 ...
 * @generated
 */
public class ControlInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ControlNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				OuterProcessEditPart.MODEL_ID));
		ControlDiagramEditorUtil.runWizard(getShell(), wizard,
