 ...
 * @generated
 */
public class ControlElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ControlElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ControlElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "control".equals(fileExtension); //$NON-NLS-1$
	}
