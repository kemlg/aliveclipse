...
import control.diagram.part.ControlDiagramEditor;
 ...
 * @generated
 */
public class ControlValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ControlDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ControlDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& OuterProcessEditPart.MODEL_ID.equals(ControlVisualIDRegistry
						.getModelID(view));
	}
