 ...
 * @generated
 */
public class ControlMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ControlDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ControlDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
