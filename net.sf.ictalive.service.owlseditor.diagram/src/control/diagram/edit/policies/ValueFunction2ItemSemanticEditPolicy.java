 ...
 * @generated
 */
public class ValueFunction2ItemSemanticEditPolicy extends
		ControlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ValueFunction2ItemSemanticEditPolicy() {
		super(ControlElementTypes.ValueFunction_3046);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ControlVisualIDRegistry.getVisualID(incomingLink) == OutputBindingSourceEditPart.VISUAL_ID) {
