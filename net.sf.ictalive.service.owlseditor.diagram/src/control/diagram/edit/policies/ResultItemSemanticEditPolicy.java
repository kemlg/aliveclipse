...
import control.diagram.edit.parts.Condition2EditPart;
import control.diagram.edit.parts.Condition3EditPart;
import control.diagram.edit.parts.Condition4EditPart;
import control.diagram.edit.parts.Expr2EditPart;
import control.diagram.edit.parts.Expr3EditPart;
import control.diagram.edit.parts.Expr4EditPart;
...
import control.diagram.edit.parts.ResultResultBindingSourceCompartment2EditPart;
import control.diagram.edit.parts.ResultResultBindingSourceCompartmentEditPart;
import control.diagram.edit.parts.ResultResultHasEffectCompartment2EditPart;
import control.diagram.edit.parts.ResultResultHasEffectCompartmentEditPart;
import control.diagram.edit.parts.ResultResultHasResultVarCompartment2EditPart;
import control.diagram.edit.parts.ResultResultHasResultVarCompartmentEditPart;
import control.diagram.edit.parts.ResultResultInConditionCompartment2EditPart;
import control.diagram.edit.parts.ResultResultInConditionCompartmentEditPart;
import control.diagram.edit.parts.ResultVarEditPart;
		...
		for (Iterator nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case ResultResultInConditionCompartment2EditPart.VISUAL_ID:
				for (Iterator cit = node.getChildren().iterator(); cit
					...
					switch (ControlVisualIDRegistry.getVisualID(cnode)) {
				...
				for (Iterator cit = node.getChildren().iterator(); cit
					...
					case ValueSourceEditPart.VISUAL_ID:
						for (Iterator it = cnode.getTargetEdges().iterator(); it
							...
							if (ControlVisualIDRegistry
									.getVisualID(incomingLink) == OutputBindingSourceEditPart.VISUAL_ID) {
						...
						for (Iterator it = cnode.getSourceEdges().iterator(); it
							...
							if (ControlVisualIDRegistry
									.getVisualID(outgoingLink) == LocBindingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
							...
							if (ControlVisualIDRegistry
									.getVisualID(outgoingLink) == OutputBindingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (ControlVisualIDRegistry
									.getVisualID(outgoingLink) == LinkBindingEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
