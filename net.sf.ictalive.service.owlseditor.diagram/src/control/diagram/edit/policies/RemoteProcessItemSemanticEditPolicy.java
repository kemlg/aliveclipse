...
import control.diagram.edit.commands.Result2CreateCommand;
 ...
 * @generated
 */
public class RemoteProcessItemSemanticEditPolicy extends
		ControlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RemoteProcessItemSemanticEditPolicy() {
		super(ControlElementTypes.RemoteProcess_3104);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (ControlElementTypes.Result_3107 == req.getElementType()) {
			return getGEFWrapper(new Result2CreateCommand(req));
		}
		if (ControlElementTypes.Condition_3108 == req.getElementType()) {
			return getGEFWrapper(new Condition4CreateCommand(req));
		}
		if (ControlElementTypes.Expr_3109 == req.getElementType()) {
			return getGEFWrapper(new Expr4CreateCommand(req));
		}
