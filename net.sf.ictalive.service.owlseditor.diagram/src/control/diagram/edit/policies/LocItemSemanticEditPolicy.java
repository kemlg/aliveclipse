 ...
 * @generated
 */
public class LocItemSemanticEditPolicy extends
		ControlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LocItemSemanticEditPolicy() {
		super(ControlElementTypes.Loc_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ControlVisualIDRegistry.getVisualID(incomingLink) == LocBindingEditPart.VISUAL_ID) {
