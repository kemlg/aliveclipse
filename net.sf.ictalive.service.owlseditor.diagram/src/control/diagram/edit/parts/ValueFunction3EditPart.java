...
import control.diagram.edit.policies.ValueFunction3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueFunction3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueFunction3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueFunction3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueFunctionName3EditPart) {
			((ValueFunctionName3EditPart) childEditPart)
