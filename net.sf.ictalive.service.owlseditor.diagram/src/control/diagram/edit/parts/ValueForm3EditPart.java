...
import control.diagram.edit.policies.ValueForm3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueForm3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueForm3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueForm3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueFormName3EditPart) {
			((ValueFormName3EditPart) childEditPart).setLabel(getPrimaryShape()
