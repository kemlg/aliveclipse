...
import control.diagram.edit.policies.Input2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Input2EditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public Input2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Input2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputName2EditPart) {
			((InputName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ControlVisualIDRegistry
				.getType(InputName2EditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof control.diagram.edit.parts.Input2EditPart) {
			types.add(ControlElementTypes.InputBinding_4002);
		}
