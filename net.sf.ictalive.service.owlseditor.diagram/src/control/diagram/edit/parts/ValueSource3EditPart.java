...
import control.diagram.edit.policies.ValueSource3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueSource3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueSource3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueSource3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		ValueSourceFigure figure = new ValueSourceFigure();
	 ...
	 * @generated
	 */
	public ValueSourceFigure getPrimaryShape() {
		return (ValueSourceFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueSourceName3EditPart) {
			((ValueSourceName3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureValueSourceLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class ValueSourceFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureValueSourceLabelFigure;

		/**
		 * @generated
		 */
		public ValueSourceFigure() {
		...
		private void createContents() {
			...
			fFigureValueSourceLabelFigure = new WrappingLabel();
			fFigureValueSourceLabelFigure.setText("ValueSource");

			this.add(fFigureValueSourceLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureValueSourceLabelFigure() {
			return fFigureValueSourceLabelFigure;
		}
