...
import control.diagram.edit.policies.ControlConstructBag3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ControlConstructBag3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ControlConstructBag3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ControlConstructBag3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControlConstructBagName3EditPart) {
			((ControlConstructBagName3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureControlConstructBagLabelFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagFirstCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagFirstCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagRestCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagRestCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagFirstCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagRestCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
