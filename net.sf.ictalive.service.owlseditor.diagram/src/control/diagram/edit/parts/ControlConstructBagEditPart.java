...
import control.diagram.edit.policies.ControlConstructBagItemSemanticEditPolicy;
...
public class ControlConstructBagEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControlConstructBagNameEditPart) {
			((ControlConstructBagNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureControlConstructBagLabelFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagFirstCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagFirstCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagRestCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagRestCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagFirstCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagRestCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
