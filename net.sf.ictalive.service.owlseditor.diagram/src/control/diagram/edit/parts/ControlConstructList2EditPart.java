...
import control.diagram.edit.policies.ControlConstructList2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ControlConstructList2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ControlConstructList2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ControlConstructList2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControlConstructListName2EditPart) {
			((ControlConstructListName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureControlConstructListLabelFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructListControlConstructListFirstCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructListFirstCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructListControlConstructListFirstCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructListControlConstructListRestCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructListRestCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructListControlConstructListRestCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ControlConstructListControlConstructListFirstCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructListControlConstructListFirstCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructListControlConstructListRestCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructListControlConstructListRestCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
