...
import control.diagram.edit.policies.LinkItemSemanticEditPolicy;
...
public class LinkEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		LinkFigure figure = new LinkFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LinkNameEditPart) {
			((LinkNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public class LinkFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureLinkLabelFigure.setText("Link");
