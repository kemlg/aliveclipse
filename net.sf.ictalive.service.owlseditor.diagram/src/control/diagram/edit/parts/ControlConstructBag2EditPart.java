...
import control.diagram.edit.policies.ControlConstructBag2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ControlConstructBag2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ControlConstructBag2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ControlConstructBag2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControlConstructBagName2EditPart) {
			((ControlConstructBagName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureControlConstructBagLabelFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagFirstCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagFirstCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagRestCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagRestCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagFirstCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagRestCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
