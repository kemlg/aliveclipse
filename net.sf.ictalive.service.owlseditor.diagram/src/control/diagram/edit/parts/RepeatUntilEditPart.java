...
import control.diagram.edit.policies.RepeatUntilItemSemanticEditPolicy;
...
public class RepeatUntilEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment7EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilConditionCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment7EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilProcessCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment7EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilConditionCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment7EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilProcessCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
