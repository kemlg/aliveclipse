...
import control.diagram.edit.policies.Produce7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Produce7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Produce7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Produce7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProduceName7EditPart) {
			((ProduceName7EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureProduceLabelFigure());
			return true;
		}
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getProduceProducedBindingValueSpecifierCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ProduceProduceProducedBindingValueSpecifierCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment6EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ProduceProduceProducedBindingValueSpecifierCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
