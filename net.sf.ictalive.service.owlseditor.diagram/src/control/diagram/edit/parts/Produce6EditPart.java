...
import control.diagram.edit.policies.Produce6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Produce6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Produce6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Produce6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProduceName6EditPart) {
			((ProduceName6EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureProduceLabelFigure());
			return true;
		}
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment5EditPart) {
			IFigure pane = getPrimaryShape()
					.getProduceProducedBindingValueSpecifierCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ProduceProduceProducedBindingValueSpecifierCompartment5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment5EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ProduceProduceProducedBindingValueSpecifierCompartment5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
