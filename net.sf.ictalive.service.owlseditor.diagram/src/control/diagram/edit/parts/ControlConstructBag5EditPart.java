...
import control.diagram.edit.policies.ControlConstructBag5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ControlConstructBag5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ControlConstructBag5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ControlConstructBag5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControlConstructBagName5EditPart) {
			((ControlConstructBagName5EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureControlConstructBagLabelFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartment5EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagFirstCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagFirstCompartment5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartment5EditPart) {
			IFigure pane = getPrimaryShape()
					.getControlConstructBagRestCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ControlConstructBagControlConstructBagRestCompartment5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ControlConstructBagControlConstructBagFirstCompartment5EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagFirstCompartment5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ControlConstructBagControlConstructBagRestCompartment5EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ControlConstructBagControlConstructBagRestCompartment5EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
