...
import control.diagram.edit.policies.ValueForm2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueForm2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueForm2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueForm2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueFormName2EditPart) {
			((ValueFormName2EditPart) childEditPart).setLabel(getPrimaryShape()
