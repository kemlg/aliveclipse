...
import control.diagram.edit.policies.SplitJoin3ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class SplitJoin3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SplitJoin3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SplitJoin3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SplitJoinName3EditPart) {
			((SplitJoinName3EditPart) childEditPart).setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof SplitJoinSplitJoinComponentsCompartment2EditPart) {
			...
			pane
					.add(((SplitJoinSplitJoinComponentsCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SplitJoinSplitJoinComponentsCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((SplitJoinSplitJoinComponentsCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
