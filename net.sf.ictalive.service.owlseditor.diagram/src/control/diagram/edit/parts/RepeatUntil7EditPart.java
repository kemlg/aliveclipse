...
import control.diagram.edit.policies.RepeatUntil7ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class RepeatUntil7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatUntil7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatUntil7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatUntilName7EditPart) {
			((RepeatUntilName7EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatUntilLabelFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilConditionCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilProcessCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment6EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilConditionCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment6EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilProcessCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
