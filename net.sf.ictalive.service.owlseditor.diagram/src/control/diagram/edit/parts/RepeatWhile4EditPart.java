...
import control.diagram.edit.policies.RepeatWhile4ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class RepeatWhile4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatWhile4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatWhile4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatWhileName4EditPart) {
			((RepeatWhileName4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatWhileLabelFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileConditionCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatWhileWhileConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatWhileRepeatWhileWhileConditionCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileProcessCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatWhileWhileProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatWhileRepeatWhileWhileProcessCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileConditionCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatWhileRepeatWhileWhileConditionCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileProcessCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatWhileRepeatWhileWhileProcessCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
