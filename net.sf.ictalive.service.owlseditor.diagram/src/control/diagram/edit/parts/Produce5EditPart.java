...
import control.diagram.edit.policies.Produce5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Produce5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Produce5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Produce5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProduceName5EditPart) {
			((ProduceName5EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureProduceLabelFigure());
			return true;
		}
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getProduceProducedBindingValueSpecifierCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ProduceProduceProducedBindingValueSpecifierCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment4EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ProduceProduceProducedBindingValueSpecifierCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
