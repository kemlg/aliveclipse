...
import control.diagram.edit.policies.ValueFunctionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueFunctionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueFunctionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueFunctionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueFunctionNameEditPart) {
			((ValueFunctionNameEditPart) childEditPart)
