...
import control.diagram.edit.policies.SplitJoinItemSemanticEditPolicy;
...
public class SplitJoinEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SplitJoinNameEditPart) {
			((SplitJoinNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureSplitJoinLabelFigure());
			return true;
		}
		if (childEditPart instanceof SplitJoinSplitJoinComponentsCompartment7EditPart) {
			IFigure pane = getPrimaryShape()
					.getSplitJoinComponentsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((SplitJoinSplitJoinComponentsCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SplitJoinSplitJoinComponentsCompartment7EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((SplitJoinSplitJoinComponentsCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
