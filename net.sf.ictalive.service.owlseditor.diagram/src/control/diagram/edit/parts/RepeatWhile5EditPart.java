...
import control.diagram.edit.policies.RepeatWhile5ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class RepeatWhile5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatWhile5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatWhile5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatWhileName5EditPart) {
			((RepeatWhileName5EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatWhileLabelFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileConditionCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatWhileWhileConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatWhileRepeatWhileWhileConditionCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileProcessCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatWhileWhileProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatWhileRepeatWhileWhileProcessCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileConditionCompartment4EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatWhileRepeatWhileWhileConditionCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileProcessCompartment4EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatWhileRepeatWhileWhileProcessCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
