...
import control.diagram.edit.policies.ValueFunction2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueFunction2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueFunction2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueFunction2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		ValueFunctionFigure figure = new ValueFunctionFigure();
	 ...
	 * @generated
	 */
	public ValueFunctionFigure getPrimaryShape() {
		return (ValueFunctionFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueFunctionName2EditPart) {
			((ValueFunctionName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureValueFunctionLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class ValueFunctionFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureValueFunctionLabelFigure;

		/**
		 * @generated
		 */
		public ValueFunctionFigure() {
		...
		private void createContents() {
			...
			fFigureValueFunctionLabelFigure = new WrappingLabel();
			fFigureValueFunctionLabelFigure.setText("ValueFunction");

			this.add(fFigureValueFunctionLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureValueFunctionLabelFigure() {
			return fFigureValueFunctionLabelFigure;
		}
