...
import control.diagram.edit.policies.ResultItemSemanticEditPolicy;
...
public class ResultEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResultNameEditPart) {
			((ResultNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureResultLabelFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultInConditionCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getResultInConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ResultResultInConditionCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultHasResultVarCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getResultHasResultVarCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ResultResultHasResultVarCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultHasEffectCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getResultHasEffectCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ResultResultHasEffectCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultBindingSourceCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getResultBindingSourceCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ResultResultBindingSourceCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ResultResultInConditionCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ResultResultInConditionCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultHasResultVarCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ResultResultHasResultVarCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultHasEffectCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ResultResultHasEffectCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof ResultResultBindingSourceCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ResultResultBindingSourceCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ControlVisualIDRegistry
				.getType(ResultNameEditPart.VISUAL_ID));
	}
