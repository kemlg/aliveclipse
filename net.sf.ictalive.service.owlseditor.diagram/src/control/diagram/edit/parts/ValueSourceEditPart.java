...
import control.diagram.edit.policies.ValueSourceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueSourceEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueSourceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueSourceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueSourceNameEditPart) {
			((ValueSourceNameEditPart) childEditPart)
