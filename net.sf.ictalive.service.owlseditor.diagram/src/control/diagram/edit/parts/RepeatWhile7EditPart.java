...
import control.diagram.edit.policies.RepeatWhile7ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class RepeatWhile7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatWhile7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatWhile7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatWhileName7EditPart) {
			((RepeatWhileName7EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatWhileLabelFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileConditionCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatWhileWhileConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatWhileRepeatWhileWhileConditionCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileProcessCompartment6EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatWhileWhileProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatWhileRepeatWhileWhileProcessCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileConditionCompartment6EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatWhileRepeatWhileWhileConditionCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatWhileRepeatWhileWhileProcessCompartment6EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatWhileRepeatWhileWhileProcessCompartment6EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
