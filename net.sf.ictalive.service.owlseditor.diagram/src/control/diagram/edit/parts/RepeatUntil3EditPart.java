...
import control.diagram.edit.policies.RepeatUntil3ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class RepeatUntil3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatUntil3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatUntil3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatUntilName3EditPart) {
			((RepeatUntilName3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatUntilLabelFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilConditionCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilProcessCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilConditionCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilProcessCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
