...
import control.diagram.edit.policies.RepeatUntil5ItemSemanticEditPolicy;
import control.diagram.part.ControlVisualIDRegistry;

/**
 * @generated
 */
public class RepeatUntil5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatUntil5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatUntil5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatUntilName5EditPart) {
			((RepeatUntilName5EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatUntilLabelFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilConditionCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment4EditPart) {
			IFigure pane = getPrimaryShape()
					.getRepeatUntilUntilProcessCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilUntilProcessCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilConditionCompartment4EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilConditionCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilUntilProcessCompartment4EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilUntilProcessCompartment4EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
