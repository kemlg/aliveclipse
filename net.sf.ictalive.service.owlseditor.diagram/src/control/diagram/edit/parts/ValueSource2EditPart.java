...
import control.diagram.edit.policies.ValueSource2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueSource2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ValueSource2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ValueSource2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ValueSourceName2EditPart) {
			((ValueSourceName2EditPart) childEditPart)
