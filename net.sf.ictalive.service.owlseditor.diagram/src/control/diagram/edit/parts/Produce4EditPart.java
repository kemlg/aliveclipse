...
import control.diagram.edit.policies.Produce4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Produce4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Produce4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Produce4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProduceName4EditPart) {
			((ProduceName4EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureProduceLabelFigure());
			return true;
		}
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getProduceProducedBindingValueSpecifierCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ProduceProduceProducedBindingValueSpecifierCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ProduceProduceProducedBindingValueSpecifierCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ProduceProduceProducedBindingValueSpecifierCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
