...
import control.diagram.edit.policies.IfThenElse4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IfThenElse4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IfThenElse4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IfThenElse4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IfThenElseName4EditPart) {
			((IfThenElseName4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureIfThenElseLabelFigure());
			return true;
		}
		if (childEditPart instanceof IfThenElseIfThenElseIfConditionCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getIfThenElseIfConditionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((IfThenElseIfThenElseIfConditionCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof IfThenElseIfThenElseThenCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getIfThenElseThenCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((IfThenElseIfThenElseThenCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof IfThenElseIfThenElseElseCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getIfThenElseElseCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((IfThenElseIfThenElseElseCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IfThenElseIfThenElseIfConditionCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((IfThenElseIfThenElseIfConditionCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof IfThenElseIfThenElseThenCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((IfThenElseIfThenElseThenCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof IfThenElseIfThenElseElseCompartment3EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((IfThenElseIfThenElseElseCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
