 ...
 * @generated
 */
public class ControlCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public ControlCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", OuterProcessEditPart.MODEL_ID); //$NON-NLS-1$
