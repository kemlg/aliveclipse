...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.runtime.NormInstances.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOfPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Of feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_of_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_of_feature", "_UI_Value_type"),
				 NormInstancesPackage.Literals.VALUE__OF,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NormInstancesPackage.Literals.VALUE__VALUE,
				 true,
				 false,
				 false,
