...
public class AgentViolatedNormsPage extends WizardPage {
	
	LoadEventData loadEvent;
	
	public AgentViolatedNormsPage(String arg0, LoadEventData loadEvent) {
		super(arg0);
		setTitle("Agents Violated Norms Matrix");
		setDescription("a table shows the agents violating norms");
	...
	public void createControl(Composite parent) {
		...
		String[] titles = { "Agents", "Tasks", "Result: Succeeded", "Result: Failed", "Result: Aborted" };
...
/*		String[] roles = {"User", "InteractionTaskManager", "Interface", "ContentAdaptor", "UserModeller", "ContentProvider", 
		...
		for (int loopIndex = 0; loopIndex < roleList.size(); loopIndex++) {
			RoleTaskInfo roleTaskInfo = roleList.get(loopIndex);
		      ...
		      item.setText(2, Integer.toString(roleTaskInfo.succeed));
		      item.setText(3, Integer.toString(roleTaskInfo.failed));
		      item.setText(4, Integer.toString(roleTaskInfo.aborted));
		}
