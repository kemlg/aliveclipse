 ...
 *******************************************************************************/
package net.sf.ictalive.SL2Code.files;
...
/**
 * Entry point of the 'Sl2wsdl' generation module.
 * 
 * @author <a href="mailto:jonathan.musset@obeo.fr">Jonathan Musset</a>
 */
public class Sl2wsdl {

	public Sl2wsdl(EObject model, File targetFolder,
...
//	 * @generated
//	 */
//	public static final String MODULE_FILE_NAME = "/net/sf/ictalive/SL2Code/files/sl2wsdl";
//	/**
//	 * The name of the templates that are to be generated.
//	 * 
//	 * @generated
//	 */
//	public static final String[] TEMPLATE_NAMES = { "sl2wsdl" };
//	/**
...
//				 */
//
//				Sl2wsdl generator = new Sl2wsdl(modelURI, folder, arguments);
//
//				/*
...
//	// "/net/sf/ictalive/SL2Code/files/sl2wsdl";
//	//
//	// /**
//	// * The name of the templates that are to be generated.
//	// * @generated
...
//	// * @generated
//	// */
//	// public Sl2wsdl(URI modelURI, File targetFolder, List<? extends Object>
...
//	// * @generated
//	// */
//	// public Sl2wsdl(EObject model, File targetFolder, List<? extends Object>
//	// arguments) throws IOException {
...
//	// * tag in the Javadoc of this method to "@generated NOT". Without this new
//	// tag, any compilation
//	// * of the Acceleo module with the main template that has caused the
//	// creation of this class will
...
//	// *
//	// * You can use the method "isInWorkspace(Class c)" to check if the package
...
//	// Eclipse. The following content should
//	// * have been generated at the beginning of this method. Do not register
//	// the package using this mechanism if
...
//	// plugin containing the package has not
//	// * been register by EMF and Acceleo should register it automatically. If
//	// you want to use the generator in
//	// * stand alone, the regular registration (seen a couple lines before) is
//	// needed.
//	// *
...
//	// * (in comment) is an example of the resource factory registration for
//	// UML.
//	// *
//	// * If you want to use the generator in stand alone, the resource factory
//	// registration will be required.
//	// *
//	// * To learn more about the registration of Resource Factories, have a look
//	// at the Acceleo documentation (Help -> Help Contents).
//	// */
//	//
//	// //
...
//	// generation
//	// * If your main template is called on an element of your model and a
//	// String, you can
...
//	// * If you want to programmatically add new properties, add them in
//	// "propertiesFiles"
//	// * You can add the absolute path of a properties files, or even a project
//	// relative path.
//	// * If you want to add another "protocol" for your properties files, please
//	// override
//	// * "getPropertiesLoaderService(AcceleoService)" in order to return a new
//	// property loader.
//	// * The behavior of the properties loader service is explained in the
...
//	// * be sufficient in most cases. If you want to change the content of this
//	// method, do NOT forget to
//	// * change the "@generated" tag in the Javadoc of this method to
//	// "@generated NOT". Without this new tag,
//	// * any compilation of the Acceleo module with the main template that has
//	// caused the creation of this
//	// * class will revert your modifications. If you encounter a problem with
//	// an unresolved proxy during the
//	// * generation, you can remove the comments in the following instructions
//	// to check for problems. Please
//	// * note that those instructions may have a significant impact on the
//	// performances.
//	// */
//	//
...
//	// *
//	// * @return List of listeners that are to be notified when text is
//	// generated through this launch.
//	// * @generated
//	// */
...
//	// list here. If you want to change
//	// * the content of this method, do NOT forget to change the "@generated"
//	// tag in the Javadoc of this method
//	// * to "@generated NOT". Without this new tag, any compilation of the
//	// Acceleo module with the main template
...
//	// * <p>
//	// * The default is {@link
//	// org.eclipse.acceleo.engine.generation.strategy.DefaultStrategy}; it
//	// generates
...
//	// example is when you wanna
//	// * override files that are under clear case or any other VCS that could
//	// forbid the overriding), then
//	// * return a new {@link
...
//	//
//	// /**
//	// * If the module(s) called by this launcher require properties files,
//	// return their qualified path from
//	// * here.Take note that the first added properties files will take
//	// precedence over subsequent ones if they
...
//	//
//	// /*
//	// * TODO if your generation module requires access to properties files, add
//	// their qualified path to the list here.
//	// *
//	// * Properties files can be located in an Eclipse plug-in or in the file
//	// system (all Acceleo projects are Eclipse
//	// * plug-in). In order to use properties files located in an Eclipse
//	// plugin, you need to add the path of the properties
//	// * files to the "propertiesFiles" list:
//	// *
//	// * final String prefix = "platform:/plugin/";
//	// * final String pluginName = "org.eclipse.acceleo.module.sample";
//	// * final String packagePath =
//	// "/org/eclipse/acceleo/module/sample/properties/";
//	// * final String fileName = "default.properties";
//	// * propertiesFiles.add(prefix + pluginName + packagePath + fileName);
//	// *
//	// * With this mechanism, you can load properties files from your plugin or
//	// from another plugin.
//	// *
...
//	// *
//	// * If you want to let your users add properties files located in the same
//	// folder as the model:
//	// *
...
//	//
//	// /**
//	// * This will be used to get the list of templates that are to be launched
//	// by this launcher.
//	// *
...
//	//
//
//	public Sl2wsdl(URI modelURI, File targetFolder,
//			List<? extends Object> arguments) {
//		// TODO Auto-generated constructor stub
//	}
//
