 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.runtime.action.PlanningActions#getPlan <em>Plan</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.runtime.action.ActionPackage#getPlanningActions()
 * @model abstract="true"
 * @generated
 */
public interface PlanningActions extends Action {
	 ...
	 * @see #setPlan(Plan)
	 * @see net.sf.ictalive.runtime.action.ActionPackage#getPlanningActions_Plan()
	 * @model
	 * @generated
	 */
	Plan getPlan();
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.runtime.action.PlanningActions#getPlan <em>Plan</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
