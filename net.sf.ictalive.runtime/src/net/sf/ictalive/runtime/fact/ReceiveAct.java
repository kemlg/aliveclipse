 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.runtime.fact.ReceiveAct#getReceivedMessage <em>Received Message</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.runtime.fact.FactPackage#getReceiveAct()
 * @model
 * @generated
 */
public interface ReceiveAct extends CommunicativeAct {
	 ...
	 * @see net.sf.ictalive.runtime.fact.FactPackage#getReceiveAct_ReceivedMessage()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.runtime.fact.ReceiveAct#getReceivedMessage <em>Received Message</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
