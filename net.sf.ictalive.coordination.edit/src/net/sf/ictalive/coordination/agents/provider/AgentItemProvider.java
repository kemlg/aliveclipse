...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.coordination.agents.Agent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AgentItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHasRolePropertyDescriptor(object);
			addHasActionPropertyDescriptor(object);
			addAsFolderLocationPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AgentsPackage.Literals.AGENT__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Has Role feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	protected void addHasActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Agent_hasAction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Agent_hasAction_feature", "_UI_Agent_type"),
				 AgentsPackage.Literals.AGENT__HAS_ACTION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the As Folder Location feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAsFolderLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
