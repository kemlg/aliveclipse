...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.SchemaType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addLangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SchemaType_lang_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SchemaType_lang_feature", "_UI_SchemaType_type"),
				 SchemaPackage.Literals.SCHEMA_TYPE__LANG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
