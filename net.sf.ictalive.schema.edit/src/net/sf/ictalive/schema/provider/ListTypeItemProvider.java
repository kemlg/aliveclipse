...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.ListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ListTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ListType_itemType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ListType_itemType_feature", "_UI_ListType_type"),
				 SchemaPackage.Literals.LIST_TYPE__ITEM_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchemaPackage.Literals.LIST_TYPE__SIMPLE_TYPE);
		}
	...
	public String getText(Object object) {
		String label = ((ListType)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.LIST_TYPE__SIMPLE_TYPE,
