...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.FieldType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FieldType_xpath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FieldType_xpath_feature", "_UI_FieldType_type"),
				 SchemaPackage.Literals.FIELD_TYPE__XPATH,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((FieldType)object).getId();
