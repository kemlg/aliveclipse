...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.AnnotationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnnotationType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnnotationType_id_feature", "_UI_AnnotationType_type"),
				 SchemaPackage.Literals.ANNOTATION_TYPE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchemaPackage.Literals.ANNOTATION_TYPE__GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AnnotationType)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.ANNOTATION_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SchemaPackage.Literals.ANNOTATION_TYPE__APPINFO,
		...
		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.ANNOTATION_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SchemaPackage.Literals.ANNOTATION_TYPE__DOCUMENTATION,
