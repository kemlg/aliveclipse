...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.NotationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotationTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NotationType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NotationType_name_feature", "_UI_NotationType_type"),
				 SchemaPackage.Literals.NOTATION_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((NotationType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NotationType.class)) {
