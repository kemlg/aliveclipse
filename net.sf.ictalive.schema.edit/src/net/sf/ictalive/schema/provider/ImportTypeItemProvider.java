...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.ImportType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ImportType_schemaLocation_feature", "_UI_ImportType_type"),
				 SchemaPackage.Literals.IMPORT_TYPE__SCHEMA_LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ImportType)object).getId();
