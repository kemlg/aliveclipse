...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.schema.Facet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FacetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Facet_fixed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Facet_fixed_feature", "_UI_Facet_type"),
				 SchemaPackage.Literals.FACET__FIXED,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Facet_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Facet_value_feature", "_UI_Facet_type"),
				 SchemaPackage.Literals.FACET__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Facet)object).getId();
