...
import net.sf.ictalive.coordination.actions.diagram.edit.commands.ControlConstructListRestCreateCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.ControlConstructListRestReorientCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.SequenceComponentsCreateCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.SequenceComponentsReorientCommand;
...
public class ControlConstructListItemSemanticEditPolicy extends
	...
	public ControlConstructListItemSemanticEditPolicy() {
		super(CoordinationElementTypes.ControlConstructList_2034);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CoordinationElementTypes.SequenceComponents_4033 == req
				.getElementType()) {
			return null;
		}
		if (CoordinationElementTypes.ControlConstructListRest_4035 == req
				.getElementType()) {
