 ...
 * @generated
 */
public class IndividualVariableNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IndividualVariableNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3058,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.IndividualVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
