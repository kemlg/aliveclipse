 ...
 * @generated
 */
public class IndividualVariableName5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IndividualVariableName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3069,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.IndividualVariableName5EditPart.VISUAL_ID));
		}
		return parser;
	}
