 ...
 * @generated
 */
public class ProcessHasInputCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProcessHasInputCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateProcessHasInput_4026(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasInput().add(getTarget());
		}
