...
import net.sf.ictalive.coordination.actions.diagram.edit.policies.DatavaluedPropertyAtomCanonicalEditPolicy;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.DatavaluedPropertyAtomItemSemanticEditPolicy;
...
public class DatavaluedPropertyAtomEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.IndividualVariable_3076) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(DatavaluedPropertyAtomDataValuedPropertyAtomArg1CompartmentEditPart.VISUAL_ID));
			}
			if (type == CoordinationElementTypes.IndividualID_3077) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(DatavaluedPropertyAtomDataValuedPropertyAtomArg1CompartmentEditPart.VISUAL_ID));
			}
		}
