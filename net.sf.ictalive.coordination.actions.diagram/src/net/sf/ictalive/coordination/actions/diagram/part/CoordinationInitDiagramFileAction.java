 ...
 * @generated
 */
public class CoordinationInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new CoordinationNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ActionsCollectionEditPart.MODEL_ID));
		CoordinationDiagramEditorUtil.runWizard(getShell(), wizard,
