...
import net.sf.ictalive.coordination.actions.diagram.edit.policies.DataRangeAtomCanonicalEditPolicy;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.DataRangeAtomItemSemanticEditPolicy;
...
public class DataRangeAtomEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.DataValue_3090) {
