 ...
 * @generated
 */
public class DataValueLiteral2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataValueLiteral2EditPart(View view) {
		super(view);
	}
			...
			parser = CoordinationParserProvider
					.getParser(
							...
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.DataValueLiteral2EditPart.VISUAL_ID));
		}
		return parser;
	}
