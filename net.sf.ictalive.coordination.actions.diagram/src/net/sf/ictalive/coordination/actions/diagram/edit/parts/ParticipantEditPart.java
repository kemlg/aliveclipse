...
import net.sf.ictalive.coordination.actions.diagram.edit.policies.ParticipantCanonicalEditPolicy;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.ParticipantItemSemanticEditPolicy;
...
public class ParticipantEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ParticipantCanonicalEditPolicy());
