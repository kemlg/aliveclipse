...
import net.sf.ictalive.coordination.actions.diagram.edit.commands.AnyOrderComponentsCreateCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.AnyOrderComponentsReorientCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.ChoiceComponentsCreateCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.ChoiceComponentsReorientCommand;
...
import net.sf.ictalive.coordination.actions.diagram.edit.commands.ControlConstructBagRestCreateCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.ControlConstructBagRestReorientCommand;
...
import net.sf.ictalive.coordination.actions.diagram.edit.commands.SplitJoinComponentsCreateCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.SplitJoinComponentsReorientCommand;
...
public class ControlConstructBagItemSemanticEditPolicy extends
	...
	public ControlConstructBagItemSemanticEditPolicy() {
		super(CoordinationElementTypes.ControlConstructBag_2031);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(incomingLink) == SplitComponentsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(incomingLink) == SplitJoinComponentsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CoordinationElementTypes.ChoiceComponents_4031 == req
				.getElementType()) {
			return null;
		}
		if (CoordinationElementTypes.AnyOrderComponents_4032 == req
				.getElementType()) {
			return null;
		}
		...
		if (CoordinationElementTypes.SplitJoinComponents_4046 == req
				.getElementType()) {
			return null;
		}
		if (CoordinationElementTypes.ControlConstructBagRest_4034 == req
				.getElementType()) {
