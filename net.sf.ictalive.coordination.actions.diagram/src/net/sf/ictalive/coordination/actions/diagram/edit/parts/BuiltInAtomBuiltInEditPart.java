 ...
 * @generated
 */
public class BuiltInAtomBuiltInEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BuiltInAtomBuiltInEditPart(View view) {
		super(view);
	}
			...
			parser = CoordinationParserProvider
					.getParser(
							...
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.BuiltInAtomBuiltInEditPart.VISUAL_ID));
		}
		return parser;
	}
