 ...
 * @generated
 */
public class BindingToParamReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BindingToParamReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Parameter && newEnd instanceof Binding)) {
			return false;
		}
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBindingToParam_4044(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBindingToParam_4044(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setToParam(null);
		getNewSource().setToParam(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setToParam(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
