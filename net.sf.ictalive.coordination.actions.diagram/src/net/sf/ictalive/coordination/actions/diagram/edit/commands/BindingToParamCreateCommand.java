 ...
 * @generated
 */
public class BindingToParamCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BindingToParamCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateBindingToParam_4044(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setToParam(getTarget());
		}
