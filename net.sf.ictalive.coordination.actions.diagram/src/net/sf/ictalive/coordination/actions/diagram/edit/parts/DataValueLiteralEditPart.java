 ...
 * @generated
 */
public class DataValueLiteralEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataValueLiteralEditPart(View view) {
		super(view);
	}
			...
			parser = CoordinationParserProvider
					.getParser(
							...
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.DataValueLiteralEditPart.VISUAL_ID));
		}
		return parser;
	}
