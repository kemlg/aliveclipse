 ...
 * @generated
 */
public class PerformProcessReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PerformProcessReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Process && newEnd instanceof Perform)) {
			return false;
		}
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistPerformProcess_4030(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistPerformProcess_4030(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setProcess(null);
		getNewSource().setProcess(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setProcess(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
	 ...
	 * @generated
	 */
	protected Process getOldTarget() {
	 ...
	 * @generated
	 */
	protected Process getNewTarget() {
