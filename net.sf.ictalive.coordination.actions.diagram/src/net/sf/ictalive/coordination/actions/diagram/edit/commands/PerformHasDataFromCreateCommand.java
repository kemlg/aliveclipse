 ...
 * @generated
 */
public class PerformHasDataFromCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PerformHasDataFromCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Binding) {
			return false;
		}
		if (getSource() == null) {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreatePerformHasDataFrom_4042(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasDataFrom().add(getTarget());
		}
