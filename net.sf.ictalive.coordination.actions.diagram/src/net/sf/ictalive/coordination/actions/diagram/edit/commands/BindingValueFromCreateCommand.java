 ...
 * @generated
 */
public class BindingValueFromCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BindingValueFromCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Binding) {
			return false;
		}
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateBindingValueFrom_4043(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setValueFrom(getTarget());
		}
