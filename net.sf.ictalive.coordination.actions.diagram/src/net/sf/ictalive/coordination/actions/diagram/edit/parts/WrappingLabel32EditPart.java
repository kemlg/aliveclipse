 ...
 * @generated
 */
public class WrappingLabel32EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CoordinationVisualIDRegistry
						.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.WrappingLabel32EditPart.VISUAL_ID),
				new Point(0, 0));
	}
