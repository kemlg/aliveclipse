 ...
 * @generated
 */
public class IndividualVariableName6EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IndividualVariableName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3076,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.IndividualVariableName6EditPart.VISUAL_ID));
		}
		return parser;
	}
