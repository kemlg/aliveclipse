 ...
 * @generated
 */
public class DataVariableName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataVariableName2EditPart(View view) {
		super(view);
	}
			...
			parser = CoordinationParserProvider
					.getParser(
							...
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.DataVariableName2EditPart.VISUAL_ID));
		}
		return parser;
	}
