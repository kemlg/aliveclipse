...
import net.sf.ictalive.coordination.actions.diagram.edit.policies.SameIndividualAtomCanonicalEditPolicy;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.SameIndividualAtomItemSemanticEditPolicy;
...
public class SameIndividualAtomEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.IndividualID_3065) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(SameIndividualAtomSameAsAtomArgsCompartmentEditPart.VISUAL_ID));
			}
			if (type == CoordinationElementTypes.IndividualVariable_3066) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(SameIndividualAtomSameAsAtomArgsCompartmentEditPart.VISUAL_ID));
			}
		}
