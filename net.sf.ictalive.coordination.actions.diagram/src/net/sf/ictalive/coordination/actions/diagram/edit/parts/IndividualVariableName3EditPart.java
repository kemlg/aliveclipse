 ...
 * @generated
 */
public class IndividualVariableName3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IndividualVariableName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3063,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.IndividualVariableName3EditPart.VISUAL_ID));
		}
		return parser;
	}
