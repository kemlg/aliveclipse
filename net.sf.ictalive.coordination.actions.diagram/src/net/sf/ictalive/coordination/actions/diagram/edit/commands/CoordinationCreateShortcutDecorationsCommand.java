 ...
 * @generated
 */
public class CoordinationCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public CoordinationCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", ActionsCollectionEditPart.MODEL_ID); //$NON-NLS-1$
