 ...
 * @generated
 */
public class WrappingLabel33EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CoordinationVisualIDRegistry
						.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.WrappingLabel33EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider.getParser(
