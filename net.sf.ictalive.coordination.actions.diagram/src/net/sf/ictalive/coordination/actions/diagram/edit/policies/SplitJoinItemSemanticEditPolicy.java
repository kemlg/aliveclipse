 ...
 * @generated
 */
public class SplitJoinItemSemanticEditPolicy extends
		CoordinationBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SplitJoinItemSemanticEditPolicy() {
		super(CoordinationElementTypes.SplitJoin_2040);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(outgoingLink) == SplitJoinComponentsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
