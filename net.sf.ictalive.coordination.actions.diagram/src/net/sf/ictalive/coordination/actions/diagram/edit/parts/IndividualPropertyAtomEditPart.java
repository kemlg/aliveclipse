...
import net.sf.ictalive.coordination.actions.diagram.edit.policies.IndividualPropertyAtomCanonicalEditPolicy;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.IndividualPropertyAtomItemSemanticEditPolicy;
...
public class IndividualPropertyAtomEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.IndividualID_3060) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(IndividualPropertyAtomIndividualPropertyAtomArg1CompartmentEditPart.VISUAL_ID));
			}
			if (type == CoordinationElementTypes.IndividualVariable_3061) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(IndividualPropertyAtomIndividualPropertyAtomArg1CompartmentEditPart.VISUAL_ID));
			}
			if (type == CoordinationElementTypes.IndividualID_3062) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(IndividualPropertyAtomIndividualPropertyAtomArg2CompartmentEditPart.VISUAL_ID));
			}
			if (type == CoordinationElementTypes.IndividualVariable_3063) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(IndividualPropertyAtomIndividualPropertyAtomArg2CompartmentEditPart.VISUAL_ID));
			}
		}
