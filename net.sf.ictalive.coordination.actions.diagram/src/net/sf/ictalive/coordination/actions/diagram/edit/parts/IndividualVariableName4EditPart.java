 ...
 * @generated
 */
public class IndividualVariableName4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IndividualVariableName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3066,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.IndividualVariableName4EditPart.VISUAL_ID));
		}
		return parser;
	}
