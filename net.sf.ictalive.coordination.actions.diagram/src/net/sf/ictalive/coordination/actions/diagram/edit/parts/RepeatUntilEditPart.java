...
import net.sf.ictalive.coordination.actions.diagram.edit.policies.RepeatUntilCanonicalEditPolicy;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.RepeatUntilItemSemanticEditPolicy;
...
public class RepeatUntilEditPart extends ShapeNodeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof net.sf.ictalive.coordination.actions.diagram.edit.parts.RepeatUntilEditPart) {
			types.add(CoordinationElementTypes.RepeatUntilUntilProcess_4038);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.Condition_3087) {
