...
import net.sf.ictalive.coordination.actions.diagram.custom.CreateMissingShortcuts;
import net.sf.ictalive.coordination.actions.diagram.edit.commands.CoordinationCreateShortcutDecorationsCommand;
import net.sf.ictalive.coordination.actions.diagram.edit.policies.ActionsCollectionCanonicalEditPolicy;
...
public class CreateShortcutAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		((ActionsCollectionCanonicalEditPolicy) selectedDiagramPart
