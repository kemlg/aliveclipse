 ...
 * @generated
 */
public class ProcessHasInputReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProcessHasInputReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Input && newEnd instanceof Process)) {
			return false;
		}
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistProcessHasInput_4026(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistProcessHasInput_4026(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getHasInput().remove(getOldTarget());
		getNewSource().getHasInput().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getHasInput().remove(getOldTarget());
		getOldSource().getHasInput().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
