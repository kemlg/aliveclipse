 ...
 * @generated
 */
public class DataValueType2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataValueType2EditPart(View view) {
		super(view);
	}
			...
			parser = CoordinationParserProvider
					.getParser(
							...
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.DataValueType2EditPart.VISUAL_ID));
		}
		return parser;
	}
