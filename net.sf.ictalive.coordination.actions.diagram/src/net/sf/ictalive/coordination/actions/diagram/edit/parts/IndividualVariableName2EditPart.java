 ...
 * @generated
 */
public class IndividualVariableName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public IndividualVariableName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3061,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.IndividualVariableName2EditPart.VISUAL_ID));
		}
		return parser;
	}
