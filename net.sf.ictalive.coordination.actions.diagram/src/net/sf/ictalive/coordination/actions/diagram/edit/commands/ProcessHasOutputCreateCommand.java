 ...
 * @generated
 */
public class ProcessHasOutputCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProcessHasOutputCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateProcessHasOutput_4027(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasOutput().add(getTarget());
		}
