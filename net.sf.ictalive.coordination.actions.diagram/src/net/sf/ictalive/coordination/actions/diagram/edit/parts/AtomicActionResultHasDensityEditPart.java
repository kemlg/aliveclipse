 ...
 * @generated
 */
public class AtomicActionResultHasDensityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AtomicActionResultHasDensityEditPart(View view) {
		super(view);
	}
			...
			parser = CoordinationParserProvider
					.getParser(
							...
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.actions.diagram.edit.parts.AtomicActionResultHasDensityEditPart.VISUAL_ID));
		}
		return parser;
	}
