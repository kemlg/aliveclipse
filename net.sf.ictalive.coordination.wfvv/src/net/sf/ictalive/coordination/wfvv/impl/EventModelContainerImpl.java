 ...
 *   <li>{@link net.sf.ictalive.coordination.wfvv.impl.EventModelContainerImpl#getObjects <em>Objects</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventModelContainerImpl extends EObjectImpl implements EventModelContainer {
	...
	public EList<EObject> getObjects() {
		if (objects == null) {
			objects = new EObjectContainmentEList<EObject>(EObject.class, this, WfvvPackage.EVENT_MODEL_CONTAINER__OBJECTS);
		}
		return objects;
	}
