...
public class WfvvPackageImpl extends EPackageImpl implements WfvvPackage {
	 ...
	 * @generated
	 */
	public EReference getEventModelContainer_Objects() {
		return (EReference)eventModelContainerEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(eventModelContainerEClass, EVENT_MODEL_CONTAINER__OBJECTS);
	...
	public void initializePackageContents() {
		...
		initEReference(getEventModelContainer_Objects(), ecorePackage.getEObject(), null, "objects", null, 0, -1, EventModelContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
