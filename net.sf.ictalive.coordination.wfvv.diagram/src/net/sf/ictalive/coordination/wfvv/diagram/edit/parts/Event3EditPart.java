...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.Event3CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.Event3ItemSemanticEditPolicy;
...
public class Event3EditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		EventFigure_Minimized figure = new EventFigure_Minimized();
	 ...
	 * @generated
	 */
	public EventFigure_Minimized getPrimaryShape() {
		return (EventFigure_Minimized) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventTimestamp3EditPart) {
			((EventTimestamp3EditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class EventFigure_Minimized extends RoundedRectangle {
