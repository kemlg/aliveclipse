...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.StartedActCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.StartedActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StartedActEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StartedActEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StartedActItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new StartedActCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		StartedActFactFigure figure = new StartedActFactFigure();
	 ...
	 * @generated
	 */
	public StartedActFactFigure getPrimaryShape() {
		return (StartedActFactFigure) primaryShape;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof net.sf.ictalive.coordination.wfvv.diagram.edit.parts.StartedActEditPart) {
			types.add(WfvvElementTypes.FactRelate_4003);
		}
	 ...
	 * @generated
	 */
	public class StartedActFactFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public StartedActFactFigure() {
		...
		private void createContents() {
			...
			WrappingLabel startedActFactTitleLabel0 = new WrappingLabel();
			startedActFactTitleLabel0.setText("Started Act");

			GridData constraintStartedActFactTitleLabel0 = new GridData();
			constraintStartedActFactTitleLabel0.verticalAlignment = GridData.CENTER;
			constraintStartedActFactTitleLabel0.horizontalAlignment = GridData.CENTER;
			constraintStartedActFactTitleLabel0.horizontalIndent = 0;
			constraintStartedActFactTitleLabel0.horizontalSpan = 1;
			constraintStartedActFactTitleLabel0.verticalSpan = 1;
			constraintStartedActFactTitleLabel0.grabExcessHorizontalSpace = false;
			constraintStartedActFactTitleLabel0.grabExcessVerticalSpace = false;
			this.add(startedActFactTitleLabel0,
					constraintStartedActFactTitleLabel0);
