...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.Event2CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.Event2ItemSemanticEditPolicy;
...
public class Event2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventTimestamp2EditPart) {
			((EventTimestamp2EditPart) childEditPart)
