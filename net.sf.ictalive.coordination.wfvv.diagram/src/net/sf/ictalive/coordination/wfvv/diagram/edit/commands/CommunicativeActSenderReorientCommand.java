 ...
 * @generated
 */
public class CommunicativeActSenderReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CommunicativeActSenderReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCommunicativeActSender_4012(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCommunicativeActSender_4012(getOldSource(),
						getNewTarget());
	}
