...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ParameterCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ParameterItemSemanticEditPolicy;
...
public class ParameterEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ParameterCanonicalEditPolicy());
	...
	public class ParameterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel parameterFigureTitleLabel0 = new WrappingLabel();
			parameterFigureTitleLabel0.setText("Parameter");

			this.add(parameterFigureTitleLabel0);
