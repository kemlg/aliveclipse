...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ServiceCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ServiceItemSemanticEditPolicy;
...
public class ServiceEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ServiceCanonicalEditPolicy());
	...
	public class ServiceFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel serviceFigureTitleLabel0 = new WrappingLabel();
			serviceFigureTitleLabel0.setText("Service");

			this.add(serviceFigureTitleLabel0);
