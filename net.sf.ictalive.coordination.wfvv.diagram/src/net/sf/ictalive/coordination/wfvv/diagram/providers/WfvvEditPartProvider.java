...
import net.sf.ictalive.coordination.wfvv.diagram.edit.parts.WfvvEditPartFactory;
 ...
 * @generated
 */
public class WfvvEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public WfvvEditPartProvider() {
		setFactory(new WfvvEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!EventModelContainerEditPart.MODEL_ID
					.equals(WfvvVisualIDRegistry.getModelID(view))) {
				return false;
			}
