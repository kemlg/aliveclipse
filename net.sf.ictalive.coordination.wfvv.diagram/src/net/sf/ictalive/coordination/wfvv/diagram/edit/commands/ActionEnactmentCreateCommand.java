 ...
 * @generated
 */
public class ActionEnactmentCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionEnactmentCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Enactment) {
			return false;
		}
		if (getSource() == null) {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateActionEnactment_4015(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getEnactment().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected Enactment getTarget() {
		return (Enactment) target;
	}
}
