...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ReceiveActCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ReceiveActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ReceiveActEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ReceiveActEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ReceiveActItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ReceiveActCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		ReceiveActFactFigure figure = new ReceiveActFactFigure();
	 ...
	 * @generated
	 */
	public ReceiveActFactFigure getPrimaryShape() {
		return (ReceiveActFactFigure) primaryShape;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof net.sf.ictalive.coordination.wfvv.diagram.edit.parts.ReceiveActEditPart) {
			types.add(WfvvElementTypes.FactRelate_4003);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == WfvvElementTypes.Message_3009) {
	 ...
	 * @generated
	 */
	public class ReceiveActFactFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ReceiveActFactFigure() {
		...
		private void createContents() {
			...
			WrappingLabel receiveActFactFigureTitleLabel0 = new WrappingLabel();
			receiveActFactFigureTitleLabel0.setText("Receive Act");

			this.add(receiveActFactFigureTitleLabel0);
