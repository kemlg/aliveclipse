 ...
 * @generated
 */
public class WfvvElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public WfvvElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.WfvvElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "opera".equals(fileExtension) || "actions".equals(fileExtension) || "plans".equals(fileExtension) || "mas".equals(fileExtension) || "event".equals(fileExtension) || "enactment".equals(fileExtension); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
	}
