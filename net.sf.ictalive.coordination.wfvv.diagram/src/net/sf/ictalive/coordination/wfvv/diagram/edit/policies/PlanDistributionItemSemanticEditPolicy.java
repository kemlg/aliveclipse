 ...
 * @generated
 */
public class PlanDistributionItemSemanticEditPolicy extends
		WfvvBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PlanDistributionItemSemanticEditPolicy() {
		super(WfvvElementTypes.PlanDistribution_3018);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WfvvVisualIDRegistry.getVisualID(outgoingLink) == PlanningActionsPlanEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
