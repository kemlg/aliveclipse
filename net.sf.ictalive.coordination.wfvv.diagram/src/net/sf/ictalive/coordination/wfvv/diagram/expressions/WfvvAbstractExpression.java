 ...
 * @generated
 */
public abstract class WfvvAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = WfvvDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected WfvvAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
