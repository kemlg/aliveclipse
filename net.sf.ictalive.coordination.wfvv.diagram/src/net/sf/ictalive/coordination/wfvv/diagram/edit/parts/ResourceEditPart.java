...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ResourceCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ResourceItemSemanticEditPolicy;
...
public class ResourceEditPart extends ShapeNodeEditPart {
	...
	public class ResourceFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel resourceFigureTitleLabel0 = new WrappingLabel();
			resourceFigureTitleLabel0.setText("Resource");

			this.add(resourceFigureTitleLabel0);
