...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ResultCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ResultItemSemanticEditPolicy;
...
public class ResultEditPart extends ShapeNodeEditPart {
	...
	public class ResultFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel resultFigureTitleLabel0 = new WrappingLabel();
			resultFigureTitleLabel0.setText("Result");

			this.add(resultFigureTitleLabel0);
