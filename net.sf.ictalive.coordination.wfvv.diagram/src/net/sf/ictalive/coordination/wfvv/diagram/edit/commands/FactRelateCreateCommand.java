 ...
 * @generated
 */
public class FactRelateCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FactRelateCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateFactRelate_4003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getRelate().add(getTarget());
		}
