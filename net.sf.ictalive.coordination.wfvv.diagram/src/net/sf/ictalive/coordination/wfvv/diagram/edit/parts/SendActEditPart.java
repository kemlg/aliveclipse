...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.SendActCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.SendActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SendActEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SendActEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SendActItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SendActCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		SendActFactFigure figure = new SendActFactFigure();
	 ...
	 * @generated
	 */
	public SendActFactFigure getPrimaryShape() {
		return (SendActFactFigure) primaryShape;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof net.sf.ictalive.coordination.wfvv.diagram.edit.parts.SendActEditPart) {
			types.add(WfvvElementTypes.FactRelate_4003);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == WfvvElementTypes.Message_3011) {
	 ...
	 * @generated
	 */
	public class SendActFactFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public SendActFactFigure() {
		...
		private void createContents() {
			...
			WrappingLabel sendActFactFigureTitleLabel0 = new WrappingLabel();
			sendActFactFigureTitleLabel0.setText("Send Act");

			this.add(sendActFactFigureTitleLabel0);
