 ...
 * @generated
 */
public class EventAsserterCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EventAsserterCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateEventAsserter_4019(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setAsserter(getTarget());
		}
