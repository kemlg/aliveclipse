 ...
 * @generated
 */
public class FactDueToReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FactDueToReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFactDueTo_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFactDueTo_4001(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDueTo(null);
		getNewSource().setDueTo(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDueTo(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
