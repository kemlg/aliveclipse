...
import net.sf.ictalive.coordination.wfvv.diagram.edit.commands.TaskViolationUnmetRequirementCreateCommand;
import net.sf.ictalive.coordination.wfvv.diagram.edit.commands.TaskViolationUnmetRequirementReorientCommand;
 ...
 * @generated
 */
public class TaskViolationItemSemanticEditPolicy extends
		WfvvBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TaskViolationItemSemanticEditPolicy() {
		super(WfvvElementTypes.TaskViolation_3013);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WfvvVisualIDRegistry.getVisualID(outgoingLink) == TaskViolationUnmetRequirementEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (WfvvElementTypes.TaskViolationUnmetRequirement_4013 == req
				.getElementType()) {
			return getGEFWrapper(new TaskViolationUnmetRequirementCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case TaskViolationUnmetRequirementEditPart.VISUAL_ID:
			return getGEFWrapper(new TaskViolationUnmetRequirementReorientCommand(
					req));
