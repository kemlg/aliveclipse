...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.MessageCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.MessageItemSemanticEditPolicy;
...
public class MessageEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MessageCanonicalEditPolicy());
	...
	public class MessageFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrappingLabel messageFigureTitleLabel0 = new WrappingLabel();
			messageFigureTitleLabel0.setText("Message");

			this.add(messageFigureTitleLabel0);
