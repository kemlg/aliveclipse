 ...
 * @generated
 */
public class WfvvCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public WfvvCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", EventModelContainerEditPart.MODEL_ID); //$NON-NLS-1$
