 ...
 * @generated
 */
public class FactEffectReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FactEffectReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Action && newEnd instanceof Fact)) {
			return false;
		}
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFactEffect_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFactEffect_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setEffect(null);
		getNewSource().setEffect(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setEffect(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
