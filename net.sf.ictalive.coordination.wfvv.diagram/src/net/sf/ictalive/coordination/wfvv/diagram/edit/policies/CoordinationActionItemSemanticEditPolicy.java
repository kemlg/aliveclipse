 ...
 * @generated
 */
public class CoordinationActionItemSemanticEditPolicy extends
		WfvvBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CoordinationActionItemSemanticEditPolicy() {
		super(WfvvElementTypes.CoordinationAction_3028);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WfvvVisualIDRegistry.getVisualID(outgoingLink) == CoordinationActionCoordActionEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (WfvvVisualIDRegistry.getVisualID(outgoingLink) == CoordinationActionPlanEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
