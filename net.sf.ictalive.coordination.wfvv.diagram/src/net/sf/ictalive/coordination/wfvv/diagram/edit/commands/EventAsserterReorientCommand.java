 ...
 * @generated
 */
public class EventAsserterReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EventAsserterReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Actor && newEnd instanceof Event)) {
			return false;
		}
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEventAsserter_4019(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEventAsserter_4019(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setAsserter(null);
		getNewSource().setAsserter(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setAsserter(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
