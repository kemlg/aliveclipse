 ...
 * @generated
 */
public class WfvvDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public WfvvDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WfvvDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((WfvvDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WfvvDomainNavigatorItem((EObject) objects[i],
