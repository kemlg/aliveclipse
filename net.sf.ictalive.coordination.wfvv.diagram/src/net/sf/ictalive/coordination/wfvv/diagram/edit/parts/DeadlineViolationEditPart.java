...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.DeadlineViolationCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.DeadlineViolationItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DeadlineViolationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DeadlineViolationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DeadlineViolationItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DeadlineViolationCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		DeadlineViolationFactFigure figure = new DeadlineViolationFactFigure();
	 ...
	 * @generated
	 */
	public DeadlineViolationFactFigure getPrimaryShape() {
		return (DeadlineViolationFactFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeadlineViolationDealineEditPart) {
			((DeadlineViolationDealineEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDeadlineViolationFigureDeadlineLabel());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof net.sf.ictalive.coordination.wfvv.diagram.edit.parts.DeadlineViolationEditPart) {
			types.add(WfvvElementTypes.FactRelate_4003);
		}
	 ...
	 * @generated
	 */
	public class DeadlineViolationFactFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDeadlineViolationFigureDeadlineLabel;

		/**
		 * @generated
		 */
		public DeadlineViolationFactFigure() {
		...
		private void createContents() {
			...
			WrappingLabel deadlineViolationFigureTitleLabel0 = new WrappingLabel();
			deadlineViolationFigureTitleLabel0.setText("Deadline Violation");

			this.add(deadlineViolationFigureTitleLabel0);

			fFigureDeadlineViolationFigureDeadlineLabel = new WrappingLabel();
			fFigureDeadlineViolationFigureDeadlineLabel.setText("");

			this.add(fFigureDeadlineViolationFigureDeadlineLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDeadlineViolationFigureDeadlineLabel() {
			return fFigureDeadlineViolationFigureDeadlineLabel;
		}
