...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ExecutedActCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.ExecutedActItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExecutedActEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ExecutedActEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExecutedActItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ExecutedActCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		ExecutedActFactFigure figure = new ExecutedActFactFigure();
	 ...
	 * @generated
	 */
	public ExecutedActFactFigure getPrimaryShape() {
		return (ExecutedActFactFigure) primaryShape;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof net.sf.ictalive.coordination.wfvv.diagram.edit.parts.ExecutedActEditPart) {
			types.add(WfvvElementTypes.FactRelate_4003);
		}
	 ...
	 * @generated
	 */
	public class ExecutedActFactFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ExecutedActFactFigure() {
		...
		private void createContents() {
			...
			WrappingLabel executedActFactTitleLabel0 = new WrappingLabel();
			executedActFactTitleLabel0.setText("Executed Act");

			GridData constraintExecutedActFactTitleLabel0 = new GridData();
			constraintExecutedActFactTitleLabel0.verticalAlignment = GridData.CENTER;
			constraintExecutedActFactTitleLabel0.horizontalAlignment = GridData.CENTER;
			constraintExecutedActFactTitleLabel0.horizontalIndent = 0;
			constraintExecutedActFactTitleLabel0.horizontalSpan = 1;
			constraintExecutedActFactTitleLabel0.verticalSpan = 1;
			constraintExecutedActFactTitleLabel0.grabExcessHorizontalSpace = false;
			constraintExecutedActFactTitleLabel0.grabExcessVerticalSpace = false;
			this.add(executedActFactTitleLabel0,
					constraintExecutedActFactTitleLabel0);
