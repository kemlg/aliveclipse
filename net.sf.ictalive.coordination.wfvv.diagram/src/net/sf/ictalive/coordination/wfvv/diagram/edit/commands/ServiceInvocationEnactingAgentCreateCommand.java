 ...
 * @generated
 */
public class ServiceInvocationEnactingAgentCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceInvocationEnactingAgentCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ServiceInvocation) {
			return false;
		}
		...
		return WfvvBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateServiceInvocationEnactingAgent_4006(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setEnactingAgent(getTarget());
		}
	 ...
	 * @generated
	 */
	protected ServiceInvocation getSource() {
		return (ServiceInvocation) source;
	}
