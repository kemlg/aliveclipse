...
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.AtomicActionCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfvv.diagram.edit.policies.AtomicActionItemSemanticEditPolicy;
...
public class AtomicActionEditPart extends ShapeNodeEditPart {
		...
		if (childEditPart instanceof AtomicActionNameEditPart) {
			((AtomicActionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureAtomicActionFigureNameLabel());
			return true;
		}
		return false;
	}
	...
	public class AtomicActionFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureAtomicActionFigureNameLabel;
		...
		private void createContents() {
			...
			fFigureAtomicActionFigureNameLabel = new WrappingLabel();
			fFigureAtomicActionFigureNameLabel.setText("Atomic Action");

			this.add(fFigureAtomicActionFigureNameLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAtomicActionFigureNameLabel() {
			return fFigureAtomicActionFigureNameLabel;
		}
