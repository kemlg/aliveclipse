...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.service.template.IfThenElse} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IfThenElse_ifCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IfThenElse_ifCondition_feature", "_UI_IfThenElse_type"),
				 TemplatePackage.Literals.IF_THEN_ELSE__IF_CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addThenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IfThenElse_then_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IfThenElse_then_feature", "_UI_IfThenElse_type"),
				 TemplatePackage.Literals.IF_THEN_ELSE__THEN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addElsePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IfThenElse_else_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IfThenElse_else_feature", "_UI_IfThenElse_type"),
				 TemplatePackage.Literals.IF_THEN_ELSE__ELSE,
				 true,
				 false,
				 true,
				 null,
