...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.service.syntax.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SyntaxPackage.Literals.BINDING__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTransportPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_transport_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_transport_feature", "_UI_Binding_type"),
				 SyntaxPackage.Literals.BINDING__TRANSPORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SyntaxPackage.Literals.BINDING__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStylePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_style_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_style_feature", "_UI_Binding_type"),
				 SyntaxPackage.Literals.BINDING__STYLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
