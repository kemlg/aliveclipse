...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.service.syntax.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SyntaxPackage.Literals.MESSAGE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SyntaxPackage.Literals.MESSAGE__PART);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case SyntaxPackage.MESSAGE__NAME:
				...
				return;
			case SyntaxPackage.MESSAGE__PART:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SyntaxPackage.Literals.MESSAGE__PART,
