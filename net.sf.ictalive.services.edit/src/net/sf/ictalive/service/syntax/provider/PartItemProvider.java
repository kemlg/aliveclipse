...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.service.syntax.Part} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SyntaxPackage.Literals.PART__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Part_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Part_type_feature", "_UI_Part_type"),
				 SyntaxPackage.Literals.PART__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addXsdTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Part_xsdType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Part_xsdType_feature", "_UI_Part_type"),
				 SyntaxPackage.Literals.PART__XSD_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addXsdElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Part_xsdElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Part_xsdElement_feature", "_UI_Part_type"),
				 SyntaxPackage.Literals.PART__XSD_ELEMENT,
				 true,
				 false,
				 true,
				 null,
