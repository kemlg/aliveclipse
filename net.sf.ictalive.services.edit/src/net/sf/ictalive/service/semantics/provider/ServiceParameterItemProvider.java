...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.service.semantics.ServiceParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceParameter_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceParameter_type_feature", "_UI_ServiceParameter_type"),
				 SemanticsPackage.Literals.SERVICE_PARAMETER__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceParameter_name_feature", "_UI_ServiceParameter_type"),
				 SemanticsPackage.Literals.SERVICE_PARAMETER__NAME,
				 true,
				 false,
				 false,
