...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.service.ServiceProvider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceProviderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceProvider_exposes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceProvider_exposes_feature", "_UI_ServiceProvider_type"),
				 ServicePackage.Literals.SERVICE_PROVIDER__EXPOSES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceProvider_isType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceProvider_isType_feature", "_UI_ServiceProvider_type"),
				 ServicePackage.Literals.SERVICE_PROVIDER__IS_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServicePackage.Literals.SERVICE_PROVIDER__IMPLEMENTATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicePackage.Literals.SERVICE_PROVIDER__IMPLEMENTATION,
				 ServiceFactory.eINSTANCE.createServiceImplemetation()));
	}
