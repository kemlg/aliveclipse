...
public interface OMFactory extends EFactory
{
   ...
   * @generated
   */
  OMFactory eINSTANCE = OM.impl.OMFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>First Order Quantifier</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>First Order Quantifier</em>'.
   * @generated
   */
  FirstOrderQuantifier createFirstOrderQuantifier();
