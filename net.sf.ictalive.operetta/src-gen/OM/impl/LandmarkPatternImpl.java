 ...
 * <ul>
 *   <li>{@link OM.impl.LandmarkPatternImpl#getLandmarks <em>Landmarks</em>}</li>
 *   <li>{@link OM.impl.LandmarkPatternImpl#getLandmarkOrder <em>Landmark Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LandmarkPatternImpl extends MinimalEObjectImpl.Container implements LandmarkPattern
{
  /**
  ...
  public EList<Landmark> getLandmarks()
  {
    if (landmarks == null)
    {
      landmarks = new EObjectContainmentEList.Resolving<Landmark>(Landmark.class, this, OMPackage.LANDMARK_PATTERN__LANDMARKS);
    }
    return landmarks;
  }
  ...
  public EList<PartialOrder> getLandmarkOrder()
  {
    ...
    {
      landmarkOrder = new EObjectContainmentEList.Resolving<PartialOrder>(PartialOrder.class, this, OMPackage.LANDMARK_PATTERN__LANDMARK_ORDER);
    }
