 ...
 * <ul>
 *   <li>{@link OM.impl.ActionsImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionsImpl extends MinimalEObjectImpl.Container implements Actions
{
  ...
  public EList<ActionDescription> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList.Resolving<ActionDescription>(ActionDescription.class, this, OMPackage.ACTIONS__ACTIONS);
    }
    return actions;
  }
