 ...
 * <ul>
 *   <li>{@link OM.Right#getName <em>Name</em>}</li>
 *   <li>{@link OM.Right#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getRight()
 * @model
 * @generated
 */
public interface Right extends EObject
{
   ...
   * @see #setName(String)
   * @see OM.OMPackage#getRight_Name()
  ...
  /**
   * Sets the value of the '{@link OM.Right#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getRight_Expr()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Right#getExpr <em>Expr</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
