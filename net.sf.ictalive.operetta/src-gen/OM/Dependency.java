 ...
 * <ul>
 *   <li>{@link OM.Dependency#getID <em>ID</em>}</li>
 *   <li>{@link OM.Dependency#getName <em>Name</em>}</li>
 *   <li>{@link OM.Dependency#getObjectOfDependency <em>Object Of Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getDependency()
 * @model abstract="true"
 * @generated
 */
public interface Dependency extends EObject
{
   ...
   * @see #setID(String)
   * @see OM.OMPackage#getDependency_ID()
  ...
  /**
   * Sets the value of the '{@link OM.Dependency#getID <em>ID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getDependency_Name()
   ...
   * @see OM.OMPackage#getDependency_ObjectOfDependency()
   * @model required="true"
   * @generated
   */
