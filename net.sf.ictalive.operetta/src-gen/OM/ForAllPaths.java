 ...
 * <ul>
 *   <li>{@link OM.ForAllPaths#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getForAllPaths()
 * @model
 * @generated
 */
public interface ForAllPaths extends StateFormula
{
   ...
   * @see OM.OMPackage#getForAllPaths_PathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.ForAllPaths#getPathFormula <em>Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
