 ...
 * <ul>
 *   <li>{@link control.impl.SetImpl#getProducedBindingValueSpecifier <em>Produced Binding Value Specifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SetImpl extends ControlConstructImpl implements Set
{
  /**
  ...
  {
		return ControlPackage.Literals.SET;
	}
  ...
  public NotificationChain basicSetProducedBindingValueSpecifier(ValueSpecifierElement newProducedBindingValueSpecifier, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ControlPackage.SET__PRODUCED_BINDING_VALUE_SPECIFIER, oldProducedBindingValueSpecifier, newProducedBindingValueSpecifier);
  ...
  public void setProducedBindingValueSpecifier(ValueSpecifierElement newProducedBindingValueSpecifier)
  {
		if (newProducedBindingValueSpecifier != producedBindingValueSpecifier) {
			...
			if (producedBindingValueSpecifier != null)
				msgs = ((InternalEObject)producedBindingValueSpecifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ControlPackage.SET__PRODUCED_BINDING_VALUE_SPECIFIER, null, msgs);
			if (newProducedBindingValueSpecifier != null)
				msgs = ((InternalEObject)newProducedBindingValueSpecifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ControlPackage.SET__PRODUCED_BINDING_VALUE_SPECIFIER, null, msgs);
			msgs = basicSetProducedBindingValueSpecifier(newProducedBindingValueSpecifier, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControlPackage.SET__PRODUCED_BINDING_VALUE_SPECIFIER, newProducedBindingValueSpecifier, newProducedBindingValueSpecifier));
	}
  ...
  {
		switch (featureID) {
			case ControlPackage.SET__PRODUCED_BINDING_VALUE_SPECIFIER:
