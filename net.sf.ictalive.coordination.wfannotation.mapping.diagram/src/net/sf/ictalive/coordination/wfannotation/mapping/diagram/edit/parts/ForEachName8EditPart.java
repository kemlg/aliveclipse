 ...
 * @generated
 */
public class ForEachName8EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ForEachName8EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MappingParserProvider
					.getParser(
							MappingElementTypes.ForEach_3153,
							getParserElement(),
							MappingVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.ForEachName8EditPart.VISUAL_ID));
		}
		return parser;
	}
