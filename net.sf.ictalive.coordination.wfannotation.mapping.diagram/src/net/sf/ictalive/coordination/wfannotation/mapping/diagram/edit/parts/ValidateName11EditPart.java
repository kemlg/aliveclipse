 ...
 * @generated
 */
public class ValidateName11EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValidateName11EditPart(View view) {
		super(view);
	}
			...
			parser = MappingParserProvider
					.getParser(
							...
							MappingVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.ValidateName11EditPart.VISUAL_ID));
		}
		return parser;
	}
