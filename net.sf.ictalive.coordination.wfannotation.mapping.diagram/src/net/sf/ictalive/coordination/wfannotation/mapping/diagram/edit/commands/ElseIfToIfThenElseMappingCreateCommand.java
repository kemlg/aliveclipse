 ...
 * @generated
 */
public class ElseIfToIfThenElseMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public ElseIfToIfThenElseMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ElseIf) {
			return false;
		}
		if (target != null && false == target instanceof IfThenElse) {
			return false;
		}
		if (getSource() == null) {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateElseIfToIfThenElseMapping_4023(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElseIfToIfThenElseMapping newElement = MappingFactory.eINSTANCE
				.createElseIfToIfThenElseMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(ElseIfToIfThenElseMapping newElement,
	 ...
	 * @generated
	 */
	protected ElseIf getSource() {
		return (ElseIf) source;
	}

	/**
	 * @generated
	 */
	protected IfThenElse getTarget() {
		return (IfThenElse) target;
	}
