...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While9CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While9ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While9EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While9EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While9ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new While9CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileName9EditPart) {
			((WhileName9EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureWhileFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof WhileWhileCompartment9EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WhileWhileCompartment9EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WhileWhileCompartment9EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((WhileWhileCompartment9EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
