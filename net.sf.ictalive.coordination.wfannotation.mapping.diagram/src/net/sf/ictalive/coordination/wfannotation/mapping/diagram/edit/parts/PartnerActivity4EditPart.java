...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity4CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartnerActivity4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartnerActivity4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartnerActivity4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PartnerActivity4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartnerActivityName4EditPart) {
			((PartnerActivityName4EditPart) childEditPart)
