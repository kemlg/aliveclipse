...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke10CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke10EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke10EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke10CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName10EditPart) {
			((InvokeName10EditPart) childEditPart).setLabel(getPrimaryShape()
