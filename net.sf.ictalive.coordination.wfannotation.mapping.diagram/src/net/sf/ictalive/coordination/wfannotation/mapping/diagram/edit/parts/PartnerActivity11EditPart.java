...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity11CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartnerActivity11EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartnerActivity11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartnerActivity11ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PartnerActivity11CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartnerActivityName11EditPart) {
			((PartnerActivityName11EditPart) childEditPart)
