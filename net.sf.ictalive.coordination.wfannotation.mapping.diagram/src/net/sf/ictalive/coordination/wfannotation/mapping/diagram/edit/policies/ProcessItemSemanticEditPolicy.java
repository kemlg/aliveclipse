...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.ProcessProcessCompartmentEditPart;
...
public class ProcessItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == ProcessToCompositeActionMappingEditPart.VISUAL_ID) {
