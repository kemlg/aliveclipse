...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.ChoiceCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.ChoiceItemSemanticEditPolicy;
...
public class ChoiceEditPart extends ShapeNodeEditPart {
	...
	public class ChoiceFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			WrappingLabel choiceFigureLabel0 = new WrappingLabel();
			choiceFigureLabel0.setText("Choice");

			this.add(choiceFigureLabel0);
