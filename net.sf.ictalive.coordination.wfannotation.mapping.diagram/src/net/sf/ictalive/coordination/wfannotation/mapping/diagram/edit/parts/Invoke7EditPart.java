...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke7CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke7ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke7CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName7EditPart) {
			((InvokeName7EditPart) childEditPart).setLabel(getPrimaryShape()
