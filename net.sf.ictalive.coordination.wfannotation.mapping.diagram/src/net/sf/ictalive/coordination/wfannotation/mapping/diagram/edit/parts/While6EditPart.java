...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While6CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new While6CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileName6EditPart) {
			((WhileName6EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureWhileFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof WhileWhileCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WhileWhileCompartment6EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WhileWhileCompartment6EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((WhileWhileCompartment6EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
