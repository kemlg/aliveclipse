...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While10CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While10EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While10EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new While10CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileName10EditPart) {
			((WhileName10EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureWhileFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof WhileWhileCompartment10EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WhileWhileCompartment10EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WhileWhileCompartment10EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((WhileWhileCompartment10EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
