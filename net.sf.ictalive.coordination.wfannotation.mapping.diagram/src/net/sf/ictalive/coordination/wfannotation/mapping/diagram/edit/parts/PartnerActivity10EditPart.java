...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity10CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartnerActivity10EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartnerActivity10EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartnerActivity10ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PartnerActivity10CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartnerActivityName10EditPart) {
			((PartnerActivityName10EditPart) childEditPart)
