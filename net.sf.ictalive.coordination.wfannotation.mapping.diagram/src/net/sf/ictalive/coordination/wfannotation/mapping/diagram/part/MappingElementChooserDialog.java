 ...
 * @generated
 */
public class MappingElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MappingElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.MappingElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "bpel".equals(fileExtension) || "actions".equals(fileExtension); //$NON-NLS-1$ //$NON-NLS-2$
	}
