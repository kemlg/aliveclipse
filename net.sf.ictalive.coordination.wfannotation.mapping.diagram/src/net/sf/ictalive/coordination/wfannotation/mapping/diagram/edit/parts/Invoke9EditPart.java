...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke9CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke9ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke9EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke9EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke9ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke9CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName9EditPart) {
			((InvokeName9EditPart) childEditPart).setLabel(getPrimaryShape()
