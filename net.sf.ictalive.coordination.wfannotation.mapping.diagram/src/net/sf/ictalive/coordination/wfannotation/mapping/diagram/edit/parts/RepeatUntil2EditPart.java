...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil2CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil2ItemSemanticEditPolicy;
...
public class RepeatUntil2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RepeatUntil2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatUntilNameEditPart) {
			((RepeatUntilNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatUntilFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRepeatUntilFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartmentEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
