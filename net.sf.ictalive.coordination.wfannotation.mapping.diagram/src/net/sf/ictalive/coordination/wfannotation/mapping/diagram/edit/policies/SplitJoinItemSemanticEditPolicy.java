...
public class SplitJoinItemSemanticEditPolicy extends
	...
	public SplitJoinItemSemanticEditPolicy() {
		super(MappingElementTypes.SplitJoin_2016);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(incomingLink) == FlowToSplitJoinMappingEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == SplitJoinComponentsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
