 ...
 * @generated
 */
public class ForToRepeatWhileMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public ForToRepeatWhileMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ForEach) {
			return false;
		}
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateForToRepeatWhileMapping_4021(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ForToRepeatWhileMapping newElement = MappingFactory.eINSTANCE
				.createForToRepeatWhileMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(ForToRepeatWhileMapping newElement,
