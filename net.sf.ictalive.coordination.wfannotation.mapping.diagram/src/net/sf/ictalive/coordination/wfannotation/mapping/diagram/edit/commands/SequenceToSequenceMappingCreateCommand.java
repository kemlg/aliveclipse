 ...
 * @generated
 */
public class SequenceToSequenceMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public SequenceToSequenceMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Sequence) {
			return false;
		}
		if (target != null
				&& false == target instanceof net.sf.ictalive.owls.process.Sequence) {
			return false;
		}
		if (getSource() == null) {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSequenceToSequenceMapping_4016(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SequenceToSequenceMapping newElement = MappingFactory.eINSTANCE
				.createSequenceToSequenceMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(SequenceToSequenceMapping newElement,
	 ...
	 * @generated
	 */
	protected net.sf.ictalive.owls.process.Sequence getTarget() {
		return (net.sf.ictalive.owls.process.Sequence) target;
	}
