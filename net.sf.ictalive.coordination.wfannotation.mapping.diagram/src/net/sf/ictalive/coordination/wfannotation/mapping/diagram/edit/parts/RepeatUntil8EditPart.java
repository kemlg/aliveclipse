...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil8CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RepeatUntil8EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatUntil8EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatUntil8ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RepeatUntil8CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartment7EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRepeatUntilFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartment7EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilCompartment7EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
