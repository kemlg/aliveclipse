 ...
 * @generated
 */
public class IfToIfThenElseMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public IfToIfThenElseMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof If) {
			return false;
		}
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateIfToIfThenElseMapping_4017(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		IfToIfThenElseMapping newElement = MappingFactory.eINSTANCE
				.createIfToIfThenElseMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(IfToIfThenElseMapping newElement,
