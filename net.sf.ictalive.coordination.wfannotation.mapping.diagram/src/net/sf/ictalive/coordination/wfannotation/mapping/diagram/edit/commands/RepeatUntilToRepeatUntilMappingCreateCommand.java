 ...
 * @generated
 */
public class RepeatUntilToRepeatUntilMappingCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public RepeatUntilToRepeatUntilMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof RepeatUntil) {
			return false;
		}
		if (target != null
				&& false == target instanceof net.sf.ictalive.owls.process.RepeatUntil) {
			return false;
		}
		if (getSource() == null) {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateRepeatUntilToRepeatUntilMapping_4019(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		RepeatUntilToRepeatUntilMapping newElement = MappingFactory.eINSTANCE
				.createRepeatUntilToRepeatUntilMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(RepeatUntilToRepeatUntilMapping newElement,
	 ...
	 * @generated
	 */
	protected RepeatUntil getSource() {
		return (RepeatUntil) source;
	}

	/**
	 * @generated
	 */
	protected net.sf.ictalive.owls.process.RepeatUntil getTarget() {
		return (net.sf.ictalive.owls.process.RepeatUntil) target;
	}
