...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.SequenceToSequenceMappingCreateCommand;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.SequenceToSequenceMappingReorientCommand;
...
public class SequenceItemSemanticEditPolicy extends
	...
	public SequenceItemSemanticEditPolicy() {
		super(MappingElementTypes.Sequence_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(incomingLink) == SequenceToSequenceMappingEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == SequenceComponentsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (MappingElementTypes.SequenceToSequenceMapping_4016 == req
				.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (MappingElementTypes.SequenceToSequenceMapping_4016 == req
				.getElementType()) {
			return getGEFWrapper(new SequenceToSequenceMappingCreateCommand(
	...
	protected Command getReorientRelationshipCommand(
		...
		case SequenceToSequenceMappingEditPart.VISUAL_ID:
			return getGEFWrapper(new SequenceToSequenceMappingReorientCommand(
					req));
