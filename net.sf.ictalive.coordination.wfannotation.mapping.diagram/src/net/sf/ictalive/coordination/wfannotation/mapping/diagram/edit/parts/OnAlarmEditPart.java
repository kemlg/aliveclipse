...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.OnAlarmCanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.OnAlarmItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OnAlarmEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public OnAlarmEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OnAlarmItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OnAlarmCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OnAlarmOnAlarmCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureOnAlarmFigureTitleLabel();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((OnAlarmOnAlarmCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OnAlarmOnAlarmCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureOnAlarmFigureTitleLabel();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((OnAlarmOnAlarmCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
