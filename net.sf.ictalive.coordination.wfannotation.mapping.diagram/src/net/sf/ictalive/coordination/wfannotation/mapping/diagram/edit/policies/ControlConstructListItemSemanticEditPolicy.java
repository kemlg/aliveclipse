...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.ControlConstructListRestCreateCommand;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.ControlConstructListRestReorientCommand;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.SequenceComponentsCreateCommand;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.SequenceComponentsReorientCommand;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.ControlConstructListFirstEditPart;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.ControlConstructListRestEditPart;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.SequenceComponentsEditPart;
...
public class ControlConstructListItemSemanticEditPolicy extends
	...
	public ControlConstructListItemSemanticEditPolicy() {
		super(MappingElementTypes.ControlConstructList_2009);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(incomingLink) == SequenceComponentsEditPart.VISUAL_ID) {
			...
			if (MappingVisualIDRegistry.getVisualID(incomingLink) == ControlConstructListRestEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == ControlConstructListRestEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == ControlConstructListFirstEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (MappingElementTypes.SequenceComponents_4007 == req.getElementType()) {
			return null;
		}
		if (MappingElementTypes.ControlConstructListRest_4009 == req
				.getElementType()) {
