 ...
 * @generated
 */
public class WhileToRepeatWhileMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public WhileToRepeatWhileMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof While) {
			return false;
		}
		if (target != null && false == target instanceof RepeatWhile) {
			return false;
		}
		if (getSource() == null) {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateWhileToRepeatWhileMapping_4018(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		WhileToRepeatWhileMapping newElement = MappingFactory.eINSTANCE
				.createWhileToRepeatWhileMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(WhileToRepeatWhileMapping newElement,
	 ...
	 * @generated
	 */
	protected RepeatWhile getTarget() {
		return (RepeatWhile) target;
	}
