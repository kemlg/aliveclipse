...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke8CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke8EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke8EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke8ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke8CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName8EditPart) {
			((InvokeName8EditPart) childEditPart).setLabel(getPrimaryShape()
