...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil3CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil3ItemSemanticEditPolicy;
...
public class RepeatUntil3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RepeatUntil3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRepeatUntilFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
