...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke5CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke5CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName5EditPart) {
			((InvokeName5EditPart) childEditPart).setLabel(getPrimaryShape()
