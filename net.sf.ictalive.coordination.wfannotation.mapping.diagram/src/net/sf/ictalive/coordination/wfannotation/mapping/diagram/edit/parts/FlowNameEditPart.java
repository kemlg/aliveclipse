 ...
 * @generated
 */
public class FlowNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MappingParserProvider
					.getParser(
							MappingElementTypes.Flow_3007,
							getParserElement(),
							MappingVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.FlowNameEditPart.VISUAL_ID));
		}
		return parser;
	}
