...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke11CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke11EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke11ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke11CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName11EditPart) {
			((InvokeName11EditPart) childEditPart).setLabel(getPrimaryShape()
