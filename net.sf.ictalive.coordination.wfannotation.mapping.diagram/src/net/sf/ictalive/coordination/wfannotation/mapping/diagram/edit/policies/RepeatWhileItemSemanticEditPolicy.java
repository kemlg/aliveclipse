...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.RepeatWhileRepeatWhileCompartmentEditPart;
 ...
 * @generated
 */
public class RepeatWhileItemSemanticEditPolicy extends
		MappingBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RepeatWhileItemSemanticEditPolicy() {
		super(MappingElementTypes.RepeatWhile_2011);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(incomingLink) == WhileToRepeatWhileMappingEditPart.VISUAL_ID) {
			...
			if (MappingVisualIDRegistry.getVisualID(incomingLink) == ForToRepeatWhileMappingEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == RepeatWhileWhileProcessEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
