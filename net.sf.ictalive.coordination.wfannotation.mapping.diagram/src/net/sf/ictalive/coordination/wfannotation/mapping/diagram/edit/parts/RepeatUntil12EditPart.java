...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil12CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.RepeatUntil12ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RepeatUntil12EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RepeatUntil12EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatUntil12ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RepeatUntil12CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatUntilName11EditPart) {
			((RepeatUntilName11EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRepeatUntilFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartment11EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRepeatUntilFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((RepeatUntilRepeatUntilCompartment11EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RepeatUntilRepeatUntilCompartment11EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((RepeatUntilRepeatUntilCompartment11EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
