...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While11CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While11EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While11ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new While11CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileName11EditPart) {
			((WhileName11EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureWhileFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof WhileWhileCompartment11EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WhileWhileCompartment11EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WhileWhileCompartment11EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((WhileWhileCompartment11EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
