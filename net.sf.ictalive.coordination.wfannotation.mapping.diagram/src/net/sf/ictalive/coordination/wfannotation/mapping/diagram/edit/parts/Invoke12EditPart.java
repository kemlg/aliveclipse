...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke12CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke12ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke12EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke12EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke12ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke12CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName12EditPart) {
			((InvokeName12EditPart) childEditPart).setLabel(getPrimaryShape()
