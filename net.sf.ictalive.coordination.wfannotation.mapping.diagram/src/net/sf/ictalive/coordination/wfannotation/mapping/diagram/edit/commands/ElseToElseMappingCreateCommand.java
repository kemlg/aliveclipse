 ...
 * @generated
 */
public class ElseToElseMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public ElseToElseMappingCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Else) {
			return false;
		}
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateElseToElseMapping_4024(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElseToElseMapping newElement = MappingFactory.eINSTANCE
				.createElseToElseMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(ElseToElseMapping newElement,
	 ...
	 * @generated
	 */
	protected ControlConstruct getTarget() {
		return (ControlConstruct) target;
	}
