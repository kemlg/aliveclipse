...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.MappingContainerItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MappingContainerEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public MappingContainerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MappingContainerItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MappingContainerCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new MappingCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
