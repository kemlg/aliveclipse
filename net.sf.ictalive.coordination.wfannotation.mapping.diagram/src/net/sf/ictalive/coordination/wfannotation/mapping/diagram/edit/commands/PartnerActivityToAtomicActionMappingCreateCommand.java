 ...
 * @generated
 */
public class PartnerActivityToAtomicActionMappingCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public PartnerActivityToAtomicActionMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof PartnerActivity) {
			return false;
		}
		if (target != null && false == target instanceof AtomicAction) {
			return false;
		}
		if (getSource() == null) {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreatePartnerActivityToAtomicActionMapping_4001(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		PartnerActivityToAtomicActionMapping newElement = MappingFactory.eINSTANCE
				.createPartnerActivityToAtomicActionMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(PartnerActivityToAtomicActionMapping newElement,
	 ...
	 * @generated
	 */
	protected PartnerActivity getSource() {
		return (PartnerActivity) source;
	}

	/**
	 * @generated
	 */
	protected AtomicAction getTarget() {
		return (AtomicAction) target;
	}
