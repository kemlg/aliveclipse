 ...
 * @generated
 */
public class RepeatUntilUntilProcessCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RepeatUntilUntilProcessCreateCommand(
	...
	public boolean canExecute() {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateRepeatUntilUntilProcess_4012(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setUntilProcess(getTarget());
		}
