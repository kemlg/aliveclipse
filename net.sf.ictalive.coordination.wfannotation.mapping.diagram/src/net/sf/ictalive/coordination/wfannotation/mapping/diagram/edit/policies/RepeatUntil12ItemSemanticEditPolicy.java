...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.RepeatUntilRepeatUntilCompartment11EditPart;
 ...
 * @generated
 */
public class RepeatUntil12ItemSemanticEditPolicy extends
		MappingBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RepeatUntil12ItemSemanticEditPolicy() {
		super(MappingElementTypes.RepeatUntil_3270);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == RepeatUntilToRepeatUntilMappingEditPart.VISUAL_ID) {
