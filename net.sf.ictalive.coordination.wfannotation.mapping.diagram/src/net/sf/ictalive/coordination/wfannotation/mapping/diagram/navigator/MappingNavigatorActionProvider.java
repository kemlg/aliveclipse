...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.part.MappingDiagramEditor;
 ...
 * @generated
 */
public class MappingNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof MappingNavigatorItem) {
					selectedElement = ((MappingNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (MappingContainerEditPart.MODEL_ID
							.equals(MappingVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, MappingDiagramEditor.ID);
