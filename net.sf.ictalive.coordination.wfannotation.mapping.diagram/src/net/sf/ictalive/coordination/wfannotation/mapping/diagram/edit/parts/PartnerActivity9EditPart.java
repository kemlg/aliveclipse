...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity9CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity9ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartnerActivity9EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartnerActivity9EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartnerActivity9ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PartnerActivity9CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartnerActivityName9EditPart) {
			((PartnerActivityName9EditPart) childEditPart)
