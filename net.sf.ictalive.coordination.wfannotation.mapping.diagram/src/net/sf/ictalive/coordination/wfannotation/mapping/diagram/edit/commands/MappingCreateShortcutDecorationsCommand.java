 ...
 * @generated
 */
public class MappingCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public MappingCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", MappingContainerEditPart.MODEL_ID); //$NON-NLS-1$
