...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.custom.CreateMissingShortcuts;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.commands.MappingCreateShortcutDecorationsCommand;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.MappingContainerCanonicalEditPolicy;
...
public class CreateShortcutAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		MappingElementChooserDialog elementChooser = new MappingElementChooserDialog(
				shell, view);
		...
		CreateMissingShortcuts.createMissingShortcuts(selectedElement,
				(Diagram) view, editingDomain);
		...
		ICommand command = new CreateCommand(editingDomain, viewDescriptor,
				view);
		command = command.compose(new MappingCreateShortcutDecorationsCommand(
		...
		((MappingContainerCanonicalEditPolicy) selectedDiagramPart
