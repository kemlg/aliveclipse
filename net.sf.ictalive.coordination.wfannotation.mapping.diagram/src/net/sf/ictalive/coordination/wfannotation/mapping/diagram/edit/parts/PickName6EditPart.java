 ...
 * @generated
 */
public class PickName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PickName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MappingParserProvider
					.getParser(
							MappingElementTypes.Pick_3131,
							getParserElement(),
							MappingVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.PickName6EditPart.VISUAL_ID));
		}
		return parser;
	}
