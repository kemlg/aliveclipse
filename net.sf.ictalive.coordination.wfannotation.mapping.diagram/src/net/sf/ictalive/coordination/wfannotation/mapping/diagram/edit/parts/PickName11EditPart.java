 ...
 * @generated
 */
public class PickName11EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PickName11EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MappingParserProvider
					.getParser(
							MappingElementTypes.Pick_3252,
							getParserElement(),
							MappingVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.PickName11EditPart.VISUAL_ID));
		}
		return parser;
	}
