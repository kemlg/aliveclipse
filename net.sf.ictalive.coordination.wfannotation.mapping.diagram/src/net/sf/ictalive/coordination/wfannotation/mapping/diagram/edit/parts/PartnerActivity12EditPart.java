...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity12CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.PartnerActivity12ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartnerActivity12EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartnerActivity12EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartnerActivity12ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PartnerActivity12CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartnerActivityName12EditPart) {
			((PartnerActivityName12EditPart) childEditPart)
