 ...
 * @generated
 */
public class RepeatWhileWhileProcessCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RepeatWhileWhileProcessCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof RepeatWhile) {
			return false;
		}
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateRepeatWhileWhileProcess_4013(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setWhileProcess(getTarget());
		}
	 ...
	 * @generated
	 */
	protected RepeatWhile getSource() {
		return (RepeatWhile) source;
	}
