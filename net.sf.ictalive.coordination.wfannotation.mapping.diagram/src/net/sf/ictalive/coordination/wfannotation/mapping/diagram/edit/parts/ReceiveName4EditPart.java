 ...
 * @generated
 */
public class ReceiveName4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ReceiveName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MappingParserProvider
					.getParser(
							MappingElementTypes.Receive_3096,
							getParserElement(),
							MappingVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.ReceiveName4EditPart.VISUAL_ID));
		}
		return parser;
	}
