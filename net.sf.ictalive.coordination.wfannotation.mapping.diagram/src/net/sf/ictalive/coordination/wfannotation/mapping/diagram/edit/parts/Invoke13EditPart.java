...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke13CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.Invoke13ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke13EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke13EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke13ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Invoke13CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName13EditPart) {
			((InvokeName13EditPart) childEditPart).setLabel(getPrimaryShape()
