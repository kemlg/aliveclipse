 ...
 * @generated
 */
public class FlowToSplitJoinMappingCreateCommand extends EditElementCommand {
	 ...
	 * @generated NOT
	 */
	public FlowToSplitJoinMappingCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Flow) {
			return false;
		}
		if (target != null && false == target instanceof SplitJoin) {
			return false;
		}
		if (getSource() == null) {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateFlowToSplitJoinMapping_4020(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		FlowToSplitJoinMapping newElement = MappingFactory.eINSTANCE
				.createFlowToSplitJoinMapping();
	 ...
	 * @generated
	 */
	protected void doConfigure(FlowToSplitJoinMapping newElement,
	 ...
	 * @generated
	 */
	protected SplitJoin getTarget() {
		return (SplitJoin) target;
	}
