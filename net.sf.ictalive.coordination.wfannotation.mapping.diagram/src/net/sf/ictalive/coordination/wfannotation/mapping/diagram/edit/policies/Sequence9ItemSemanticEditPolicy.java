...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.parts.SequenceSequenceCompartment8EditPart;
 ...
 * @generated
 */
public class Sequence9ItemSemanticEditPolicy extends
		MappingBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Sequence9ItemSemanticEditPolicy() {
		super(MappingElementTypes.Sequence_3290);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MappingVisualIDRegistry.getVisualID(outgoingLink) == SequenceToSequenceMappingEditPart.VISUAL_ID) {
