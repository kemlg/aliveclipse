 ...
 * @generated
 */
public class IfThenElseThenReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IfThenElseThenReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIfThenElseThen_4010(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MappingBaseItemSemanticEditPolicy.LinkConstraints
				.canExistIfThenElseThen_4010(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setThen(null);
		getNewSource().setThen(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setThen(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
