...
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While7CanonicalEditPolicy;
import net.sf.ictalive.coordination.wfannotation.mapping.diagram.edit.policies.While7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While7ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new While7CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileName7EditPart) {
			((WhileName7EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureWhileFigureNameLabel());
			return true;
		}
		if (childEditPart instanceof WhileWhileCompartment7EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WhileWhileCompartment7EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WhileWhileCompartment7EditPart) {
			IFigure pane = getPrimaryShape().getFigureWhileFigureContainer();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((WhileWhileCompartment7EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
