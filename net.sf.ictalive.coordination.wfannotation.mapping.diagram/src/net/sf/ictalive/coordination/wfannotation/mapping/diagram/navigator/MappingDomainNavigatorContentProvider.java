 ...
 * @generated
 */
public class MappingDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MappingDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MappingDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((MappingDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MappingDomainNavigatorItem((EObject) objects[i],
