...
public class MultiplyServiceSimple {

	Method serviceMethod;
	{
		try {
			serviceMethod = getClass().getMethod("multiply", ANumber.class, ANumber.class);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}

	@OwlsService(name = "MulService", label = "Multiplication Service")
	@OwlsOutParam(name = "rv", owlType = "#Integer", bindings = { @OwlsBinding(from = "value", to = "hasValue") })
	@WebMethod
	public ANumber multiply(
