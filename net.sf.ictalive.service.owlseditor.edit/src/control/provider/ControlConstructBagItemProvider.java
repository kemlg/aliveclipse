...
/**
 * This is the item provider adapter for a {@link control.ControlConstructBag} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlPackage.Literals.CONTROL_CONSTRUCT_BAG__FIRST);
			childrenFeatures.add(ControlPackage.Literals.CONTROL_CONSTRUCT_BAG__REST);
		}
  ...
  {
		String label = ((ControlConstructBag)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ControlConstructBag_type") :
			getString("_UI_ControlConstructBag_type") + " " + label;
	}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(ControlPackage.Literals.CONTROL_CONSTRUCT_BAG__REST,
