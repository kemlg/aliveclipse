...
/**
 * This is the item provider adapter for a {@link control.RepeatUntil} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlPackage.Literals.REPEAT_UNTIL__UNTIL_CONDITION);
			childrenFeatures.add(ControlPackage.Literals.REPEAT_UNTIL__UNTIL_PROCESS);
		}
  ...
  public String getText(Object object)
  {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_RepeatUntil_type") :
			getString("_UI_RepeatUntil_type") + " " + label;
	}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(ControlPackage.Literals.REPEAT_UNTIL__UNTIL_CONDITION,
		...
		newChildDescriptors.add
			(createChildParameter
				(ControlPackage.Literals.REPEAT_UNTIL__UNTIL_PROCESS,
