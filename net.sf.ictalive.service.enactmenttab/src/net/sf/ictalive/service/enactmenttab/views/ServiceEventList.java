...
public class ServiceEventList extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "alive_service_enactment_tab.viewer");
		makeActions();
		hookContextMenu();
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				ServiceEventList.this.fillContextMenu(manager);
			}
		});
