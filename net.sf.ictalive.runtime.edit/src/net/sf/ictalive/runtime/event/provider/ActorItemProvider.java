...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.runtime.event.Actor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEmitPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_url_feature", "_UI_Actor_type"),
				 EventPackage.Literals.ACTOR__URL,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Emit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEmitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_emit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_emit_feature", "_UI_Actor_type"),
				 EventPackage.Literals.ACTOR__EMIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAgentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Actor_agent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Actor_agent_feature", "_UI_Actor_type"),
				 EventPackage.Literals.ACTOR__AGENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EventPackage.Literals.ACTOR__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
