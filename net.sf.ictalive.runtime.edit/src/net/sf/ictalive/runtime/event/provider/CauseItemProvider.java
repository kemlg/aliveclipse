...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.runtime.event.Cause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CauseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cause_event_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cause_event_feature", "_UI_Cause_type"),
				 EventPackage.Literals.CAUSE__EVENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cause_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cause_type_feature", "_UI_Cause_type"),
				 EventPackage.Literals.CAUSE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ProvenanceType labelValue = ((Cause)object).getType();
