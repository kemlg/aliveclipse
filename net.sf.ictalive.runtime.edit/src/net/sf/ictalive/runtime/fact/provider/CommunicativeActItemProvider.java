...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.runtime.fact.CommunicativeAct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommunicativeActItemProvider
	 ...
	 * @generated
	 */
	public CommunicativeActItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addReceiverPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CommunicativeAct_receiver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CommunicativeAct_receiver_feature", "_UI_CommunicativeAct_type"),
				 FactPackage.Literals.COMMUNICATIVE_ACT__RECEIVER,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_CommunicativeAct_type");
	}
