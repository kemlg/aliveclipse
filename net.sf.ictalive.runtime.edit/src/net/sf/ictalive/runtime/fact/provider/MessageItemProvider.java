...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.runtime.fact.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_object_feature", "_UI_Message_type"),
				 FactPackage.Literals.MESSAGE__OBJECT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_body_feature", "_UI_Message_type"),
				 FactPackage.Literals.MESSAGE__BODY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Message)object).getBody();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case FactPackage.MESSAGE__BODY:
