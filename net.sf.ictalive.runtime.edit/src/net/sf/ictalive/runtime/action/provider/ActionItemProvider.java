...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.runtime.action.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addByActorPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the By Actor feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addByActorPropertyDescriptor(Object object) {
	...
	protected void addCausePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_cause_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_cause_feature", "_UI_Action_type"),
				 ActionPackage.Literals.ACTION__CAUSE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEnactmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_enactment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_enactment_feature", "_UI_Action_type"),
				 ActionPackage.Literals.ACTION__ENACTMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActionPackage.Literals.ACTION__RESULT);
			childrenFeatures.add(ActionPackage.Literals.ACTION__INPUT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActionPackage.Literals.ACTION__RESULT,
				 ActionFactory.eINSTANCE.createResult()));

		newChildDescriptors.add
			(createChildParameter
				(ActionPackage.Literals.ACTION__INPUT,
