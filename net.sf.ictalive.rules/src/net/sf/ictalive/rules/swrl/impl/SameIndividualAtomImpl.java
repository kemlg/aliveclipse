 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.rules.swrl.impl.SameIndividualAtomImpl#getArgs <em>Args</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SameIndividualAtomImpl extends AtomImpl implements SameIndividualAtom {
	...
	protected EClass eStaticClass() {
		return SwrlPackage.Literals.SAME_INDIVIDUAL_ATOM;
	}
	...
	public EList<IObject> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<IObject>(IObject.class, this, SwrlPackage.SAME_INDIVIDUAL_ATOM__ARGS);
		}
		return args;
	}
