 ...
 * $Id$
 */
package net.sf.ictalive.rules.ruleml.util;

import java.util.List;

import net.sf.ictalive.rules.ruleml.*;
...
public class RulemlSwitch<T> {
	 ...
	 * @generated
	 */
	protected static RulemlPackage modelPackage;
	...
	public RulemlSwitch() {
		if (modelPackage == null) {
			modelPackage = RulemlPackage.eINSTANCE;
		}
	}
