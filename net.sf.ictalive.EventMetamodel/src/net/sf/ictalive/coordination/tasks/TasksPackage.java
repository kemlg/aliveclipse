...
public interface TasksPackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://alive/coordinationLevel/tasks/0.3";
	 ...
	 * @ordered
	 */
	int TASKS_COLLECTION__CONTROL_CONSTRUCTS = 1;
	 ...
	 * @ordered
	 */
	int PLANS_COLLECTION__VERSION = 2;
	 ...
	 * @ordered
	 */
	int PLANS_COLLECTION_FEATURE_COUNT = 3;
	...
	/**
	 * Returns the meta object for the reference list '{@link net.sf.ictalive.coordination.tasks.Task#getComponents <em>Components</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link net.sf.ictalive.coordination.tasks.TasksCollection#getControlConstructs <em>Control Constructs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Control Constructs</em>'.
	 * @see net.sf.ictalive.coordination.tasks.TasksCollection#getControlConstructs()
	 * @see #getTasksCollection()
	 * @generated
	 */
	EReference getTasksCollection_ControlConstructs();
	...
	interface Literals
	{
		 ...
		 * @generated
		 */
		EReference TASKS_COLLECTION__CONTROL_CONSTRUCTS = eINSTANCE.getTasksCollection_ControlConstructs();
