...
public class TasksPackageImpl extends EPackageImpl implements TasksPackage
{
	...
	public static TasksPackage init()
	{
		...
		TasksPackageImpl theTasksPackage = (TasksPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof TasksPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new TasksPackageImpl());
	...
	{
		return (EReference)tasksCollectionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTasksCollection_ControlConstructs()
	{
	...
	{
		return (EReference)plansCollectionEClass.getEStructuralFeatures().get(0);
	}
	...
	{
		return (EAttribute)plansCollectionEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(tasksCollectionEClass, TASKS_COLLECTION__CONTROL_CONSTRUCTS);
	...
	public void initializePackageContents()
	{
		...
		initEReference(getTasksCollection_ControlConstructs(), theProcessPackage.getControlConstruct(), null, "controlConstructs", null, 0, -1, TasksCollection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
