 ...
 *   <li>{@link net.sf.ictalive.coordination.actions.ActionsCollection#getControlConstructs <em>Control Constructs</em>}</li>
...
public interface ActionsCollection extends EObject
{
	 ...
	 * @see net.sf.ictalive.coordination.actions.ActionsPackage#getActionsCollection_ControlConstructs()
	 * @model containment="true"
	 * @generated
	 */
