 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.EventModel.Action.impl.NotifyStateOfWorldImpl#getStateOfWorld <em>State Of World</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotifyStateOfWorldImpl extends AgentActionImpl implements NotifyStateOfWorld
{
	 ...
	 * @ordered
	 */
	protected EList<EObject> stateOfWorld;
	 ...
	 * @generated
	 */
	public EList<EObject> getStateOfWorld()
	{
		if (stateOfWorld == null)
		{
			stateOfWorld = new EObjectContainmentEList<EObject>(EObject.class, this, ActionPackage.NOTIFY_STATE_OF_WORLD__STATE_OF_WORLD);
		}
		return stateOfWorld;
	}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case ActionPackage.NOTIFY_STATE_OF_WORLD__STATE_OF_WORLD:
				...
				getStateOfWorld().addAll((Collection<? extends EObject>)newValue);
				return;
		}
