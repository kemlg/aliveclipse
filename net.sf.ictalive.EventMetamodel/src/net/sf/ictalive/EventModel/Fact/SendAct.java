 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.EventModel.Fact.SendAct#getSendMessage <em>Send Message</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.EventModel.Fact.FactPackage#getSendAct()
 * @model
 * @generated
 */
public interface SendAct extends CommunicativeAct
{
	 ...
	 * @see net.sf.ictalive.EventModel.Fact.FactPackage#getSendAct_SendMessage()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.EventModel.Fact.SendAct#getSendMessage <em>Send Message</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
