 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.service.template.impl.AnyOrderImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnyOrderImpl extends ControlConstructImpl implements AnyOrder
{
	...
	{
		return TemplatePackage.Literals.ANY_ORDER;
	}
	...
	public NotificationChain basicSetComponents(ControlConstructBag newComponents, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemplatePackage.ANY_ORDER__COMPONENTS, oldComponents, newComponents);
	...
	public void setComponents(ControlConstructBag newComponents)
	{
		if (newComponents != components)
		{
			...
			if (components != null)
				msgs = ((InternalEObject)components).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.ANY_ORDER__COMPONENTS, null, msgs);
			if (newComponents != null)
				msgs = ((InternalEObject)newComponents).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.ANY_ORDER__COMPONENTS, null, msgs);
			msgs = basicSetComponents(newComponents, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.ANY_ORDER__COMPONENTS, newComponents, newComponents));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case TemplatePackage.ANY_ORDER__COMPONENTS:
