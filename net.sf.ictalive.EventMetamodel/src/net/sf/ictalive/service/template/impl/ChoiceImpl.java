 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.service.template.impl.ChoiceImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceImpl extends ControlConstructImpl implements Choice
{
	...
	{
		return TemplatePackage.Literals.CHOICE;
	}
	...
	public NotificationChain basicSetComponents(ControlConstructBag newComponents, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemplatePackage.CHOICE__COMPONENTS, oldComponents, newComponents);
	...
	public void setComponents(ControlConstructBag newComponents)
	{
		if (newComponents != components)
		{
			...
			if (components != null)
				msgs = ((InternalEObject)components).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.CHOICE__COMPONENTS, null, msgs);
			if (newComponents != null)
				msgs = ((InternalEObject)newComponents).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.CHOICE__COMPONENTS, null, msgs);
			msgs = basicSetComponents(newComponents, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.CHOICE__COMPONENTS, newComponents, newComponents));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case TemplatePackage.CHOICE__COMPONENTS:
