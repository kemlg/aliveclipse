...
public class TemplateConstraintImpl extends EObjectImpl implements TemplateConstraint
{
	 ...
	 * @ordered
	 */
	protected EList<Antecedent> body;
	 ...
	 * @generated
	 */
	public EList<Antecedent> getBody()
	{
		if (body == null)
		{
			body = new EObjectContainmentEList<Antecedent>(Antecedent.class, this, TemplatePackage.TEMPLATE_CONSTRAINT__BODY);
		}
		return body;
	}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case TemplatePackage.TEMPLATE_CONSTRAINT__BODY:
				getBody().clear();
				getBody().addAll((Collection<? extends Antecedent>)newValue);
				return;
		}
