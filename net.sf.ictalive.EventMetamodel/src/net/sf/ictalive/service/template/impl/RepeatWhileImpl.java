...
public class RepeatWhileImpl extends IterateImpl implements RepeatWhile
{
	 ...
	 * @ordered
	 */
	protected Antecedent whileCondition;
	 ...
	 * @generated
	 */
	public Antecedent basicGetWhileCondition()
	{
		return whileCondition;
	}
	 ...
	 * @generated
	 */
	public void setWhileCondition(Antecedent newWhileCondition)
	{
		Antecedent oldWhileCondition = whileCondition;
	...
	public void eSet(int featureID, Object newValue)
	{
		...
		{
			case TemplatePackage.REPEAT_WHILE__WHILE_CONDITION:
				setWhileCondition((Antecedent)newValue);
				return;
			case TemplatePackage.REPEAT_WHILE__WHILE_PROCESS:
	...
	public void eUnset(int featureID)
	{
		...
		{
			case TemplatePackage.REPEAT_WHILE__WHILE_CONDITION:
				setWhileCondition((Antecedent)null);
				return;
			case TemplatePackage.REPEAT_WHILE__WHILE_PROCESS:
