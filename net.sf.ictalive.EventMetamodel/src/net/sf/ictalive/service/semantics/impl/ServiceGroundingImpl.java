 ...
 *   <li>{@link net.sf.ictalive.service.semantics.impl.ServiceGroundingImpl#getBindParams <em>Bind Params</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceGroundingImpl extends EObjectImpl implements ServiceGrounding
{
	...
	/**
	 * The cached value of the '{@link #getBindParams() <em>Bind Params</em>}' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBindParams()
	 * @generated
	 * @ordered
	 */
	protected EList<String> bindParams;
	 ...
	 * @generated
	 */
	public EList<String> getBindParams()
	{
		if (bindParams == null)
		{
			bindParams = new EDataTypeUniqueEList<String>(String.class, this, SemanticsPackage.SERVICE_GROUNDING__BIND_PARAMS);
		}
		return bindParams;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case SemanticsPackage.SERVICE_GROUNDING__NAME:
				return getName();
			case SemanticsPackage.SERVICE_GROUNDING__BIND_PARAMS:
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case SemanticsPackage.SERVICE_GROUNDING__BIND_PARAMS:
				getBindParams().clear();
				getBindParams().addAll((Collection<? extends String>)newValue);
				return;
		}
