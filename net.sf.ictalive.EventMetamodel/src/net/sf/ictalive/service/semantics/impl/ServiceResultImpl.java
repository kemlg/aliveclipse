...
public class ServiceResultImpl extends EObjectImpl implements ServiceResult
{
	 ...
	 * @generated
	 */
	public Consequent getResult()
	{
		if (result != null && result.eIsProxy())
		{
			InternalEObject oldResult = (InternalEObject)result;
			result = (Consequent)eResolveProxy(oldResult);
			if (result != oldResult)
			{
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public Consequent basicGetResult()
	{
		return result;
	}
	 ...
	 * @generated
	 */
	public void setResult(Consequent newResult)
	{
		Consequent oldResult = result;
		result = newResult;
		if (eNotificationRequired())
