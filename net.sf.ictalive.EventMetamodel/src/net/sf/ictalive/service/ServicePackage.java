...
public interface ServicePackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://alive/serviceLevel/0.5.4";
	 ...
	 * @ordered
	 */
	int SERVICE_PROVIDER__ACTORS = AgentsPackage.AGENT__ACTORS;
	 ...
	 * @ordered
	 */
	int SERVICE_PROVIDER__PLAY_ROLE = AgentsPackage.AGENT__PLAY_ROLE;
	 ...
	 * @ordered
	 */
	int SERVICE_CONSUMER__ACTORS = AgentsPackage.AGENT__ACTORS;
	 ...
	 * @ordered
	 */
	int SERVICE_CONSUMER__PLAY_ROLE = AgentsPackage.AGENT__PLAY_ROLE;
