...
import net.sf.ictalive.opera.OperaFactory;
 ...
 * @generated
 */
public class OperaPackageImpl extends EPackageImpl implements OperaPackage
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OperaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OperaPackageImpl()
	{
		super(eNS_URI, OperaFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static OperaPackage init()
	{
		if (isInited) return (OperaPackage)EPackage.Registry.INSTANCE.getEPackage(OperaPackage.eNS_URI);

		// Obtain or create and register package
		OperaPackageImpl theOperaPackage = (OperaPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof OperaPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new OperaPackageImpl());
		...
		theOperaPackage.freeze();

		return theOperaPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getOperAModel_OrganisationObjectives()
	{
		return (EReference)operAModelEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public OperaFactory getOperaFactory()
	{
		return (OperaFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(operAModelEClass, OPER_AMODEL__ORGANISATION_OBJECTIVES);
	}
	...
	public void initializePackageContents()
	{
		...
		// Add subpackages
		getESubpackages().add(theOMPackage);
		...
		initEReference(getOperAModel_Om(), theOMPackage.getOM(), null, "om", null, 1, 1, OperAModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperAModel_OrganisationObjectives(), theOMPackage.getObjective(), null, "OrganisationObjectives", null, 1, -1, OperAModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
