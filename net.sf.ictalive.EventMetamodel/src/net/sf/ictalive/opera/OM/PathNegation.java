 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.PathNegation#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getPathNegation()
 * @model
 * @generated
 */
public interface PathNegation extends PathFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getPathNegation_PathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.PathNegation#getPathFormula <em>Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
