 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Always#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getAlways()
 * @model
 * @generated
 */
public interface Always extends PathFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getAlways_PathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Always#getPathFormula <em>Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
