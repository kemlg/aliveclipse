 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Landmark#getName <em>Name</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Landmark#getStateDescription <em>State Description</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Landmark#getEntails <em>Entails</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getLandmark()
 * @model
 * @generated
 */
public interface Landmark extends EObject
{
	 ...
	 * @see #setName(String)
	 * @see net.sf.ictalive.opera.OM.OMPackage#getLandmark_Name()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Landmark#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getLandmark_StateDescription()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Landmark#getStateDescription <em>State Description</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getLandmark_Entails()
	 * @model
	 * @generated
	 */
