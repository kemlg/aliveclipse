 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.SS#getRoles <em>Roles</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.SS#getObjectives <em>Objectives</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.SS#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getSS()
 * @model
 * @generated
 */
public interface SS extends EObject
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getSS_Roles()
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getSS_Objectives()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getSS_Dependencies()
	 * @model containment="true" required="true"
	 * @generated
	 */
