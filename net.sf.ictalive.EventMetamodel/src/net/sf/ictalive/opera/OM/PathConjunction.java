 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.PathConjunction#getLeftPathFormula <em>Left Path Formula</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.PathConjunction#getRightPathFormula <em>Right Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getPathConjunction()
 * @model
 * @generated
 */
public interface PathConjunction extends PathFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getPathConjunction_LeftPathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.PathConjunction#getLeftPathFormula <em>Left Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getPathConjunction_RightPathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.PathConjunction#getRightPathFormula <em>Right Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
