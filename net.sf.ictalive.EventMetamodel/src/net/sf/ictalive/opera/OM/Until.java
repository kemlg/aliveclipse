 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Until#getFromPathFormula <em>From Path Formula</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Until#getUntilPathFormula <em>Until Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getUntil()
 * @model
 * @generated
 */
public interface Until extends PathFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getUntil_FromPathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Until#getFromPathFormula <em>From Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getUntil_UntilPathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Until#getUntilPathFormula <em>Until Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
