 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Disjunction#getLeftStateFormula <em>Left State Formula</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Disjunction#getRightStateFormula <em>Right State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getDisjunction()
 * @model
 * @generated
 */
public interface Disjunction extends StateFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getDisjunction_LeftStateFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Disjunction#getLeftStateFormula <em>Left State Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getDisjunction_RightStateFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Disjunction#getRightStateFormula <em>Right State Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
