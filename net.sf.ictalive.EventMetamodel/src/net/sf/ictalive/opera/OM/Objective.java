 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Objective#getConceptName <em>Concept Name</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Objective#getStateDescription <em>State Description</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Objective#getSubObjectives <em>Sub Objectives</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Objective#getParentObjective <em>Parent Objective</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Objective#getUsedByRole <em>Used By Role</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Objective#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective()
 * @model
 * @generated
 */
public interface Objective extends EObject
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective_ConceptName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Objective#getConceptName <em>Concept Name</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective_StateDescription()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Objective#getStateDescription <em>State Description</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective_SubObjectives()
	 * @model keys="Name"
	 * @generated
	 */
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective_ParentObjective()
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective_UsedByRole()
	 ...
	 * @see #setName(String)
	 * @see net.sf.ictalive.opera.OM.OMPackage#getObjective_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Objective#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
