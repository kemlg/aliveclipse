 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Implication#getAntecedentStateFormula <em>Antecedent State Formula</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Implication#getConsequentStateFormula <em>Consequent State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getImplication()
 * @model
 * @generated
 */
public interface Implication extends StateFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getImplication_AntecedentStateFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Implication#getAntecedentStateFormula <em>Antecedent State Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getImplication_ConsequentStateFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Implication#getConsequentStateFormula <em>Consequent State Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
