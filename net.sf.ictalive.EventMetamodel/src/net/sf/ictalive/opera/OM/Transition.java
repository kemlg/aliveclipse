 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.Transition#getTransitionID <em>Transition ID</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Transition#getTransitionType <em>Transition Type</em>}</li>
 *   <li>{@link net.sf.ictalive.opera.OM.Transition#getNorms <em>Norms</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getTransition()
 * @model
 * @generated
 */
public interface Transition extends EObject
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getTransition_TransitionID()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Transition#getTransitionID <em>Transition ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link net.sf.ictalive.opera.OM.TransitionType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getTransition_TransitionType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.Transition#getTransitionType <em>Transition Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getTransition_Norms()
	 * @model
	 * @generated
	 */
	EList<Norm> getNorms();
