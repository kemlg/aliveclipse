 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.opera.OM.ForAllPaths#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.opera.OM.OMPackage#getForAllPaths()
 * @model
 * @generated
 */
public interface ForAllPaths extends StateFormula
{
	 ...
	 * @see net.sf.ictalive.opera.OM.OMPackage#getForAllPaths_PathFormula()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.opera.OM.ForAllPaths#getPathFormula <em>Path Formula</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
