 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RedefineTypeImpl#getSchemaLocation <em>Schema Location</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
