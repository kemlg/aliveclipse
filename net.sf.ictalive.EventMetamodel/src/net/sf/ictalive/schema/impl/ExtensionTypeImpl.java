 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getAll <em>All</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getChoice <em>Choice</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getAnyAttribute1 <em>Any Attribute1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ExtensionTypeImpl#getBase <em>Base</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
