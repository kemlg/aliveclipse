 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getAll <em>All</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getChoice <em>Choice</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getFacets <em>Facets</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getMinExclusive <em>Min Exclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getMaxExclusive <em>Max Exclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getTotalDigits <em>Total Digits</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getFractionDigits <em>Fraction Digits</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getLength <em>Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getEnumeration <em>Enumeration</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getWhiteSpace <em>White Space</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getAnyAttribute1 <em>Any Attribute1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionTypeImpl#getBase <em>Base</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
