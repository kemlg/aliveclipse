 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getIdentityConstraint <em>Identity Constraint</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getUnique <em>Unique</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getKey <em>Key</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getKeyref <em>Keyref</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getFixed <em>Fixed</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getForm <em>Form</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getMaxOccurs <em>Max Occurs</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getMinOccurs <em>Min Occurs</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#isNillable <em>Nillable</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getSubstitutionGroup <em>Substitution Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
