 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getSimpleContent <em>Simple Content</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getComplexContent <em>Complex Content</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getAll <em>All</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getChoice <em>Choice</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getAnyAttribute1 <em>Any Attribute1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#isMixed <em>Mixed</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.ComplexTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
