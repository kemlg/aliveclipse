 ...
 * @generated
 */
public class WsdlGroundingSwitch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case WsdlGroundingPackage.WSDL_GROUNDING:
			{
			...
			case WsdlGroundingPackage.WSDL_ATOMIC_PROCESS_GROUNDING:
			{
			...
			case WsdlGroundingPackage.WSDL_OPERATION_REF:
			{
			...
			case WsdlGroundingPackage.WSDL_MESSAGE_MAP:
			{
			...
			case WsdlGroundingPackage.WSDL_INPUT_MESSAGE_MAP:
			{
			...
			case WsdlGroundingPackage.WSDL_OUTPUT_MESSAGE_MAP:
			{
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GD</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>GD</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGD(GD object)
	{
		return null;
	}
