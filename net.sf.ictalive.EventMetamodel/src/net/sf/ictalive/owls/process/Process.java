 ...
 *   <li>{@link net.sf.ictalive.owls.process.Process#getPerformedByRole <em>Performed By Role</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Process extends ServiceModel
{
	...
	/**
	 * Returns the value of the '<em><b>Performed By Role</b></em>' attribute list.
	 ...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Performed By Role</em>' attribute list.
	 * @see net.sf.ictalive.owls.process.ProcessPackage#getProcess_PerformedByRole()
