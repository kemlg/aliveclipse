 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.Split#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.owls.process.ProcessPackage#getSplit()
 * @model
 * @generated
 */
public interface Split extends ControlConstruct
{
	 ...
	 * @see net.sf.ictalive.owls.process.ProcessPackage#getSplit_Components()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.owls.process.Split#getComponents <em>Components</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
