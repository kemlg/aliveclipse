...
public interface ProcessPackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://owls/process/1.1";
	 ...
	 * @ordered
	 */
	int PROCESS__DESCRIBES = ServicePackage.SERVICE_MODEL__DESCRIBES;
	 ...
	 * @ordered
	 */
	int PROCESS__PERFORMED_BY_ROLE = ServicePackage.SERVICE_MODEL_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int PROCESS_FEATURE_COUNT = ServicePackage.SERVICE_MODEL_FEATURE_COUNT + 11;
	 ...
	 * @ordered
	 */
	int ATOMIC_PROCESS__DESCRIBES = PROCESS__DESCRIBES;
	 ...
	 * @ordered
	 */
	int ATOMIC_PROCESS__PERFORMED_BY_ROLE = PROCESS__PERFORMED_BY_ROLE;
	 ...
	 * @ordered
	 */
	int COMPOSITE_PROCESS__DESCRIBES = PROCESS__DESCRIBES;
	 ...
	 * @ordered
	 */
	int COMPOSITE_PROCESS__PERFORMED_BY_ROLE = PROCESS__PERFORMED_BY_ROLE;
	...
	/**
	 * The feature id for the '<em><b>Parameter Type</b></em>' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Has Data From</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int PRODUCE__TIMEOUT = CONTROL_CONSTRUCT__TIMEOUT;
	 ...
	 * @ordered
	 */
	int PRODUCE__ID = CONTROL_CONSTRUCT__ID;
	 ...
	 * @ordered
	 */
	int PRODUCE__VERSION = CONTROL_CONSTRUCT__VERSION;
	 ...
	 * @ordered
	 */
	int PRODUCE__PRODUCED_BINDING = CONTROL_CONSTRUCT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SIMPLE_PROCESS__DESCRIBES = PROCESS__DESCRIBES;
	 ...
	 * @ordered
	 */
	int SIMPLE_PROCESS__PERFORMED_BY_ROLE = PROCESS__PERFORMED_BY_ROLE;
	...
	/**
	 * The meta object id for the '{@link net.sf.ictalive.owls.process.impl.ComponentsImpl <em>Components</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see net.sf.ictalive.owls.process.impl.ComponentsImpl
	 * @see net.sf.ictalive.owls.process.impl.ProcessPackageImpl#getComponents()
	 * @generated
	 */
	int COMPONENTS = 29;
	...
	/**
	 * Returns the meta object for the reference '{@link net.sf.ictalive.owls.process.CompositeProcess#getComposedOf <em>Composed Of</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link net.sf.ictalive.owls.process.IfThenElse#getThen <em>Then</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link net.sf.ictalive.owls.process.IfThenElse#getElse <em>Else</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute list '{@link net.sf.ictalive.owls.process.Parameter#getParameterType <em>Parameter Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Parameter Type</em>'.
	...
	/**
	 * Returns the meta object for the containment reference '{@link net.sf.ictalive.owls.process.Perform#getHasDataFrom <em>Has Data From</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Has Data From</em>'.
	...
	/**
	 * Returns the meta object for the attribute list '{@link net.sf.ictalive.owls.process.Process#getPerformedByRole <em>Performed By Role</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Performed By Role</em>'.
	 * @see net.sf.ictalive.owls.process.Process#getPerformedByRole()
	 * @see #getProcess()
	 * @generated
	 */
	EAttribute getProcess_PerformedByRole();
	...
	/**
	 * Returns the meta object for the reference '{@link net.sf.ictalive.owls.process.RepeatUntil#getUntilProcess <em>Until Process</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link net.sf.ictalive.owls.process.RepeatWhile#getWhileProcess <em>While Process</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link net.sf.ictalive.owls.process.Components <em>Components</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals
	{
		...
		/**
		 * The meta object literal for the '<em><b>Parameter Type</b></em>' attribute list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Has Data From</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EAttribute PROCESS__PERFORMED_BY_ROLE = eINSTANCE.getProcess_PerformedByRole();
		...
		/**
		 * The meta object literal for the '{@link net.sf.ictalive.owls.process.impl.ComponentsImpl <em>Components</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see net.sf.ictalive.owls.process.impl.ComponentsImpl
		 * @see net.sf.ictalive.owls.process.impl.ProcessPackageImpl#getComponents()
