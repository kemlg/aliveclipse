...
public class ProcessPackageImpl extends EPackageImpl implements ProcessPackage
{
	 ...
	 * @generated
	 */
	public EAttribute getProcess_PerformedByRole()
	{
	...
	public void createPackageContents()
	{
		...
		createEAttribute(processEClass, PROCESS__PERFORMED_BY_ROLE);
	...
	public void initializePackageContents()
	{
		...
		processEClass.getESuperTypes().add(theServicePackage_1.getServiceModel());
		...
		initEAttribute(getParameter_ParameterType(), theXMLTypePackage.getAnyURI(), "parameterType", null, 1, -1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProcess_PerformedByRole(), theXMLTypePackage.getAnyURI(), "performedByRole", null, 0, -1, net.sf.ictalive.owls.process.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
