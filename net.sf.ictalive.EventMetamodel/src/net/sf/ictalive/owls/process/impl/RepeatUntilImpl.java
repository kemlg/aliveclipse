...
public class RepeatUntilImpl extends IterateImpl implements RepeatUntil
{
	...
	public ControlConstruct getUntilProcess()
	{
		if (untilProcess != null && untilProcess.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.REPEAT_UNTIL__UNTIL_PROCESS, oldUntilProcess, untilProcess));
			}
		}
		return untilProcess;
	}
	...
	public void setUntilProcess(ControlConstruct newUntilProcess)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.REPEAT_UNTIL__UNTIL_PROCESS, oldUntilProcess, untilProcess));
	}
