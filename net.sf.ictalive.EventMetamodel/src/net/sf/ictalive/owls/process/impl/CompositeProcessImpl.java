...
public class CompositeProcessImpl extends ProcessImpl implements CompositeProcess
{
	...
	public ControlConstruct getComposedOf()
	{
		if (composedOf != null && composedOf.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.COMPOSITE_PROCESS__COMPOSED_OF, oldComposedOf, composedOf));
			}
		}
		return composedOf;
	}
	...
	public void setComposedOf(ControlConstruct newComposedOf)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.COMPOSITE_PROCESS__COMPOSED_OF, oldComposedOf, composedOf));
	}
