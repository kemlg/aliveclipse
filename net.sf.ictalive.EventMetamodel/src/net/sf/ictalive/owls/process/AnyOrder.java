 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.AnyOrder#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.owls.process.ProcessPackage#getAnyOrder()
 * @model
 * @generated
 */
public interface AnyOrder extends ControlConstruct
{
	 ...
	 * @see net.sf.ictalive.owls.process.ProcessPackage#getAnyOrder_Components()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.owls.process.AnyOrder#getComponents <em>Components</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
