...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.rules.swrl.DataValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_conceptType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_conceptType_feature", "_UI_DataValue_type"),
				 SwrlPackage.Literals.DATA_VALUE__CONCEPT_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLiteralPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_literal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_literal_feature", "_UI_DataValue_type"),
				 SwrlPackage.Literals.DATA_VALUE__LITERAL,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_type_feature", "_UI_DataValue_type"),
				 SwrlPackage.Literals.DATA_VALUE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((DataValue)object).getLiteral();
