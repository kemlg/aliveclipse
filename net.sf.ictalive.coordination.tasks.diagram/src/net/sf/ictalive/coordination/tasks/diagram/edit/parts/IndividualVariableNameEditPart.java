	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3035,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.tasks.diagram.edit.parts.IndividualVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
