...
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.ClassAtomCanonicalEditPolicy;
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.ClassAtomItemSemanticEditPolicy;
...
public class ClassAtomEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.IndividualID_3034) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(ClassAtomClassAtomArgValueCompartmentEditPart.VISUAL_ID));
			}
			if (type == CoordinationElementTypes.IndividualVariable_3035) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
						.getType(ClassAtomClassAtomArgValueCompartmentEditPart.VISUAL_ID));
			}
		}
