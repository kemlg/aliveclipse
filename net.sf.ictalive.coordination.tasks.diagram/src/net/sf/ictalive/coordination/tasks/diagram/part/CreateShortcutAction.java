...
import net.sf.ictalive.coordination.tasks.diagram.custom.CreateMissingShortcuts;
...
public class CreateShortcutAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		((TasksCollectionCanonicalEditPolicy) selectedDiagramPart.getEditPolicy(EditPolicyRoles.CANONICAL_ROLE)).refresh();
