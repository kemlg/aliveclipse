	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3043,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.tasks.diagram.edit.parts.IndividualVariableName4EditPart.VISUAL_ID));
		}
		return parser;
	}
