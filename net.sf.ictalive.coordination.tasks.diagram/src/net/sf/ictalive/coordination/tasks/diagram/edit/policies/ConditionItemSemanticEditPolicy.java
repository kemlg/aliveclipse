...
import net.sf.ictalive.coordination.tasks.diagram.edit.commands.AtomListCreateCommand;
import net.sf.ictalive.coordination.tasks.diagram.edit.commands.RepeatWhileWhileConditionCreateCommand;
import net.sf.ictalive.coordination.tasks.diagram.edit.commands.RepeatWhileWhileConditionReorientCommand;
...
public class ConditionItemSemanticEditPolicy extends
	...
	public ConditionItemSemanticEditPolicy() {
		super(CoordinationElementTypes.Condition_3031);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (CoordinationElementTypes.AtomList_3032 == req.getElementType()) {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(incomingLink) == RepeatWhileWhileConditionEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CoordinationElementTypes.RepeatWhileWhileCondition_4032 == req
				.getElementType()) {
			return null;
		}
		return null;
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (CoordinationElementTypes.RepeatWhileWhileCondition_4032 == req
				.getElementType()) {
			return getGEFWrapper(new RepeatWhileWhileConditionCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case RepeatWhileWhileConditionEditPart.VISUAL_ID:
			return getGEFWrapper(new RepeatWhileWhileConditionReorientCommand(
					req));
		}
