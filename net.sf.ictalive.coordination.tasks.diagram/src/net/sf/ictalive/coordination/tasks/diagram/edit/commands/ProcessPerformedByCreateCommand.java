 ...
 * @generated
 */
public class ProcessPerformedByCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProcessPerformedByCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateProcessPerformedBy_4019(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setPerformedBy(getTarget());
		}
