	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3053,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.tasks.diagram.edit.parts.IndividualVariableName6EditPart.VISUAL_ID));
		}
		return parser;
	}
