...
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.TaskCanonicalEditPolicy;
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.TaskItemSemanticEditPolicy;
...
public class TaskEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.InputMessageMap_3057) {
				return getChildBySemanticHint(CoordinationVisualIDRegistry
