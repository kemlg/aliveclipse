...
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.RepeatWhileWhileConditionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RepeatWhileWhileConditionEditPart extends ConnectionNodeEditPart
	 ...
	 * @generated
	 */
	public RepeatWhileWhileConditionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RepeatWhileWhileConditionItemSemanticEditPolicy());
	}
	...
	public class RepeatActionFigure extends PolylineConnectionEx {
		...
		private void createContents() {
			...
			fFigureRepeatActionFigureLabel.setText("repeat action");
