	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3046,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.tasks.diagram.edit.parts.IndividualVariableName5EditPart.VISUAL_ID));
		}
		return parser;
	}
