	...
	public IParser getParser() {
		if (parser == null) {
			parser = CoordinationParserProvider
					.getParser(
							CoordinationElementTypes.IndividualVariable_3040,
							getParserElement(),
							CoordinationVisualIDRegistry
									.getType(net.sf.ictalive.coordination.tasks.diagram.edit.parts.IndividualVariableName3EditPart.VISUAL_ID));
		}
		return parser;
	}
