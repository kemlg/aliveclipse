...
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.TasksCollectionCanonicalEditPolicy;
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.TasksCollectionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TasksCollectionEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Tasks"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public TasksCollectionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TasksCollectionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TasksCollectionCanonicalEditPolicy());
