...
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.InputCanonicalEditPolicy;
import net.sf.ictalive.coordination.tasks.diagram.edit.policies.InputItemSemanticEditPolicy;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputNameEditPart) {
			((InputNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureParameterNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForSource(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == CoordinationElementTypes.InputMessageMapParameter_4027) {
	 ...
	 * @generated
	 */
	public class ParameterFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureParameterNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureParameterNameLabelFigure = new WrappingLabel();
			fFigureParameterNameLabelFigure.setText("");

			this.add(fFigureParameterNameLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureParameterNameLabelFigure() {
			return fFigureParameterNameLabelFigure;
		}
