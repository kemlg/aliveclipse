...
import net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.policies.PartnerActivity14ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PartnerActivity14EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PartnerActivity14EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PartnerActivity14ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PartnerActivityName14EditPart) {
			((PartnerActivityName14EditPart) childEditPart)
