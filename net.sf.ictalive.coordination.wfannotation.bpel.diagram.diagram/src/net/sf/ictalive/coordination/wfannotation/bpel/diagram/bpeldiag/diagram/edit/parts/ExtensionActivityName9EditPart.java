 ...
 * @generated
 */
public class ExtensionActivityName9EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName9EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName9EditPart.VISUAL_ID));
		}
		return parser;
	}
