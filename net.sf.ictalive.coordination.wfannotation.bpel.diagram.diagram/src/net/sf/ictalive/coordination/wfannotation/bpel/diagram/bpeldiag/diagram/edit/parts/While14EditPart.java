...
import net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.policies.While14ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class While14EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public While14EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new While14ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WhileName14EditPart) {
			((WhileName14EditPart) childEditPart).setLabel(getPrimaryShape()
