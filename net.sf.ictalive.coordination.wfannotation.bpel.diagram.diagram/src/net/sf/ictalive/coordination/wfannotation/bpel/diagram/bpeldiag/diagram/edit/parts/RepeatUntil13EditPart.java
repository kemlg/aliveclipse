...
import net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.policies.RepeatUntil13ItemSemanticEditPolicy;
...
public class RepeatUntil13EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RepeatUntilName13EditPart) {
			((RepeatUntilName13EditPart) childEditPart)
