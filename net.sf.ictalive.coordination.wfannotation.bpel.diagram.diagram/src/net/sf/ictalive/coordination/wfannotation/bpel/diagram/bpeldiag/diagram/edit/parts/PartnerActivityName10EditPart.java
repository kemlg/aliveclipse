 ...
 * @generated
 */
public class PartnerActivityName10EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PartnerActivityName10EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.PartnerActivityName10EditPart.VISUAL_ID));
		}
		return parser;
	}
