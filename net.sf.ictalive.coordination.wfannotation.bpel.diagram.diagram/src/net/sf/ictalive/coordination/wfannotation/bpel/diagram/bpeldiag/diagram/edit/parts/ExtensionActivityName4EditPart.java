 ...
 * @generated
 */
public class ExtensionActivityName4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName4EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName4EditPart.VISUAL_ID));
		}
		return parser;
	}
