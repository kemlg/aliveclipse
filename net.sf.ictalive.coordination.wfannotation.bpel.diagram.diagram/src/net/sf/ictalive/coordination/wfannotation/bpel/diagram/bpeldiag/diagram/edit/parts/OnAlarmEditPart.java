...
import net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.policies.OnAlarmItemSemanticEditPolicy;
...
public class OnAlarmEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OnAlarmOnAlarmCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFigureOnAlarmFigureTitleLabel();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((OnAlarmOnAlarmCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OnAlarmOnAlarmCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFigureOnAlarmFigureTitleLabel();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((OnAlarmOnAlarmCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
