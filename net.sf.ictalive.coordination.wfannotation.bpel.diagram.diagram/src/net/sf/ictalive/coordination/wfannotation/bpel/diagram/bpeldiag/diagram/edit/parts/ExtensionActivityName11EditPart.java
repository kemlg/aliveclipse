 ...
 * @generated
 */
public class ExtensionActivityName11EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName11EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName11EditPart.VISUAL_ID));
		}
		return parser;
	}
