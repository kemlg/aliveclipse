 ...
 * @generated
 */
public class ExtensionActivityName6EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName6EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName6EditPart.VISUAL_ID));
		}
		return parser;
	}
