 ...
 * @generated
 */
public class InvokeName4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InvokeName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BpeldiagParserProvider
					.getParser(
							BpeldiagElementTypes.Invoke_3064,
							getParserElement(),
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.InvokeName4EditPart.VISUAL_ID));
		}
		return parser;
	}
