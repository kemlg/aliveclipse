...
import net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.part.BpeldiagDiagramEditor;
 ...
 * @generated
 */
public class BpeldiagNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof BpeldiagNavigatorItem) {
					selectedElement = ((BpeldiagNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ProcessContainerEditPart.MODEL_ID
							.equals(BpeldiagVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, BpeldiagDiagramEditor.ID);
