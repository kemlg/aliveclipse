 ...
 * @generated
 */
public class ExtensionActivityName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName2EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName2EditPart.VISUAL_ID));
		}
		return parser;
	}
