 ...
 * @generated
 */
public class ReplyName12EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ReplyName12EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BpeldiagParserProvider
					.getParser(
							BpeldiagElementTypes.Reply_3279,
							getParserElement(),
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ReplyName12EditPart.VISUAL_ID));
		}
		return parser;
	}
