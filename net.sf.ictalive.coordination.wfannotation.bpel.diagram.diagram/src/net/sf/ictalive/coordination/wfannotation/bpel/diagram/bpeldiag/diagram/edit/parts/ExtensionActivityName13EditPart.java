 ...
 * @generated
 */
public class ExtensionActivityName13EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName13EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName13EditPart.VISUAL_ID));
		}
		return parser;
	}
