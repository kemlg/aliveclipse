 ...
 * @generated
 */
public class ReplyName14EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ReplyName14EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BpeldiagParserProvider
					.getParser(
							BpeldiagElementTypes.Reply_3018,
							getParserElement(),
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ReplyName14EditPart.VISUAL_ID));
		}
		return parser;
	}
