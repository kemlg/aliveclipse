 ...
 * @generated
 */
public class ScopeName11EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ScopeName11EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BpeldiagParserProvider
					.getParser(
							BpeldiagElementTypes.Scope_3257,
							getParserElement(),
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ScopeName11EditPart.VISUAL_ID));
		}
		return parser;
	}
