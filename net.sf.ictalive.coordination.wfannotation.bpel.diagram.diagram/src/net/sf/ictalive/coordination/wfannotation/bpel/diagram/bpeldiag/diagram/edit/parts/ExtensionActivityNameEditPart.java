 ...
 * @generated
 */
public class ExtensionActivityNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityNameEditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
