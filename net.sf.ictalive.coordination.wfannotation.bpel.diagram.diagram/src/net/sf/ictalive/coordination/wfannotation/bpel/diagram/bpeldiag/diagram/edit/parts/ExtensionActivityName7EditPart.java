 ...
 * @generated
 */
public class ExtensionActivityName7EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName7EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName7EditPart.VISUAL_ID));
		}
		return parser;
	}
