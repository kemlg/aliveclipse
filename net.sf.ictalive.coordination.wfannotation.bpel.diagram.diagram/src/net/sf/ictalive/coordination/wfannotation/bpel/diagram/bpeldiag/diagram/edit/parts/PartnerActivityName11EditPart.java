 ...
 * @generated
 */
public class PartnerActivityName11EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PartnerActivityName11EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.PartnerActivityName11EditPart.VISUAL_ID));
		}
		return parser;
	}
