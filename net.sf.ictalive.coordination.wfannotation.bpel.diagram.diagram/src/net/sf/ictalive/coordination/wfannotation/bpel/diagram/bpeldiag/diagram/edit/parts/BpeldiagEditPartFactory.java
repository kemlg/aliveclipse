 ...
 * @generated
 */
public class BpeldiagEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case ProcessContainerEditPart.VISUAL_ID:
				return new ProcessContainerEditPart(view);
			...
			case OnMessage2EditPart.VISUAL_ID:
				return new OnMessage2EditPart(view);
			...
			case OnAlarm3EditPart.VISUAL_ID:
				return new OnAlarm3EditPart(view);
			...
			case ElseIf2EditPart.VISUAL_ID:
				return new ElseIf2EditPart(view);
			...
			case FlowFlowCompartment10EditPart.VISUAL_ID:
				return new FlowFlowCompartment10EditPart(view);

			case ForEachForEachCompartment14EditPart.VISUAL_ID:
				return new ForEachForEachCompartment14EditPart(view);

			case IfIfCompartment12EditPart.VISUAL_ID:
				return new IfIfCompartment12EditPart(view);

			case PickPickCompartment14EditPart.VISUAL_ID:
				return new PickPickCompartment14EditPart(view);
			...
			case ScopeScopeCompartment14EditPart.VISUAL_ID:
				return new ScopeScopeCompartment14EditPart(view);

			case SequenceSequenceCompartment9EditPart.VISUAL_ID:
				return new SequenceSequenceCompartment9EditPart(view);

			case WhileWhileCompartment14EditPart.VISUAL_ID:
				return new WhileWhileCompartment14EditPart(view);

			case ElseIfEliseIfCompartment2EditPart.VISUAL_ID:
				return new ElseIfEliseIfCompartment2EditPart(view);

			case ElseElseCompartment2EditPart.VISUAL_ID:
				return new ElseElseCompartment2EditPart(view);

			case OnAlarmOnAlarmCompartment3EditPart.VISUAL_ID:
				return new OnAlarmOnAlarmCompartment3EditPart(view);

			case OnEventOnEventCompartment2EditPart.VISUAL_ID:
				return new OnEventOnEventCompartment2EditPart(view);

			case OnMessageOnMessageCompartment2EditPart.VISUAL_ID:
				return new OnMessageOnMessageCompartment2EditPart(view);

			case EventHandlerEventHandlerCompartment3EditPart.VISUAL_ID:
				return new EventHandlerEventHandlerCompartment3EditPart(view);

			case PartnerActivityOperationEditPart.VISUAL_ID:
				return new PartnerActivityOperationEditPart(view);
