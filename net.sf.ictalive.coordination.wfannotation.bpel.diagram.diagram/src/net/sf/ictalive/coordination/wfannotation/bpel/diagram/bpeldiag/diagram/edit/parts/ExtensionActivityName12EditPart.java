 ...
 * @generated
 */
public class ExtensionActivityName12EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName12EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName12EditPart.VISUAL_ID));
		}
		return parser;
	}
