 ...
 * @generated
 */
public class WhileName7EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WhileName7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new BpeldiagTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return BpeldiagElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof BpeldiagTextSelectionEditPolicy) {
			((BpeldiagTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof BpeldiagTextSelectionEditPolicy) {
			((BpeldiagTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BpeldiagParserProvider
					.getParser(
							BpeldiagElementTypes.While_3175,
							getParserElement(),
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.WhileName7EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), BpeldiagEditPartFactory
