 ...
 * @generated
 */
public class ExtensionActivityName10EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName10EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName10EditPart.VISUAL_ID));
		}
		return parser;
	}
