 ...
 * @generated
 */
public class BpeldiagVisualIDRegistry {

	/**
	 * @generated
	 */
	private static final String DEBUG_KEY = "net.sf.ictalive.coordination.wfannotation.bpel.diagram.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		if (view instanceof Diagram) {
			if (ProcessContainerEditPart.MODEL_ID.equals(view.getType())) {
				return ProcessContainerEditPart.VISUAL_ID;
			} else {
				return -1;
			}
		}
		return net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.part.BpeldiagVisualIDRegistry
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (BpeldiagPackage.eINSTANCE.getProcessContainer().isSuperTypeOf(
				domainElement.eClass())
				&& isDiagram((ProcessContainer) domainElement)) {
			return ProcessContainerEditPart.VISUAL_ID;
		}
		return -1;
	}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.part.BpeldiagVisualIDRegistry
				.getModelID(containerView);
		if (!ProcessContainerEditPart.MODEL_ID.equals(containerModelID)
				&& !"bpel".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		int containerVisualID;
		if (ProcessContainerEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.part.BpeldiagVisualIDRegistry
					.getVisualID(containerView);
		} else {
			if (containerView instanceof Diagram) {
				containerVisualID = ProcessContainerEditPart.VISUAL_ID;
			} else {
				return -1;
			}
		}
		...
		case ProcessProcessCompartmentEditPart.VISUAL_ID:
			...
			if (BPELPackage.eINSTANCE.getReply().isSuperTypeOf(
					domainElement.eClass())) {
				return Reply14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getRethrow().isSuperTypeOf(
					domainElement.eClass())) {
				return Rethrow14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getScope().isSuperTypeOf(
					domainElement.eClass())) {
				return Scope14EditPart.VISUAL_ID;
			}
		...
		case IfIfCompartmentEditPart.VISUAL_ID:
			...
			if (BPELPackage.eINSTANCE.getElseIf().isSuperTypeOf(
					domainElement.eClass())) {
				return ElseIf2EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getElse().isSuperTypeOf(
					domainElement.eClass())) {
				return Else2EditPart.VISUAL_ID;
			}
			break;
		...
		case PickPickCompartmentEditPart.VISUAL_ID:
			...
			if (BPELPackage.eINSTANCE.getOnMessage().isSuperTypeOf(
					domainElement.eClass())) {
				return OnMessage2EditPart.VISUAL_ID;
			}
			break;
		...
		case EventHandlerEventHandlerCompartmentEditPart.VISUAL_ID:
			if (BPELPackage.eINSTANCE.getOnAlarm().isSuperTypeOf(
					domainElement.eClass())) {
				return OnAlarm3EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getOnEvent().isSuperTypeOf(
					domainElement.eClass())) {
				return OnEvent2EditPart.VISUAL_ID;
			}
			break;
		...
		case OnEventOnEventCompartmentEditPart.VISUAL_ID:
			if (BPELPackage.eINSTANCE.getAssign().isSuperTypeOf(
					domainElement.eClass())) {
				return Assign14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getCompensate().isSuperTypeOf(
					domainElement.eClass())) {
				return Compensate14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getCompensateScope().isSuperTypeOf(
					domainElement.eClass())) {
				return CompensateScope14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getEmpty().isSuperTypeOf(
					domainElement.eClass())) {
				return Empty14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getExit().isSuperTypeOf(
					domainElement.eClass())) {
				return Exit14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getExtensionActivity().isSuperTypeOf(
					domainElement.eClass())) {
				return ExtensionActivity14EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getFlow().isSuperTypeOf(
					domainElement.eClass())) {
				return Flow10EditPart.VISUAL_ID;
			}
			if (BPELPackage.eINSTANCE.getForEach().isSuperTypeOf(
					domainElement.eClass())) {
		...
		return getNodeVisualID(containerView, domainElement, containerVisualID);
	}
	
	public static int getNodeVisualID(View containerView, EObject domainElement, int containerVisualID) {switch (containerVisualID) {
		...
		case ProcessContainerEditPart.VISUAL_ID:
			...
			if (WSDLPackage.eINSTANCE.getOperation().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case FlowEditPart.VISUAL_ID:
			...
			if (FlowFlowCompartment10EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ForEachEditPart.VISUAL_ID:
			...
			if (ForEachForEachCompartment14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case IfEditPart.VISUAL_ID:
			...
			if (IfIfCompartment12EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case PickEditPart.VISUAL_ID:
			...
			if (PickPickCompartment14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ScopeEditPart.VISUAL_ID:
			...
			if (ScopeScopeCompartment14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case SequenceEditPart.VISUAL_ID:
			...
			if (SequenceSequenceCompartment9EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case WhileEditPart.VISUAL_ID:
			...
			if (WhileWhileCompartment14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case ElseIfEditPart.VISUAL_ID:
			...
			if (ElseIfEliseIfCompartment2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ElseEditPart.VISUAL_ID:
			...
			if (ElseElseCompartment2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OnAlarmEditPart.VISUAL_ID:
			...
			if (OnAlarmOnAlarmCompartment3EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OnEventEditPart.VISUAL_ID:
			...
			if (OnEventOnEventCompartment2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OnMessageEditPart.VISUAL_ID:
			...
			if (OnMessageOnMessageCompartment2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case EventHandlerEditPart.VISUAL_ID:
			...
			if (EventHandlerEventHandlerCompartment3EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case Assign14EditPart.VISUAL_ID:
			if (AssignName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Compensate14EditPart.VISUAL_ID:
			if (CompensateName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case CompensateScope14EditPart.VISUAL_ID:
			if (CompensateScopeName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Empty14EditPart.VISUAL_ID:
			if (EmptyName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Exit14EditPart.VISUAL_ID:
			if (ExitName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ExtensionActivity14EditPart.VISUAL_ID:
			if (ExtensionActivityName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Flow10EditPart.VISUAL_ID:
			if (FlowName10EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case ForEach14EditPart.VISUAL_ID:
			if (ForEachName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case If12EditPart.VISUAL_ID:
			if (IfName12EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case Invoke14EditPart.VISUAL_ID:
			if (InvokeName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OpaqueActivity14EditPart.VISUAL_ID:
			if (OpaqueActivityName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case PartnerActivity14EditPart.VISUAL_ID:
			if (PartnerActivityName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Pick14EditPart.VISUAL_ID:
			if (PickName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case Receive14EditPart.VISUAL_ID:
			if (ReceiveName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case RepeatUntil13EditPart.VISUAL_ID:
			if (RepeatUntilName13EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case Reply14EditPart.VISUAL_ID:
			if (ReplyName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Rethrow14EditPart.VISUAL_ID:
			if (RethrowName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Scope14EditPart.VISUAL_ID:
			if (ScopeName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case Sequence9EditPart.VISUAL_ID:
			if (SequenceName9EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case Throw14EditPart.VISUAL_ID:
			if (ThrowName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Validate14EditPart.VISUAL_ID:
			if (ValidateName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Wait14EditPart.VISUAL_ID:
			if (WaitName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case While14EditPart.VISUAL_ID:
			if (WhileName14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case ProcessProcessCompartmentEditPart.VISUAL_ID:
			...
			if (ForEach14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (If12EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Invoke14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OpaqueActivity14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (PartnerActivity14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Pick14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Receive14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (RepeatUntil13EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Reply14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Rethrow14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Scope14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Sequence9EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Throw14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Validate14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Wait14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (While14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (EventHandler3EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case FlowFlowCompartmentEditPart.VISUAL_ID:
		...
		case IfIfCompartmentEditPart.VISUAL_ID:
			...
			if (ElseIf2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Else2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case IfIfCompartment2EditPart.VISUAL_ID:
		...
		case PickPickCompartmentEditPart.VISUAL_ID:
			...
			if (OnMessage2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OnAlarmOnAlarmCompartmentEditPart.VISUAL_ID:
		...
		case ScopeScopeCompartment4EditPart.VISUAL_ID:
			...
			break;
		case EventHandlerEventHandlerCompartmentEditPart.VISUAL_ID:
			if (OnAlarm3EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (OnEvent2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case OnAlarmOnAlarmCompartment2EditPart.VISUAL_ID:
		...
		case WhileWhileCompartment10EditPart.VISUAL_ID:
			...
			break;
		case OnEventOnEventCompartmentEditPart.VISUAL_ID:
			if (Assign14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Compensate14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (CompensateScope14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Empty14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Exit14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (ExtensionActivity14EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (Flow10EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
	 ...
	 * @generated
	 */
	private static boolean isDiagram(ProcessContainer element) {
		return true;
	}
