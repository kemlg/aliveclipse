 ...
 * @generated
 */
public class BpeldiagElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public BpeldiagElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.BpeldiagElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "bpel".equals(fileExtension); //$NON-NLS-1$
	}
