 ...
 * @generated
 */
public class ExtensionActivityName5EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName5EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName5EditPart.VISUAL_ID));
		}
		return parser;
	}
