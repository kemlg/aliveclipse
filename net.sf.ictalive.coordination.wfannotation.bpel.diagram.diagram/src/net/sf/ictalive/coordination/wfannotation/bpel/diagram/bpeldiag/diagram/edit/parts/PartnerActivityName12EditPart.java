 ...
 * @generated
 */
public class PartnerActivityName12EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PartnerActivityName12EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.PartnerActivityName12EditPart.VISUAL_ID));
		}
		return parser;
	}
