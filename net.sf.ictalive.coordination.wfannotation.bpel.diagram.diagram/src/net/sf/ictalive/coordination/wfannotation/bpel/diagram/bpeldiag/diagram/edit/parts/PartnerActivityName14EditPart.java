 ...
 * @generated
 */
public class PartnerActivityName14EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PartnerActivityName14EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.PartnerActivityName14EditPart.VISUAL_ID));
		}
		return parser;
	}
