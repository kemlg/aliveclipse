 ...
 * @generated
 */
public class PartnerActivityName13EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PartnerActivityName13EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.PartnerActivityName13EditPart.VISUAL_ID));
		}
		return parser;
	}
