 ...
 * @generated
 */
public class BpeldiagDomainNavigatorLabelProvider implements
	...
	public Image getImage(Object element) {
		if (element instanceof BpeldiagDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getImage(((BpeldiagDomainNavigatorItem) element)
							.getEObject());
		}
		return null;
	}
	...
	public String getText(Object element) {
		if (element instanceof BpeldiagDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getText(((BpeldiagDomainNavigatorItem) element)
							.getEObject());
		}
		return null;
	}
