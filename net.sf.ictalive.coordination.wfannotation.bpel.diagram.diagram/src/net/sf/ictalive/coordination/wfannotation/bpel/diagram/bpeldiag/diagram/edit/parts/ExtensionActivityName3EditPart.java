 ...
 * @generated
 */
public class ExtensionActivityName3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName3EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName3EditPart.VISUAL_ID));
		}
		return parser;
	}
