 ...
 * @generated
 */
public class ExtensionActivityName14EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName14EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName14EditPart.VISUAL_ID));
		}
		return parser;
	}
