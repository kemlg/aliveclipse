 ...
 * @generated
 */
public class CompensateScopeName9EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompensateScopeName9EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.CompensateScopeName9EditPart.VISUAL_ID));
		}
		return parser;
	}
