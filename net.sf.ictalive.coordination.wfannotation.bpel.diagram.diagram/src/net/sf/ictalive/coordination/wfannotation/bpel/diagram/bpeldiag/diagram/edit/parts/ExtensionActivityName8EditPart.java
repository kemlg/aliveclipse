 ...
 * @generated
 */
public class ExtensionActivityName8EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExtensionActivityName8EditPart(View view) {
		super(view);
	}
			...
			parser = BpeldiagParserProvider
					.getParser(
							...
							BpeldiagVisualIDRegistry
									.getType(net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.parts.ExtensionActivityName8EditPart.VISUAL_ID));
		}
		return parser;
	}
