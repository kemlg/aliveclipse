 ...
 * @generated
 */
public class BpeldiagDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public BpeldiagDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof BpeldiagDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((BpeldiagDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new BpeldiagDomainNavigatorItem(
