...
import net.sf.ictalive.coordination.wfannotation.bpel.diagram.bpeldiag.diagram.edit.policies.Invoke14ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Invoke14EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Invoke14EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Invoke14ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InvokeName14EditPart) {
			((InvokeName14EditPart) childEditPart).setLabel(getPrimaryShape()
