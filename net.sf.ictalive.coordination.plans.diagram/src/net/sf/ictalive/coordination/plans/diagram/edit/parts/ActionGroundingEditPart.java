...
import net.sf.ictalive.coordination.plans.diagram.edit.policies.ActionGroundingCanonicalEditPolicy;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.ActionGroundingItemSemanticEditPolicy;
...
public class ActionGroundingEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionGroundingActionGroundingRectangleEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureActionGroundingCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((ActionGroundingActionGroundingRectangleEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionGroundingActionGroundingRectangleEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((ActionGroundingActionGroundingRectangleEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ActionGroundingActionGroundingRectangleEditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == CoordinationElementTypes.ActionGroundingOwlsProcess_4008) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CoordinationElementTypes.InputMessageMap_3004) {
