...
import net.sf.ictalive.coordination.plans.diagram.edit.commands.ActionGroundingListRestCreateCommand;
import net.sf.ictalive.coordination.plans.diagram.edit.commands.ActionGroundingListRestReorientCommand;
...
public class ActionGroundingListItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(incomingLink) == ActionGroundingListRestEditPart.VISUAL_ID) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(incomingLink) == PlanHasAtomicProcessGroundingListEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(outgoingLink) == ActionGroundingListRestEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
					...
					case ActionGroundingEditPart.VISUAL_ID:
						for (Iterator it = cnode.getSourceEdges().iterator(); it
							...
							if (CoordinationVisualIDRegistry
									.getVisualID(outgoingLink) == ActionGroundingOwlsProcessEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CoordinationElementTypes.ActionGroundingListRest_4006 == req
				.getElementType()) {
