...
import net.sf.ictalive.coordination.plans.diagram.edit.policies.CompositeActionCanonicalEditPolicy;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.CompositeActionItemSemanticEditPolicy;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.OpenDiagramEditPolicyCompositeAction;
...
public class CompositeActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new OpenDiagramEditPolicyCompositeAction());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompositeActionNameEditPart) {
			((CompositeActionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureActionNameFigure());
			return true;
		}
		return false;
	}
