...
import net.sf.ictalive.coordination.plans.diagram.edit.commands.ActionGroundingOwlsProcessCreateCommand;
import net.sf.ictalive.coordination.plans.diagram.edit.commands.ActionGroundingOwlsProcessReorientCommand;
...
public class ActionGroundingItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CoordinationVisualIDRegistry.getVisualID(outgoingLink) == ActionGroundingOwlsProcessEditPart.VISUAL_ID) {
					...
					case InputMessageMapEditPart.VISUAL_ID:
						for (Iterator it = cnode.getSourceEdges().iterator(); it
							...
							if (CoordinationVisualIDRegistry
									.getVisualID(outgoingLink) == InputMessageMapParameterEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CoordinationElementTypes.ActionGroundingOwlsProcess_4008 == req
				.getElementType()) {
