 ...
 * @generated
 */
public class PlanForTaskCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PlanForTaskCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreatePlanForTask_4009(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setForTask(getTarget());
		}
