 ...
 * @generated
 */
public class ActionGroundingListRestReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionGroundingListRestReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof ActionGroundingList) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistActionGroundingListRest_4006(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistActionGroundingListRest_4006(getOldSource(),
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ActionGroundingList getOldSource() {
		return (ActionGroundingList) referenceOwner;
	}

	/**
	 * @generated
	 */
	protected ActionGroundingList getNewSource() {
