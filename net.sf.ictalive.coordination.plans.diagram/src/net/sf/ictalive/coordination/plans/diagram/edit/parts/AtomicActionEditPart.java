...
import net.sf.ictalive.coordination.plans.diagram.edit.policies.AtomicActionCanonicalEditPolicy;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.AtomicActionItemSemanticEditPolicy;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.OpenDiagramEditPolicyAtomicAction;
...
public class AtomicActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new OpenDiagramEditPolicyAtomicAction());
