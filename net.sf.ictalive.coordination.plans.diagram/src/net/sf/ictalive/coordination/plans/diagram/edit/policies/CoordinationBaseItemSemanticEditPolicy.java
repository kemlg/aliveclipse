...
import net.sf.ictalive.coordination.plans.diagram.edit.helpers.CoordinationBaseEditHelper;
...
public class CoordinationBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateActionGroundingListRest_4006(
			...
			return canExistActionGroundingListRest_4006(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateInputMessageMapParameter_4007(
			...
			return canExistInputMessageMapParameter_4007(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateActionGroundingOwlsProcess_4008(
				ActionGrounding source, Action target) {
			if (source != null) {
			...
			return canExistActionGroundingOwlsProcess_4008(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreatePlanForTask_4009(Plan source, Task target) {
			if (source != null) {
				if (source.getForTask() != null) {
					return false;
				}
			}

			return canExistPlanForTask_4009(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreatePlanHasAtomicProcessGroundingList_4010(
			...
			return canExistPlanHasAtomicProcessGroundingList_4010(source,
					target);
		}
		 ...
		 * @generated
		 */
		public static boolean canExistActionGroundingListRest_4006(
				ActionGroundingList source, ActionGroundingList target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public static boolean canExistInputMessageMapParameter_4007(
				InputMessageMap source, Parameter target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public static boolean canExistActionGroundingOwlsProcess_4008(
				ActionGrounding source, Action target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public static boolean canExistPlanForTask_4009(Plan source, Task target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public static boolean canExistPlanHasAtomicProcessGroundingList_4010(
				Plan source, ActionGroundingList target) {
			return true;
		}
	}
