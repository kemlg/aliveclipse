 ...
 * @generated
 */
public class InputMessageMapParameterCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InputMessageMapParameterCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof InputMessageMap) {
			return false;
		}
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateInputMessageMapParameter_4007(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setParameter(getTarget());
		}
	 ...
	 * @generated
	 */
	protected InputMessageMap getSource() {
		return (InputMessageMap) source;
	}
