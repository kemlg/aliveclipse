...
import net.sf.ictalive.coordination.plans.diagram.edit.policies.PlansCollectionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PlansCollectionEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Plans"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public PlansCollectionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PlansCollectionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new PlansCollectionCanonicalEditPolicy());
