...
import net.sf.ictalive.coordination.plans.diagram.edit.policies.OpenDiagramEditPolicyOutput;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.OutputCanonicalEditPolicy;
import net.sf.ictalive.coordination.plans.diagram.edit.policies.OutputItemSemanticEditPolicy;
...
public class OutputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OutputCanonicalEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new OpenDiagramEditPolicyOutput());
