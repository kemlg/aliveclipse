/**
 * Adapted by David Corsar from CreateMissingShortcuts for the PlanTab 
 * @author Piotr Andruszkiewicz, David Corsar
 */
package net.sf.ictalive.coordination.plans.diagram.custom;
...
public class CreateMissingShortcuts {
	...
	public static void createMissingShortcuts(EObject obj, Diagram d,
			TransactionalEditingDomain domain) {
		System.out.println("creating missing shortcuts for obj type " + obj.getClass().getName());
