 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getImport <em>Import</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getRedefine <em>Redefine</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getGroup2 <em>Group2</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getElement <em>Element</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getNotation <em>Notation</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getAnnotation1 <em>Annotation1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getAttributeFormDefault <em>Attribute Form Default</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getBlockDefault <em>Block Default</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getElementFormDefault <em>Element Form Default</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getFinalDefault <em>Final Default</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.SchemaTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
