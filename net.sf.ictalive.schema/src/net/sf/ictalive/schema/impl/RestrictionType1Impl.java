 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getFacets <em>Facets</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getMinExclusive <em>Min Exclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getMaxExclusive <em>Max Exclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getTotalDigits <em>Total Digits</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getFractionDigits <em>Fraction Digits</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getLength <em>Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getEnumeration <em>Enumeration</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getWhiteSpace <em>White Space</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.RestrictionType1Impl#getBase <em>Base</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
