 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.impl.AppinfoTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.AppinfoTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.AppinfoTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.AppinfoTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.impl.AppinfoTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AppinfoTypeImpl extends EObjectImpl implements AppinfoType {
	/**
