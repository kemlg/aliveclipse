 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getComplexType <em>Complex Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getAttributeGroup <em>Attribute Group</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getId <em>Id</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RedefineType#getSchemaLocation <em>Schema Location</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType()
...
public interface RedefineType extends OpenAttrs {
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_Group()
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_Annotation()
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_SimpleType()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_ComplexType()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_Group1()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_AttributeGroup()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setId(String)
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_Id()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.schema.RedefineType#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRedefineType_SchemaLocation()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.schema.RedefineType#getSchemaLocation <em>Schema Location</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
