 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getSimpleType <em>Simple Type</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getFacets <em>Facets</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getMinExclusive <em>Min Exclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getMaxExclusive <em>Max Exclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getTotalDigits <em>Total Digits</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getFractionDigits <em>Fraction Digits</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getLength <em>Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getEnumeration <em>Enumeration</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getWhiteSpace <em>White Space</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getPattern <em>Pattern</em>}</li>
 *   <li>{@link net.sf.ictalive.schema.RestrictionType1#getBase <em>Base</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1()
...
public interface RestrictionType1 extends Annotated {
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_SimpleType()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.schema.RestrictionType1#getSimpleType <em>Simple Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_Facets()
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_MinExclusive()
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_MinInclusive()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_MaxExclusive()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_MaxInclusive()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_TotalDigits()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_FractionDigits()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_Length()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_MinLength()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_MaxLength()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_Enumeration()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_WhiteSpace()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_Pattern()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setBase(QName)
	 * @see net.sf.ictalive.schema.SchemaPackage#getRestrictionType1_Base()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.schema.RestrictionType1#getBase <em>Base</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
