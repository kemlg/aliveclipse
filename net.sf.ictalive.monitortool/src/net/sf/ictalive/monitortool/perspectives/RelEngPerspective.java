 ...
 *******************************************************************************/
package net.sf.ictalive.monitortool.perspectives;

import net.sf.ictalive.monitortool.views.EventBusLocationView;
...
//		bottom.addView("org.eclipse.team.ui.GenericHistoryView"); //NON-NLS-1
		bottom.addView("monitortool.views.EventList");
		...
		IFolderLayout topRight =
			factory.createFolder(
				...
				0.00f,
				factory.getEditorArea());
		// factory.addView(EventView.ID, IPageLayout.RIGHT, 1.0f, factory.getEditorArea());
		// topLeft.addView(IPageLayout.ID_RES_NAV);
		topLeft.addView(EventBusLocationView.ID); //NON-NLS-1
		// topRight.addView(EventView.ID);
		factory.setEditorAreaVisible(false);
		bottom.addPlaceholder(IConsoleConstants.ID_CONSOLE_VIEW);
		topRight.addPlaceholder(EventView.ID + ":*");
