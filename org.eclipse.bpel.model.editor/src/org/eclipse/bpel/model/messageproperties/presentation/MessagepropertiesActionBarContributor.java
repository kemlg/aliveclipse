...
public class MessagepropertiesActionBarContributor extends
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("messageproperties-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("messageproperties-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				BpelEditorPlugin.INSTANCE
						.getString("_UI_MessagepropertiesEditor_menu"), "org.eclipse.bpel.model.messagepropertiesMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(BpelEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(BpelEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(BpelEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
