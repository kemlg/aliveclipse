...
public class PartnerlinktypeActionBarContributor extends
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("partnerlinktype-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("partnerlinktype-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				BpelEditorPlugin.INSTANCE
						.getString("_UI_PartnerlinktypeEditor_menu"), "org.eclipse.bpel.model.partnerlinktypeMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
