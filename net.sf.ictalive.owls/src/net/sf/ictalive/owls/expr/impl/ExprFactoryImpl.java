...
public class ExprFactoryImpl extends EFactoryImpl implements ExprFactory {
	...
	public static ExprFactory init() {
		try {
			ExprFactory theExprFactory = (ExprFactory)EPackage.Registry.INSTANCE.getEFactory("http://ict-alive.sourceforge.net/owls/expr"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExprPackage.CONDITION: return createCondition();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ExprPackage.EXPRESSION_LANGUAGE:
