 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.Sequence#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.owls.process.ProcessPackage#getSequence()
 * @model
 * @generated
 */
public interface Sequence extends ControlConstruct {
	 ...
	 * @see net.sf.ictalive.owls.process.ProcessPackage#getSequence_Components()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.owls.process.Sequence#getComponents <em>Components</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
