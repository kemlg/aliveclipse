 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.impl.SplitJoinImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SplitJoinImpl extends ControlConstructImpl implements SplitJoin {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.SPLIT_JOIN;
	}
	...
	public NotificationChain basicSetComponents(ControlConstructBag newComponents, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.SPLIT_JOIN__COMPONENTS, oldComponents, newComponents);
	...
	public void setComponents(ControlConstructBag newComponents) {
		if (newComponents != components) {
			...
			if (components != null)
				msgs = ((InternalEObject)components).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.SPLIT_JOIN__COMPONENTS, null, msgs);
			if (newComponents != null)
				msgs = ((InternalEObject)newComponents).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.SPLIT_JOIN__COMPONENTS, null, msgs);
			msgs = basicSetComponents(newComponents, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SPLIT_JOIN__COMPONENTS, newComponents, newComponents));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.SPLIT_JOIN__COMPONENTS:
