 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.impl.SplitImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SplitImpl extends ControlConstructImpl implements Split {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.SPLIT;
	}
	...
	public NotificationChain basicSetComponents(ControlConstructBag newComponents, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.SPLIT__COMPONENTS, oldComponents, newComponents);
	...
	public void setComponents(ControlConstructBag newComponents) {
		if (newComponents != components) {
			...
			if (components != null)
				msgs = ((InternalEObject)components).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.SPLIT__COMPONENTS, null, msgs);
			if (newComponents != null)
				msgs = ((InternalEObject)newComponents).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.SPLIT__COMPONENTS, null, msgs);
			msgs = basicSetComponents(newComponents, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.SPLIT__COMPONENTS, newComponents, newComponents));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.SPLIT__COMPONENTS:
