 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.SplitJoin#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.owls.process.ProcessPackage#getSplitJoin()
 * @model
 * @generated
 */
public interface SplitJoin extends ControlConstruct {
	 ...
	 * @see net.sf.ictalive.owls.process.ProcessPackage#getSplitJoin_Components()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.owls.process.SplitJoin#getComponents <em>Components</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
