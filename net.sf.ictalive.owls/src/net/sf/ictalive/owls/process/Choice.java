 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.owls.process.Choice#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.owls.process.ProcessPackage#getChoice()
 * @model
 * @generated
 */
public interface Choice extends ControlConstruct {
	 ...
	 * @see net.sf.ictalive.owls.process.ProcessPackage#getChoice_Components()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.owls.process.Choice#getComponents <em>Components</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
