...
public class RestartEventLog extends PluggedInDashboardAction<RuntimeDashboardState>
{	
	@Override
	public String dashboardActionId()
	{
		return RuntimeDashboardState.RestartEventLogId;
	}
	...
	public String getProblems(RuntimeDashboardState state)
	{
		...
		{
			res = "EventLog instance not running. Please start before restarting.";
		}
		else
		{
			res = null;
