...
public class RestartEventCollector extends PluggedInDashboardAction<RuntimeDashboardState>
{	
	@Override
	public String dashboardActionId()
	{
		return RuntimeDashboardState.RestartEventCollectorId;
	}
	...
	public String getProblems(RuntimeDashboardState state)
	{
		...
		{
			res = "EventCollector instance not running. Please start before restarting.";
		}
		else
		{
			res = null;
