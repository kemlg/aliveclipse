...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider extends BPELExtensibleElementItemProvider
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Activity_name_feature", "_UI_Activity_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						BPELPackage.Literals.ACTIVITY__NAME, true, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_Activity_suppressJoinFailure_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Activity_suppressJoinFailure_feature", "_UI_Activity_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						BPELPackage.Literals.ACTIVITY__SUPPRESS_JOIN_FAILURE,
						true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPELPackage.Literals.ACTIVITY__TARGETS);
			childrenFeatures.add(BPELPackage.Literals.ACTIVITY__SOURCES);
		}
