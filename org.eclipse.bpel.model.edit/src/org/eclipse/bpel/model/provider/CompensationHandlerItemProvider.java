...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.CompensationHandler} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompensationHandlerItemProvider extends
	 ...
	 * @generated
	 */
	public CompensationHandlerItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(BPELPackage.Literals.COMPENSATION_HANDLER__ACTIVITY);
		}
	...
	/**
	 * This returns CompensationHandler.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		Element labelValue = ((CompensationHandler) object)
				.getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_CompensationHandler_type") : //$NON-NLS-1$
				getString("_UI_CompensationHandler_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.COMPENSATION_HANDLER__ACTIVITY,
