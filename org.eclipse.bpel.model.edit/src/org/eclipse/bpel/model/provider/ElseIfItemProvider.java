 ...
 * @generated
 */
public class ElseIfItemProvider extends BPELExtensibleElementItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ElseIf")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.ELSE_IF__CONDITION,
				BPELFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.ELSE_IF__ACTIVITY,
