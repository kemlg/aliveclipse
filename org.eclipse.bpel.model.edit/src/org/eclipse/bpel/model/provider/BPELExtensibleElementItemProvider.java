...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.BPELExtensibleElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPELExtensibleElementItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public BPELExtensibleElementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(BPELPackage.Literals.BPEL_EXTENSIBLE_ELEMENT__DOCUMENTATION);
		}
	...
	/**
	 * This returns BPELExtensibleElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/BPELExtensibleElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		Element labelValue = ((BPELExtensibleElement) object)
				.getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_BPELExtensibleElement_type") : //$NON-NLS-1$
				getString("_UI_BPELExtensibleElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BPELExtensibleElement.class)) {
		case BPELPackage.BPEL_EXTENSIBLE_ELEMENT__DOCUMENTATION_ELEMENT:
		case BPELPackage.BPEL_EXTENSIBLE_ELEMENT__ELEMENT:
			fireNotifyChanged(new ViewerNotification(notification,
					notification.getNotifier(), false, true));
			return;
		case BPELPackage.BPEL_EXTENSIBLE_ELEMENT__EEXTENSIBILITY_ELEMENTS:
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.BPEL_EXTENSIBLE_ELEMENT__DOCUMENTATION,
				BPELFactory.eINSTANCE.createDocumentation()));
	}
