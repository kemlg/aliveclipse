 ...
 * @generated
 */
public class ProcessItemProvider extends ExtensibleElementItemProvider
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.PROCESS__VARIABLES, BPELFactory.eINSTANCE
						.createVariables()));

		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.PROCESS__ACTIVITY, BPELFactory.eINSTANCE
						.createActivity()));
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.PROCESS__IMPORTS, BPELFactory.eINSTANCE
						.createImport()));

		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.PROCESS__EXTENSIONS, BPELFactory.eINSTANCE
						.createExtensions()));
	}
