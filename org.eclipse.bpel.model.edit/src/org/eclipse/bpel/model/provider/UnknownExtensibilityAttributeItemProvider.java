...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.UnknownExtensibilityAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnknownExtensibilityAttributeItemProvider extends
	 ...
	 * @generated
	 */
	public UnknownExtensibilityAttributeItemProvider(
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(WSDLPackage.Literals.UNKNOWN_EXTENSIBILITY_ELEMENT__CHILDREN);
		}
	...
	/**
	 * This returns UnknownExtensibilityAttribute.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		Element labelValue = ((UnknownExtensibilityAttribute) object)
				.getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_UnknownExtensibilityAttribute_type") : //$NON-NLS-1$
				getString("_UI_UnknownExtensibilityAttribute_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnknownExtensibilityAttribute.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				WSDLPackage.Literals.UNKNOWN_EXTENSIBILITY_ELEMENT__CHILDREN,
				BPELFactory.eINSTANCE.createUnknownExtensibilityAttribute()));

		newChildDescriptors.add(createChildParameter(
				WSDLPackage.Literals.UNKNOWN_EXTENSIBILITY_ELEMENT__CHILDREN,
				WSDLFactory.eINSTANCE.createUnknownExtensibilityElement()));
	}
