...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.Pick} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PickItemProvider extends ActivityItemProvider implements
	...
	protected void addCreateInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Pick_createInstance_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Pick_createInstance_feature", "_UI_Pick_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						BPELPackage.Literals.PICK__CREATE_INSTANCE, true,
						false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPELPackage.Literals.PICK__MESSAGES);
			childrenFeatures.add(BPELPackage.Literals.PICK__ALARM);
		}
	...
	public String getText(Object object) {
		String label = ((Pick) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Pick_type") : //$NON-NLS-1$
				getString("_UI_Pick_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
