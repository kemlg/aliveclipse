...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.If} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfItemProvider extends ActivityItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPELPackage.Literals.IF__CONDITION);
			childrenFeatures.add(BPELPackage.Literals.IF__ELSE_IF);
			childrenFeatures.add(BPELPackage.Literals.IF__ELSE);
			childrenFeatures.add(BPELPackage.Literals.IF__ACTIVITY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/If")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.IF__CONDITION,
				BPELFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.IF__ELSE_IF,
				BPELFactory.eINSTANCE.createElseIf()));

		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.IF__ELSE,
				BPELFactory.eINSTANCE.createElse()));

		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.IF__ACTIVITY,
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == WSDLPackage.Literals.EXTENSIBLE_ELEMENT__EEXTENSIBILITY_ELEMENTS
				|| childFeature == BPELPackage.Literals.IF__CONDITION;
