...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.CatchAll} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CatchAllItemProvider extends BPELExtensibleElementItemProvider
	 ...
	 * @generated
	 */
	public CatchAllItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPELPackage.Literals.CATCH_ALL__ACTIVITY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/CatchAll")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		Element labelValue = ((CatchAll) object).getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_CatchAll_type") : //$NON-NLS-1$
				getString("_UI_CatchAll_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CatchAll.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.CATCH_ALL__ACTIVITY,
