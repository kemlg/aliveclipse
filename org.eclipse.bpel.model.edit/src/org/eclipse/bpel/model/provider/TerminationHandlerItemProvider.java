...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.TerminationHandler} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminationHandlerItemProvider extends
	 ...
	 * @generated
	 */
	public TerminationHandlerItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(BPELPackage.Literals.TERMINATION_HANDLER__ACTIVITY);
		}
	...
	/**
	 * This returns TerminationHandler.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TerminationHandler")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		Element labelValue = ((TerminationHandler) object)
				.getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_TerminationHandler_type") : //$NON-NLS-1$
				getString("_UI_TerminationHandler_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TerminationHandler.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.TERMINATION_HANDLER__ACTIVITY,
