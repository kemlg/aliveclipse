...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.RepeatUntil} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatUntilItemProvider extends ActivityItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPELPackage.Literals.REPEAT_UNTIL__ACTIVITY);
			childrenFeatures.add(BPELPackage.Literals.REPEAT_UNTIL__CONDITION);
		}
	...
	public String getText(Object object) {
		String label = ((RepeatUntil) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_RepeatUntil_type") : //$NON-NLS-1$
				getString("_UI_RepeatUntil_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.REPEAT_UNTIL__ACTIVITY,
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.REPEAT_UNTIL__CONDITION,
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == WSDLPackage.Literals.EXTENSIBLE_ELEMENT__EEXTENSIBILITY_ELEMENTS
				|| childFeature == BPELPackage.Literals.REPEAT_UNTIL__CONDITION;
