...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.BooleanExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanExpressionItemProvider extends ExpressionItemProvider
	...
	public String getText(Object object) {
		Element labelValue = ((BooleanExpression) object)
				.getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_BooleanExpression_type") : //$NON-NLS-1$
				getString("_UI_BooleanExpression_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
