...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.Links} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinksItemProvider extends ExtensibleElementItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPELPackage.Literals.LINKS__CHILDREN);
		}
	...
	public String getText(Object object) {
		Element labelValue = ((Links) object).getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_Links_type") : //$NON-NLS-1$
				getString("_UI_Links_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
