 ...
 * 
 */
@WebServiceClient(name = "EcografiaService", targetNamespace = "http://www.owl-ontologies.com/ECSDIServices", wsdlLocation = "file:/Users/sergio/Documents/Research/ecsdi/aliveclipse/ExampleWebApplication/src/conf/xml-resources/web-services/EcoService/wsdl/ECSDIServices.wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECOGRAFIASERVICE_QNAME = new QName("http://www.owl-ontologies.com/ECSDIServices", "EcografiaService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/sergio/Documents/Research/ecsdi/aliveclipse/ExampleWebApplication/src/conf/xml-resources/web-services/EcoService/wsdl/ECSDIServices.wsdl");
    ...
    public EcografiaPortType getEcografiaPort() {
        return super.getPort(new QName("http://www.owl-ontologies.com/ECSDIServices", "EcografiaPort"), EcografiaPortType.class);
    }
    ...
    public EcografiaPortType getEcografiaPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.owl-ontologies.com/ECSDIServices", "EcografiaPort"), EcografiaPortType.class, features);
    }
