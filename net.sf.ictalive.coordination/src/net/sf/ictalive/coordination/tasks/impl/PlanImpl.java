 ...
 *   <li>{@link net.sf.ictalive.coordination.tasks.impl.PlanImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlanImpl extends EObjectImpl implements Plan {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TasksPackage.PLAN__NAME, oldName, name));
	}
