 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.coordination.tasks.TasksCollection#getNs <em>Ns</em>}</li>
...
public interface TasksCollection extends EObject {
	 ...
	 * @see #setNs(String)
	 * @see net.sf.ictalive.coordination.tasks.TasksPackage#getTasksCollection_Ns()
	 * @model
	 * @generated
	 */
	String getNs();
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.coordination.tasks.TasksCollection#getNs <em>Ns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
