...
public interface ActionsPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://ict-alive.sourceforge.net/coordination/actions";
	 ...
	 * @ordered
	 */
	int ACTION__PERFORMED_BY_ROLE = ProcessPackage.PROCESS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACTION_FEATURE_COUNT = ProcessPackage.PROCESS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ACTIONS_COLLECTION__ACTIONS = 1;
	 ...
	 * @ordered
	 */
	int ACTIONS_COLLECTION__PARTICIPANTS = 2;
	 ...
	 * @ordered
	 */
	int ACTIONS_COLLECTION__PARAMETERS = 3;
	...
	/**
	 * Returns the meta object for the attribute '{@link net.sf.ictalive.coordination.actions.ActionsCollection#getNs <em>Ns</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Ns</em>'.
	 * @see net.sf.ictalive.coordination.actions.ActionsCollection#getNs()
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute ACTIONS_COLLECTION__NS = eINSTANCE.getActionsCollection_Ns();
