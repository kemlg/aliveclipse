 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.coordination.actions.impl.ActionsCollectionImpl#getNs <em>Ns</em>}</li>
...
public class ActionsCollectionImpl extends EObjectImpl implements ActionsCollection {
	...
	public void setNs(String newNs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.ACTIONS_COLLECTION__NS, oldNs, ns));
	}
