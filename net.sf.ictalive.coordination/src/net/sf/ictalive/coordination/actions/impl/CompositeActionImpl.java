...
public class CompositeActionImpl extends ActionImpl implements CompositeAction {
	...
	public NotificationChain basicSetComposedOf(ControlConstruct newComposedOf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActionsPackage.COMPOSITE_ACTION__COMPOSED_OF, oldComposedOf, newComposedOf);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setComposedOf(ControlConstruct newComposedOf) {
		if (newComposedOf != composedOf) {
			NotificationChain msgs = null;
			if (composedOf != null)
				msgs = ((InternalEObject)composedOf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActionsPackage.COMPOSITE_ACTION__COMPOSED_OF, null, msgs);
			if (newComposedOf != null)
				msgs = ((InternalEObject)newComposedOf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActionsPackage.COMPOSITE_ACTION__COMPOSED_OF, null, msgs);
			msgs = basicSetComposedOf(newComposedOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionsPackage.COMPOSITE_ACTION__COMPOSED_OF, newComposedOf, newComposedOf));
	}
