...
public class AgentsAdapterFactory extends AdapterFactoryImpl {
	...
	protected AgentsSwitch<Adapter> modelSwitch =
		new AgentsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMasModel(MasModel object) {
				return createMasModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.sf.ictalive.coordination.agents.MasModel <em>Mas Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
