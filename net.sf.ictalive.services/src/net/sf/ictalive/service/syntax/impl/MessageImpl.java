 ...
 *   <li>{@link net.sf.ictalive.service.syntax.impl.MessageImpl#getPart <em>Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends EObjectImpl implements Message {
	...
	public EList<Part> getPart() {
		if (part == null) {
			part = new EObjectContainmentEList<Part>(Part.class, this, SyntaxPackage.MESSAGE__PART);
		}
		return part;
	}
