 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.service.template.Split#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ictalive.service.template.TemplatePackage#getSplit()
 * @model
 * @generated
 */
public interface Split extends ControlConstruct {
	 ...
	 * @see net.sf.ictalive.service.template.TemplatePackage#getSplit_Components()
	...
	/**
	 * Sets the value of the '{@link net.sf.ictalive.service.template.Split#getComponents <em>Components</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
