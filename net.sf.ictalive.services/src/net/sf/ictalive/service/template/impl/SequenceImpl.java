 ...
 * <ul>
 *   <li>{@link net.sf.ictalive.service.template.impl.SequenceImpl#getComponents <em>Components</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceImpl extends ControlConstructImpl implements Sequence {
	...
	protected EClass eStaticClass() {
		return TemplatePackage.Literals.SEQUENCE;
	}
	...
	public NotificationChain basicSetComponents(ControlConstructList newComponents, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemplatePackage.SEQUENCE__COMPONENTS, oldComponents, newComponents);
	...
	public void setComponents(ControlConstructList newComponents) {
		if (newComponents != components) {
			...
			if (components != null)
				msgs = ((InternalEObject)components).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.SEQUENCE__COMPONENTS, null, msgs);
			if (newComponents != null)
				msgs = ((InternalEObject)newComponents).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.SEQUENCE__COMPONENTS, null, msgs);
			msgs = basicSetComponents(newComponents, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.SEQUENCE__COMPONENTS, newComponents, newComponents));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TemplatePackage.SEQUENCE__COMPONENTS:
