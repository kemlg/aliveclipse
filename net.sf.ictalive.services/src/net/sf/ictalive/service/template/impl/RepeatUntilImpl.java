...
public class RepeatUntilImpl extends IterateImpl implements RepeatUntil {
	...
	public Atom getUntilCondition() {
		if (untilCondition != null && untilCondition.eIsProxy()) {
			...
			untilCondition = (Atom)eResolveProxy(oldUntilCondition);
	 ...
	 * @generated
	 */
	public void setUntilCondition(Atom newUntilCondition) {
		Atom oldUntilCondition = untilCondition;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TemplatePackage.REPEAT_UNTIL__UNTIL_CONDITION:
				setUntilCondition((Atom)newValue);
				return;
			case TemplatePackage.REPEAT_UNTIL__UNTIL_PROCESS:
