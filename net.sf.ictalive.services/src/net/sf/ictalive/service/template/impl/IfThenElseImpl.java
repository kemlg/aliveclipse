...
public class IfThenElseImpl extends ControlConstructImpl implements IfThenElse {
	...
	public Atom getIfCondition() {
		if (ifCondition != null && ifCondition.eIsProxy()) {
			...
			ifCondition = (Atom)eResolveProxy(oldIfCondition);
	 ...
	 * @generated
	 */
	public void setIfCondition(Atom newIfCondition) {
		Atom oldIfCondition = ifCondition;
