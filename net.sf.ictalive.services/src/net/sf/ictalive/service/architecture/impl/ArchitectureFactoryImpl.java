...
public class ArchitectureFactoryImpl extends EFactoryImpl implements ArchitectureFactory {
	...
	public static ArchitectureFactory init() {
		try {
			ArchitectureFactory theArchitectureFactory = (ArchitectureFactory)EPackage.Registry.INSTANCE.getEFactory("http://ict-alive.sourceforge.net/services/architecture"); 
