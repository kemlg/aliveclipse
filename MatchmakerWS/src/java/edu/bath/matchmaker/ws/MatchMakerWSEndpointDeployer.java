 ...
 */
public class MatchMakerWSEndpointDeployer {

    private MatchMakerWSEndpointDeployer() {
    }
     ...
     * @param matchMaker the underlying {@link MatchMaker} instance on which the service will be implemented
     * @return a proxy to the deployed service
     */
    public static Proxy deploy(int port, MatchMaker matchMaker) {
        MatchMakerWSImpl serviceImpl = new MatchMakerWSImpl(matchMaker);
