 ...
 * <ul>
 *   <li>{@link OM.impl.CountsAsImpl#getConcreteFact <em>Concrete Fact</em>}</li>
 *   <li>{@link OM.impl.CountsAsImpl#getAbstractFact <em>Abstract Fact</em>}</li>
 *   <li>{@link OM.impl.CountsAsImpl#getContext <em>Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CountsAsImpl extends MinimalEObjectImpl.Container implements CountsAs
{
  /**
