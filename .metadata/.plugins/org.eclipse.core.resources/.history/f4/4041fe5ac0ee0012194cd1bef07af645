 ...
 * <ul>
 *   <li>{@link OM.Atom#getPredicate <em>Predicate</em>}</li>
 *   <li>{@link OM.Atom#getConcept <em>Concept</em>}</li>
 *   <li>{@link OM.Atom#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getAtom()
 * @model
 * @generated
 */
public interface Atom extends StateFormula
{
   ...
   * @see OM.OMPackage#getAtom_Predicate()
  ...
  /**
   * Sets the value of the '{@link OM.Atom#getPredicate <em>Predicate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Unsets the value of the '{@link OM.Atom#getPredicate <em>Predicate</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetPredicate()
   * @see #getPredicate()
  ...
  /**
   * Returns whether the value of the '{@link OM.Atom#getPredicate <em>Predicate</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getAtom_Concept()
   * @model required="true"
   * @generated
   */
  Concept getConcept();
  ...
  /**
   * Sets the value of the '{@link OM.Atom#getConcept <em>Concept</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getAtom_Arguments()
   * @model
   * @generated
   */
