 ...
 * <ul>
 *   <li>{@link OM.PathImplication#getAntecedentPathFormula <em>Antecedent Path Formula</em>}</li>
 *   <li>{@link OM.PathImplication#getConsequentPathFormula <em>Consequent Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getPathImplication()
 * @model
 * @generated
 */
public interface PathImplication extends PathFormula
{
   ...
   * @see OM.OMPackage#getPathImplication_AntecedentPathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.PathImplication#getAntecedentPathFormula <em>Antecedent Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getPathImplication_ConsequentPathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.PathImplication#getConsequentPathFormula <em>Consequent Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
