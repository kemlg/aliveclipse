 ...
 * <ul>
 *   <li>{@link OM.Sometime#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getSometime()
 * @model
 * @generated
 */
public interface Sometime extends PathFormula
{
   ...
   * @see OM.OMPackage#getSometime_PathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Sometime#getPathFormula <em>Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
