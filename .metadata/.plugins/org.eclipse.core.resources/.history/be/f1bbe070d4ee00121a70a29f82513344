...
public class NormImpl extends MinimalEObjectImpl.Container implements Norm
{
  ...
  {
    if (deontics != null && deontics.eIsProxy())
    {
      InternalEObject oldDeontics = (InternalEObject)deontics;
      deontics = (DeonticStatement)eResolveProxy(oldDeontics);
      if (deontics != oldDeontics)
      {
        InternalEObject newDeontics = (InternalEObject)deontics;
        NotificationChain msgs = oldDeontics.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OMPackage.NORM__DEONTICS, null, null);
        if (newDeontics.eInternalContainer() == null)
        {
          msgs = newDeontics.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OMPackage.NORM__DEONTICS, null, msgs);
        }
        if (msgs != null) msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, OMPackage.NORM__DEONTICS, oldDeontics, deontics));
      }
    }
    return deontics;
  }
   ...
   * @generated
   */
  public DeonticStatement basicGetDeontics()
  {
    return deontics;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case OMPackage.NORM__DEONTICS:
        if (resolve) return getDeontics();
        return basicGetDeontics();
