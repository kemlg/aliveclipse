...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpel.model.ExtensibleElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensibleElementItemProvider extends ItemProviderAdapter
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(BPELPackage.Literals.EXTENSIBLE_ELEMENT__DOCUMENTATION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/ExtensibleElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		Element labelValue = ((ExtensibleElement) object)
				.getDocumentationElement();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_ExtensibleElement_type") : //$NON-NLS-1$
				getString("_UI_ExtensibleElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				BPELPackage.Literals.EXTENSIBLE_ELEMENT__DOCUMENTATION,
