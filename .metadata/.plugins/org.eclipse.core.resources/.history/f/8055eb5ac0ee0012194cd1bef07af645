 ...
 * <ul>
 *   <li>{@link OM.NetworkDependency#getDependant1 <em>Dependant1</em>}</li>
 *   <li>{@link OM.NetworkDependency#getDependant2 <em>Dependant2</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getNetworkDependency()
 * @model
 * @generated
 */
public interface NetworkDependency extends Dependency
{
   ...
   * @see OM.OMPackage#getNetworkDependency_Dependant1()
   * @model required="true"
   * @generated
   */
  Role getDependant1();
  ...
  /**
   * Sets the value of the '{@link OM.NetworkDependency#getDependant1 <em>Dependant1</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getNetworkDependency_Dependant2()
   * @model required="true"
   * @generated
   */
  Role getDependant2();
  ...
  /**
   * Sets the value of the '{@link OM.NetworkDependency#getDependant2 <em>Dependant2</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
