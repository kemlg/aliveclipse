 ...
 * <ul>
 *   <li>{@link OM.PathConjunction#getLeftPathFormula <em>Left Path Formula</em>}</li>
 *   <li>{@link OM.PathConjunction#getRightPathFormula <em>Right Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getPathConjunction()
 * @model
 * @generated
 */
public interface PathConjunction extends PathFormula
{
   ...
   * @see OM.OMPackage#getPathConjunction_LeftPathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.PathConjunction#getLeftPathFormula <em>Left Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getPathConjunction_RightPathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.PathConjunction#getRightPathFormula <em>Right Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
