 ...
 * <ul>
 *   <li>{@link OM.impl.ImplicationImpl#getAntecedentStateFormula <em>Antecedent State Formula</em>}</li>
 *   <li>{@link OM.impl.ImplicationImpl#getConsequentStateFormula <em>Consequent State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
