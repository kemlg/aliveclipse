...
/**
 * Entry point of the 'Sl2Code' generation module.
 * 
 * @author <a href="mailto:jonathan.musset@obeo.fr">Jonathan Musset</a>
 */
public class Sl2Code {

	/**
	 * The name of the module.
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "sl2Code";
	
	/**
	 * The name of the templates that are to be generated.
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "sl2Code", };
	 ...
	 * @generated
	 */
	public Sl2Code(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
    ResourceSet resourceSet = new ResourceSetImpl();
    registerResourceFactories(resourceSet);
    registerPackages(resourceSet);
    final URL templateURL;
    if (EMFPlugin.IS_ECLIPSE_RUNNING) {
      templateURL = FileLocator.toFileURL(Sl2Code.class.getResource(MODULE_FILE_NAME + ".emtl"));
    } else {
      templateURL = Sl2Code.class.getResource(MODULE_FILE_NAME + ".emtl");
    }
    if (templateURL == null) {
	 ...
	 * @generated
	 */
	public Sl2Code(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    resourceSet.getPackageRegistry().put(net.sf.ictalive.service.ServicePackage.eINSTANCE.getNsURI(), net.sf.ictalive.service.ServicePackage.eINSTANCE);
    resourceSet.getPackageRegistry().put(net.sf.ictalive.service.syntax.SyntaxPackage.eINSTANCE.getNsURI(), net.sf.ictalive.service.syntax.SyntaxPackage.eINSTANCE);
    resourceSet.getPackageRegistry().put(net.sf.ictalive.service.semantics.SemanticsPackage.eINSTANCE.getNsURI(), net.sf.ictalive.service.semantics.SemanticsPackage.eINSTANCE);
    resourceSet.getPackageRegistry().put(net.sf.ictalive.service.template.TemplatePackage.eINSTANCE.getNsURI(), net.sf.ictalive.service.template.TemplatePackage.eINSTANCE);
    resourceSet.getPackageRegistry().put(net.sf.ictalive.service.architecture.ArchitecturePackage.eINSTANCE.getNsURI(), net.sf.ictalive.service.architecture.ArchitecturePackage.eINSTANCE);
    ...
    for (int i = 0; i < TEMPLATE_NAMES.length; i++) {
    	AcceleoService as = new AcceleoService();
      as.doGenerate(module, TEMPLATE_NAMES[i], model, arguments, targetFolder, false, monitor);
    }
  }
