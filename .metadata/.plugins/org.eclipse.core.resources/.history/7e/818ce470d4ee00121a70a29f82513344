 ...
 * <ul>
 *   <li>{@link OM.impl.ConjunctionImpl#getLeftStateFormula <em>Left State Formula</em>}</li>
 *   <li>{@link OM.impl.ConjunctionImpl#getRightStateFormula <em>Right State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
