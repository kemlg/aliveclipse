 ...
 * <ul>
 *   <li>{@link OM.impl.ConceptImpl#getConcept <em>Concept</em>}</li>
 *   <li>{@link OM.impl.ConceptImpl#getURI <em>URI</em>}</li>
 *   <li>{@link OM.impl.ConceptImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
