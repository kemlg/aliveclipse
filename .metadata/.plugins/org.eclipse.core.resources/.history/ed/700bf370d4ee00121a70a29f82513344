 ...
 * <ul>
 *   <li>{@link OM.Implication#getAntecedentStateFormula <em>Antecedent State Formula</em>}</li>
 *   <li>{@link OM.Implication#getConsequentStateFormula <em>Consequent State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getImplication()
 * @model
 * @generated
 */
public interface Implication extends StateFormula
{
   ...
   * @see OM.OMPackage#getImplication_AntecedentStateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Implication#getAntecedentStateFormula <em>Antecedent State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getImplication_ConsequentStateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Implication#getConsequentStateFormula <em>Consequent State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
