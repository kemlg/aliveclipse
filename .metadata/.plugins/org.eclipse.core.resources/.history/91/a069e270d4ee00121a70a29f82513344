 ...
 * <ul>
 *   <li>{@link OM.impl.LandmarkImpl#getName <em>Name</em>}</li>
 *   <li>{@link OM.impl.LandmarkImpl#getStateDescription <em>State Description</em>}</li>
 *   <li>{@link OM.impl.LandmarkImpl#getEntails <em>Entails</em>}</li>
 *   <li>{@link OM.impl.LandmarkImpl#isIsResult <em>Is Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LandmarkImpl extends MinimalEObjectImpl.Container implements Landmark
{
  /**
  ...
  {
    // TODO: implement this method to return the 'Is Result' attribute
  ...
  {
    // TODO: implement this method to set the 'Is Result' attribute
    // Ensure that you remove @generated or mark it @generated NOT
    throw new UnsupportedOperationException();
  }
