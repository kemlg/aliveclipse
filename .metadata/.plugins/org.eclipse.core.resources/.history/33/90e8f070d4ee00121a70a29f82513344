 ...
 * <ul>
 *   <li>{@link OM.Next#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getNext()
 * @model
 * @generated
 */
public interface Next extends PathFormula
{
   ...
   * @see OM.OMPackage#getNext_PathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Next#getPathFormula <em>Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
