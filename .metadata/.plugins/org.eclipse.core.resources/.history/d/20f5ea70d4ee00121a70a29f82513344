 ...
 * <ul>
 *   <li>{@link OM.PathDisjunction#getLeftPathFormula <em>Left Path Formula</em>}</li>
 *   <li>{@link OM.PathDisjunction#getRightPathFormula <em>Right Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getPathDisjunction()
 * @model
 * @generated
 */
public interface PathDisjunction extends PathFormula
{
   ...
   * @see OM.OMPackage#getPathDisjunction_LeftPathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.PathDisjunction#getLeftPathFormula <em>Left Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getPathDisjunction_RightPathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.PathDisjunction#getRightPathFormula <em>Right Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
