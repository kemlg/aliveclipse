 ...
 * <ul>
 *   <li>{@link OM.Negation#getStateFormula <em>State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getNegation()
 * @model
 * @generated
 */
public interface Negation extends StateFormula
{
   ...
   * @see OM.OMPackage#getNegation_StateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Negation#getStateFormula <em>State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
