 ...
 * <ul>
 *   <li>{@link OM.Disjunction#getLeftStateFormula <em>Left State Formula</em>}</li>
 *   <li>{@link OM.Disjunction#getRightStateFormula <em>Right State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getDisjunction()
 * @model
 * @generated
 */
public interface Disjunction extends StateFormula
{
   ...
   * @see OM.OMPackage#getDisjunction_LeftStateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Disjunction#getLeftStateFormula <em>Left State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getDisjunction_RightStateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Disjunction#getRightStateFormula <em>Right State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
