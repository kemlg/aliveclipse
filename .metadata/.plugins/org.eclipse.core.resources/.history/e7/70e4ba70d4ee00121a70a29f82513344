...
public class OMSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case OMPackage.EXISTS:
      {
        Exists exists = (Exists)theEObject;
        T result = caseExists(exists);
        if (result == null) result = caseFirstOrderQuantifier(exists);
        if (result == null) result = casePartialStateDescription(exists);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OMPackage.FIRST_ORDER_QUANTIFIER:
      {
        FirstOrderQuantifier firstOrderQuantifier = (FirstOrderQuantifier)theEObject;
        T result = caseFirstOrderQuantifier(firstOrderQuantifier);
        if (result == null) result = casePartialStateDescription(firstOrderQuantifier);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OMPackage.FOR_ALL:
      {
        ForAll forAll = (ForAll)theEObject;
        T result = caseForAll(forAll);
        if (result == null) result = caseFirstOrderQuantifier(forAll);
        if (result == null) result = casePartialStateDescription(forAll);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>First Order Quantifier</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>First Order Quantifier</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseFirstOrderQuantifier(FirstOrderQuantifier object)
  {
    return null;
  }
