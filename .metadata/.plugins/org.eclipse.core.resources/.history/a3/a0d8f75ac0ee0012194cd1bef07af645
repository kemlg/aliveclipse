 ...
 * <ul>
 *   <li>{@link OM.ExistsPath#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getExistsPath()
 * @model
 * @generated
 */
public interface ExistsPath extends StateFormula
{
   ...
   * @see OM.OMPackage#getExistsPath_PathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.ExistsPath#getPathFormula <em>Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
