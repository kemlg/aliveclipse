 ...
 * <ul>
 *   <li>{@link OM.impl.ObjectiveImpl#getName <em>Name</em>}</li>
 *   <li>{@link OM.impl.ObjectiveImpl#getConceptName <em>Concept Name</em>}</li>
 *   <li>{@link OM.impl.ObjectiveImpl#getStateDescription <em>State Description</em>}</li>
 *   <li>{@link OM.impl.ObjectiveImpl#getSubObjectives <em>Sub Objectives</em>}</li>
 *   <li>{@link OM.impl.ObjectiveImpl#getParentObjective <em>Parent Objective</em>}</li>
 *   <li>{@link OM.impl.ObjectiveImpl#getUsedByRole <em>Used By Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
