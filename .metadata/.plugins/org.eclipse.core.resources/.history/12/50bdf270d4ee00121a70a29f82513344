 ...
 * <ul>
 *   <li>{@link OM.Landmark#getName <em>Name</em>}</li>
 *   <li>{@link OM.Landmark#getStateDescription <em>State Description</em>}</li>
 *   <li>{@link OM.Landmark#getEntails <em>Entails</em>}</li>
 *   <li>{@link OM.Landmark#isIsResult <em>Is Result</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getLandmark()
 * @model
 * @generated
 */
public interface Landmark extends EObject
{
   ...
   * @see #setName(String)
   * @see OM.OMPackage#getLandmark_Name()
  ...
  /**
   * Sets the value of the '{@link OM.Landmark#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getLandmark_StateDescription()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Landmark#getStateDescription <em>State Description</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getLandmark_Entails()
   * @model
   * @generated
   */
   ...
   * @see OM.OMPackage#getLandmark_IsResult()
   * @model default="false" unique="false" required="true" transient="true" volatile="true"
   * @generated
   */
  boolean isIsResult();

  /**
   * Sets the value of the '{@link OM.Landmark#isIsResult <em>Is Result</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
