 ...
 * <ul>
 *   <li>{@link OM.TransitionNorm#getID <em>ID</em>}</li>
 *   <li>{@link OM.TransitionNorm#getFromScene <em>From Scene</em>}</li>
 *   <li>{@link OM.TransitionNorm#getFromPlayers <em>From Players</em>}</li>
 *   <li>{@link OM.TransitionNorm#getFromResults <em>From Results</em>}</li>
 *   <li>{@link OM.TransitionNorm#getToScene <em>To Scene</em>}</li>
 *   <li>{@link OM.TransitionNorm#getToPlayer <em>To Player</em>}</li>
 *   <li>{@link OM.TransitionNorm#getAttachedTo <em>Attached To</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getTransitionNorm()
 * @model
 * @generated
 */
public interface TransitionNorm extends EObject
{
   ...
   * @see #setID(String)
   * @see OM.OMPackage#getTransitionNorm_ID()
  ...
  /**
   * Sets the value of the '{@link OM.TransitionNorm#getID <em>ID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getTransitionNorm_FromScene()
   * @model required="true"
   * @generated
   */
  Scene getFromScene();
  ...
  /**
   * Sets the value of the '{@link OM.TransitionNorm#getFromScene <em>From Scene</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getTransitionNorm_FromPlayers()
   * @model required="true"
   * @generated
   */
   ...
   * @see OM.OMPackage#getTransitionNorm_FromResults()
   * @model required="true"
   * @generated
   */
   ...
   * @see OM.OMPackage#getTransitionNorm_ToScene()
   * @model required="true"
   * @generated
   */
  Scene getToScene();
  ...
  /**
   * Sets the value of the '{@link OM.TransitionNorm#getToScene <em>To Scene</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getTransitionNorm_ToPlayer()
   * @model required="true"
   * @generated
   */
  Player getToPlayer();
  ...
  /**
   * Sets the value of the '{@link OM.TransitionNorm#getToPlayer <em>To Player</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getTransitionNorm_AttachedTo()
  ...
  /**
   * Sets the value of the '{@link OM.TransitionNorm#getAttachedTo <em>Attached To</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
