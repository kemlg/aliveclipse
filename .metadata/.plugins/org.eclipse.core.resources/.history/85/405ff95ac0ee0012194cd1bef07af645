 ...
 * <ul>
 *   <li>{@link OM.Conjunction#getLeftStateFormula <em>Left State Formula</em>}</li>
 *   <li>{@link OM.Conjunction#getRightStateFormula <em>Right State Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getConjunction()
 * @model
 * @generated
 */
public interface Conjunction extends StateFormula
{
   ...
   * @see OM.OMPackage#getConjunction_LeftStateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Conjunction#getLeftStateFormula <em>Left State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see OM.OMPackage#getConjunction_RightStateFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Conjunction#getRightStateFormula <em>Right State Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
