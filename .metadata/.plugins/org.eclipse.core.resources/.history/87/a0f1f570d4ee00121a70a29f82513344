 ...
 * <ul>
 *   <li>{@link OM.Always#getPathFormula <em>Path Formula</em>}</li>
 * </ul>
 * </p>
 *
 * @see OM.OMPackage#getAlways()
 * @model
 * @generated
 */
public interface Always extends PathFormula
{
   ...
   * @see OM.OMPackage#getAlways_PathFormula()
   * @model required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link OM.Always#getPathFormula <em>Path Formula</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
