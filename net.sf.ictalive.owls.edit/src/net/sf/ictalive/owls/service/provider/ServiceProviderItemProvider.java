...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.service.ServiceProvider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceProviderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceProvider_provides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceProvider_provides_feature", "_UI_ServiceProvider_type"),
				 ServicePackage.Literals.SERVICE_PROVIDER__PROVIDES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_ServiceProvider_type");
	}
