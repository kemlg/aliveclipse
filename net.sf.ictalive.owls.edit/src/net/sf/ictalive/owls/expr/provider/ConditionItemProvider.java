...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.expr.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider
	...
	public String getText(Object object) {
		...
		String label = cond.getName();
		return label == null || label.length() == 0 ?cond.eContainmentFeature().getName() +" "+
			getString("_UI_Condition_type") :cond.eContainmentFeature().getName()+" "+
