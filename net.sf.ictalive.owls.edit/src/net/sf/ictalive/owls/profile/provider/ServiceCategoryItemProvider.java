...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.profile.ServiceCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceCategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceCategory_taxonomy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceCategory_taxonomy_feature", "_UI_ServiceCategory_type"),
				 ProfilePackage.Literals.SERVICE_CATEGORY__TAXONOMY,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceCategory_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceCategory_value_feature", "_UI_ServiceCategory_type"),
				 ProfilePackage.Literals.SERVICE_CATEGORY__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceCategory_code_feature", "_UI_ServiceCategory_type"),
				 ProfilePackage.Literals.SERVICE_CATEGORY__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCategoryNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceCategory_categoryName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceCategory_categoryName_feature", "_UI_ServiceCategory_type"),
				 ProfilePackage.Literals.SERVICE_CATEGORY__CATEGORY_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ServiceCategory)object).getCategoryName();
		return label == null || label.length() == 0 ?
			getString("_UI_ServiceCategory_type") :
