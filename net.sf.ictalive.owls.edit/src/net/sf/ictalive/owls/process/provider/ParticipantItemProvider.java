...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.process.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_id_feature", "_UI_Participant_type"),
				 ProcessPackage.Literals.PARTICIPANT__ID,
				 true,
				 false,
				 false,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_version_feature", "_UI_Participant_type"),
				 ProcessPackage.Literals.PARTICIPANT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addNsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_ns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_ns_feature", "_UI_Participant_type"),
				 ProcessPackage.Literals.PARTICIPANT__NS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessPackage.Literals.PARTICIPANT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
