...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.process.RepeatWhile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatWhileItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessPackage.Literals.REPEAT_WHILE__WHILE_CONDITION);
			childrenFeatures.add(ProcessPackage.Literals.REPEAT_WHILE__WHILE_PROCESS);
		}
	...
	public String getText(Object object) {
		RepeatWhile repeatWhile = (RepeatWhile)object;
		return getString("_UI_RepeatWhile_type") + " " + repeatWhile.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.REPEAT_WHILE__WHILE_CONDITION,
				 ExprFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.REPEAT_WHILE__WHILE_PROCESS,
