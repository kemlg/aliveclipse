...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.process.RepeatUntil} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatUntilItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessPackage.Literals.REPEAT_UNTIL__UNTIL_CONDITION);
			childrenFeatures.add(ProcessPackage.Literals.REPEAT_UNTIL__UNTIL_PROCESS);
		}
	...
	public String getText(Object object) {
		RepeatUntil repeatUntil = (RepeatUntil)object;
		return getString("_UI_RepeatUntil_type") + " " + repeatUntil.getId();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.REPEAT_UNTIL__UNTIL_CONDITION,
				 ExprFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.REPEAT_UNTIL__UNTIL_PROCESS,
