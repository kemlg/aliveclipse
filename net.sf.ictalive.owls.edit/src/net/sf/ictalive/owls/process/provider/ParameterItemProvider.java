...
/**
 * This is the item provider adapter for a {@link net.sf.ictalive.owls.process.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessPackage.Literals.PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addParameterValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_parameterValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_parameterValue_feature", "_UI_Parameter_type"),
				 ProcessPackage.Literals.PARAMETER__PARAMETER_VALUE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessPackage.Literals.PARAMETER__ID,
				 true,
				 false,
				 false,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_version_feature", "_UI_Parameter_type"),
				 ProcessPackage.Literals.PARAMETER__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addNsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_ns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_ns_feature", "_UI_Parameter_type"),
				 ProcessPackage.Literals.PARAMETER__NS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessPackage.Literals.PARAMETER__PARAMETER_TYPE,
				 true,
				 false,
				 true,
				 null,
