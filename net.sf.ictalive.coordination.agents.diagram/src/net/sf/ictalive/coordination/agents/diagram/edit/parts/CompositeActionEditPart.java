...
import net.sf.ictalive.coordination.agents.diagram.edit.policies.CompositeActionItemSemanticEditPolicy;
import net.sf.ictalive.coordination.agents.diagram.edit.policies.MasActionCompositeActionEditPolicy;
...
public class CompositeActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new MasActionCompositeActionEditPolicy());
