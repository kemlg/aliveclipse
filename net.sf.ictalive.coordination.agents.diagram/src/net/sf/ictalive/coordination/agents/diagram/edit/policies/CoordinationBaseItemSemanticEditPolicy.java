...
import net.sf.ictalive.coordination.agents.diagram.edit.helpers.CoordinationBaseEditHelper;
...
public class CoordinationBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateAgentHasAction_4003(Agent source,
				Action target) {
			if (source != null) {
				if (source.getHasAction().contains(target)) {
					return false;
				}
			}

			return canExistAgentHasAction_4003(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateAgentHasRole_4004(Agent source,
				Role target) {
			if (source != null) {
				if (source.getHasRole().contains(target)) {
					return false;
				}
			}

			return canExistAgentHasRole_4004(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistAgentHasAction_4003(Agent source,
				Action target) {
			return true;
		}
		 ...
		 * @generated
		 */
		public static boolean canExistAgentHasRole_4004(Agent source,
				Role target) {
			return true;
		}
	}
