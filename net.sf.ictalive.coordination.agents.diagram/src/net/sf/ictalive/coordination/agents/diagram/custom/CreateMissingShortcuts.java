/**
 * Adapted by David Corsar from CreateMissingShortcuts for the ActionTab 
 * @author Piotr Andruszkiewicz, David Corsar
 */
package net.sf.ictalive.coordination.agents.diagram.custom;
