...
import net.sf.ictalive.coordination.agents.diagram.part.CoordinationDiagramEditor;
 ...
 * @generated
 */
public class CoordinationNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof CoordinationNavigatorItem) {
					selectedElement = ((CoordinationNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (MasModelEditPart.MODEL_ID
							.equals(CoordinationVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, CoordinationDiagramEditor.ID);
