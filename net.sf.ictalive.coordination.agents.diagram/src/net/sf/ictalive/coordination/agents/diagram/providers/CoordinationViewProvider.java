...
public class CoordinationViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MasModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return AgentEditPart.VISUAL_ID == visualID
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MasModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case AgentEditPart.VISUAL_ID:
			return createAgent_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case RoleEditPart.VISUAL_ID:
			return createRole_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case AtomicActionEditPart.VISUAL_ID:
			return createAtomicAction_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case CompositeActionEditPart.VISUAL_ID:
			return createCompositeAction_2007(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case AgentHasActionEditPart.VISUAL_ID:
			return createAgentHasAction_4003(containerView, index, persisted,
					preferencesHint);
		case AgentHasRoleEditPart.VISUAL_ID:
			return createAgentHasRole_4004(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createAgent_2004(EObject domainElement, View containerView,
		...
		Node label5004 = createLabel(node, CoordinationVisualIDRegistry
	...
	public Node createRole_2005(EObject domainElement, View containerView,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5005 = createLabel(node, CoordinationVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createAtomicAction_2006(EObject domainElement,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5006 = createLabel(node, CoordinationVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createCompositeAction_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		{
	 ...
	 * @generated
	 */
	public Edge createAgentHasAction_4003(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createAgentHasRole_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
