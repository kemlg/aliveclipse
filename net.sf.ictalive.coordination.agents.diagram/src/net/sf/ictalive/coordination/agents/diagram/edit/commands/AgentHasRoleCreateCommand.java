 ...
 * @generated
 */
public class AgentHasRoleCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AgentHasRoleCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateAgentHasRole_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasRole().add(getTarget());
		}
