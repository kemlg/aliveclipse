...
import net.sf.ictalive.coordination.agents.diagram.part.CoordinationDiagramEditorUtil;
 ...
 * @generated
 */
public class MasActionCompositeActionEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(CoordinationDiagramEditorUtil
													.getSaveOptions());
								}
							}
		...
		protected EObject getDiagramDomainElement() {
			...
			return ((View) diagramFacet.eContainer()).getElement().eContainer();
		}
		...
		protected String getEditorID() {
			return "net.sf.ictalive.coordination.actions.diagram.part.CoordinationDiagramEditorID";
		}
	}
