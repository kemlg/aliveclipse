...
import net.sf.ictalive.coordination.agents.diagram.edit.policies.AtomicActionItemSemanticEditPolicy;
import net.sf.ictalive.coordination.agents.diagram.edit.policies.MasActionAtomicActionEditPolicy;
...
public class AtomicActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new MasActionAtomicActionEditPolicy());
