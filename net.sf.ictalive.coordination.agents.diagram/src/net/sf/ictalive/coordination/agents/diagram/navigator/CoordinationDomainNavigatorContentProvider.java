 ...
 * @generated
 */
public class CoordinationDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public CoordinationDomainNavigatorContentProvider() {
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(
				AgentsDiagramEditorPlugin.getInstance()
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof CoordinationDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((CoordinationDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new CoordinationDomainNavigatorItem(
