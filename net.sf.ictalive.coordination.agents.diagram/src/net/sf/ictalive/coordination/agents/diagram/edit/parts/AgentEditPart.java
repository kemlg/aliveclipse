...
import net.sf.ictalive.coordination.agents.diagram.edit.policies.AgentItemSemanticEditPolicy;
...
public class AgentEditPart extends ShapeNodeEditPart {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == CoordinationElementTypes.AgentHasAction_4003) {
			types.add(CoordinationElementTypes.AtomicAction_2006);
		}
		if (relationshipType == CoordinationElementTypes.AgentHasAction_4003) {
			types.add(CoordinationElementTypes.CompositeAction_2007);
		}
		if (relationshipType == CoordinationElementTypes.AgentHasRole_4004) {
			types.add(CoordinationElementTypes.Role_2005);
		}
		return types;
	}
	...
	public class AgentFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(fFigureAgentNameFigure);
