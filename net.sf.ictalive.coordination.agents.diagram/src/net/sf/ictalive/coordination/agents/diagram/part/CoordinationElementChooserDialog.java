 ...
 * @generated
 */
public class CoordinationElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public CoordinationElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.CoordinationElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "opera".equals(fileExtension) || "actions".equals(fileExtension); //$NON-NLS-1$ //$NON-NLS-2$
	}
