 ...
 * @generated
 */
public class AgentHasActionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AgentHasActionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateAgentHasAction_4003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasAction().add(getTarget());
		}
