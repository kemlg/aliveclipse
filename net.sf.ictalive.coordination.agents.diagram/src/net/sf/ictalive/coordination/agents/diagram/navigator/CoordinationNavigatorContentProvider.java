...
import net.sf.ictalive.coordination.agents.diagram.part.Messages;
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), MasModelEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MasModelEditPart.VISUAL_ID: {
			...
			CoordinationNavigatorGroup links = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_MasModel_1000_links,
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(view),
					CoordinationVisualIDRegistry
							.getType(AgentHasActionEditPart.VISUAL_ID));
			links
					.addChildren(createNavigatorItems(connectedViews, links,
							false));
			connectedViews = getDiagramLinksByType(Collections.singleton(view),
					CoordinationVisualIDRegistry
							.getType(AgentHasRoleEditPart.VISUAL_ID));
			links
					.addChildren(createNavigatorItems(connectedViews, links,
							false));
			if (!links.isEmpty()) {
		...
		case AgentEditPart.VISUAL_ID: {
			...
			CoordinationNavigatorGroup outgoinglinks = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_Agent_2004_outgoinglinks,
		...
		case AtomicActionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			CoordinationNavigatorGroup incominglinks = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_AtomicAction_2006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), CoordinationVisualIDRegistry
					.getType(AgentHasActionEditPart.VISUAL_ID));
		...
		case CompositeActionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			CoordinationNavigatorGroup incominglinks = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_CompositeAction_2007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), CoordinationVisualIDRegistry
					.getType(AgentHasActionEditPart.VISUAL_ID));
		...
		case AgentHasActionEditPart.VISUAL_ID: {
			...
			CoordinationNavigatorGroup target = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_AgentHasAction_4003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CoordinationNavigatorGroup source = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_AgentHasAction_4003_source,
		...
		case AgentHasRoleEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			CoordinationNavigatorGroup target = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_AgentHasRole_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			CoordinationNavigatorGroup source = new CoordinationNavigatorGroup(
					Messages.NavigatorGroupName_AgentHasRole_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), CoordinationVisualIDRegistry
					.getType(RoleEditPart.VISUAL_ID));
