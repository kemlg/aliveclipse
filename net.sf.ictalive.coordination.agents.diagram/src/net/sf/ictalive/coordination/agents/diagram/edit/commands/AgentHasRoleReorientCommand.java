 ...
 * @generated
 */
public class AgentHasRoleReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AgentHasRoleReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Role && newEnd instanceof Agent)) {
			return false;
		}
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAgentHasRole_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CoordinationBaseItemSemanticEditPolicy.LinkConstraints
				.canExistAgentHasRole_4004(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getHasRole().remove(getOldTarget());
		getNewSource().getHasRole().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getHasRole().remove(getOldTarget());
		getOldSource().getHasRole().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
